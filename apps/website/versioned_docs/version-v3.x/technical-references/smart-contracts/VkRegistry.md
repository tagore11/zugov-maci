...
Please note that each Verifying Key should be set with the corresponding mode. Available modes are quadratic, non quadratic, full credits, and ranked choice voting.
