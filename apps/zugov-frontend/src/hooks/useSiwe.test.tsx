...
// regardless of which external wallet connected (MetaMask, Rabby, etc. via the single
// injected() connector). Mocking at this level exercises the flow without a real WagmiProvider
