...
import { c as u, n as w, r as d, o as F, U as We } from "./index-Dd5QMJ5n.js";
import "./index-myL0f5cF.js";
import "./index.es-C5YIhjW9.js";
import "./events-DQ172AOg.js";
const p = be({ message: "", open: !1, triggerRect: { width: 0, height: 0, top: 0, left: 0 }, variant: "shade" }),
  Re = {
    state: p,
    subscribe(r) {
      return ge(p, () => r(p));
    ...
    hide() {
      ((p.open = !1), (p.message = ""), (p.triggerRect = { width: 0, height: 0, top: 0, left: 0 }));
    },
  },
  O = ve(Re),
  de = {
...
var Ae = function (r, e, t, o) {
  var n = arguments.length,
    i = n < 3 ? e : o === null ? (o = Object.getOwnPropertyDescriptor(e, t)) : o,
    s;
...
W.styles = [P, Te];
_([w()], W.prototype, "message", void 0);
_([w()], W.prototype, "backgroundColor", void 0);
_([w()], W.prototype, "iconColor", void 0);
_([w()], W.prototype, "icon", void 0);
W = _([u("wui-alertbar")], W);
const Oe = v`
  :host {
    display: block;
    position: absolute;
...
const Ne = {
  ...
  success: { backgroundColor: "success-glass-reown-020", iconColor: "success-125", icon: "checkmark" },
  warning: { backgroundColor: "warning-glass-reown-020", iconColor: "warning-100", icon: "warningCircle" },
  error: { backgroundColor: "error-glass-reown-020", iconColor: "error-125", icon: "exclamationTriangle" },
};
let M = class extends f {
  constructor() {
    (super(),
      (this.unsubscribe = []),
      (this.open = K.state.open),
      this.onOpen(!0),
  ...
  render() {
    const { message: e, variant: t } = K.state,
      o = Ne[t];
    return a`
      <wui-alertbar
        message=${e}
...
M.styles = Oe;
we([d()], M.prototype, "open", void 0);
M = we([u("w3m-alertbar")], M);
const Ee = v`
  button {
...
let R = class extends f {
  ...
  render() {
    const e = this.size === "lg" ? "--wui-border-radius-xs" : "--wui-border-radius-xxs",
...
R.styles = [P, ce, le, Ee];
B([w()], R.prototype, "size", void 0);
B([w({ type: Boolean })], R.prototype, "disabled", void 0);
B([w()], R.prototype, "icon", void 0);
B([w()], R.prototype, "iconColor", void 0);
R = B([u("wui-icon-link")], R);
const Ie = v`
  button {
    display: block;
    display: flex;
...
let V = class extends f {
  ...
  imageTemplate() {
    return this.imageSrc
      ? a`<wui-image src=${this.imageSrc} alt="select visual"></wui-image>`
      : a`<wui-icon-box
      size="xxs"
      iconColor="fg-200"
...
V.styles = [P, ce, le, Ie];
ue([w()], V.prototype, "imageSrc", void 0);
V = ue([u("wui-select")], V);
const Pe = v`
  :host {
    height: 64px;
...
function G() {
  var s, c, N, k, j, L, U;
  const r = (c = (s = l.state.data) == null ? void 0 : s.connector) == null ? void 0 : c.name,
    e = (k = (N = l.state.data) == null ? void 0 : N.wallet) == null ? void 0 : k.name,
    t = (L = (j = l.state.data) == null ? void 0 : j.network) == null ? void 0 : L.name,
    o = e ?? r,
    n = q.getConnectors();
  return {
...
let h = class extends f {
  constructor() {
    (super(),
      ...
      (this.viewDirection = ""),
      (this.headerText = G()[l.state.view]),
      this.unsubscribe.push(
        ye.subscribeNetworkImages(() => {
          this.networkImage = Y.getNetworkImage(this.network);
        }),
        l.subscribeKey("view", (e) => {
          (setTimeout(() => {
            ((this.view = e), (this.headerText = G()[e]));
          }, S.ANIMATION_DURATIONS.HeaderText),
            this.onViewChange(),
  ...
  rightHeaderTemplate() {
    var t, o, n;
    const e =
      (n = (o = (t = E) == null ? void 0 : t.state) == null ? void 0 : o.features) == null ? void 0 : n.smartSessions;
  ...
  leftHeaderTemplate() {
    ...
    const { view: e } = l.state,
      t = e === "Connect",
      o = E.state.enableEmbedded,
      n = e === "ApproveTransaction",
      i = e === "ConnectingSiwe",
      s = e === "Account",
      c = E.state.enableNetworkSwitch,
      N = n || i || (t && o);
    return s && c
      ? a`<wui-select
        id="dynamic"
  ...
  isAllowedNetworkSwitch() {
    const e = m.getAllRequestedCaipNetworks(),
      t = e ? e.length > 1 : !1,
      o =
        e == null
          ? void 0
  ...
  onViewChange() {
    ...
    (e.length < this.prevHistoryLength && (t = S.VIEW_DIRECTION.Prev),
  ...
  async onHistoryChange() {
    ...
    e.length > 1 && !this.showBack && t
      ? (await t.animate([{ opacity: 1 }, { opacity: 0 }], { duration: 200, fill: "forwards", easing: "ease" })
          .finished,
        (this.showBack = !0),
        t.animate([{ opacity: 0 }, { opacity: 1 }], { duration: 200, fill: "forwards", easing: "ease" }))
      : e.length <= 1 &&
        this.showBack &&
        t &&
        (await t.animate([{ opacity: 1 }, { opacity: 0 }], { duration: 200, fill: "forwards", easing: "ease" })
...
h.styles = Pe;
y([d()], h.prototype, "heading", void 0);
y([d()], h.prototype, "network", void 0);
y([d()], h.prototype, "networkImage", void 0);
y([d()], h.prototype, "showBack", void 0);
y([d()], h.prototype, "prevHistoryLength", void 0);
y([d()], h.prototype, "view", void 0);
y([d()], h.prototype, "viewDirection", void 0);
y([d()], h.prototype, "headerText", void 0);
h = y([u("w3m-header")], h);
const Be = v`
  :host {
    display: flex;
...
let b = class extends f {
  ...
  templateIcon() {
    return this.loading
      ? a`<wui-loading-spinner size="md" color="accent-100"></wui-loading-spinner>`
      : this.iconType === "default"
        ? a`<wui-icon size="xl" color=${this.iconColor} name=${this.icon}></wui-icon>`
        : a`<wui-icon-box
      size="sm"
      iconSize="xs"
...
b.styles = [P, Be];
A([w()], b.prototype, "backgroundColor", void 0);
A([w()], b.prototype, "iconColor", void 0);
A([w()], b.prototype, "icon", void 0);
A([w()], b.prototype, "message", void 0);
A([w()], b.prototype, "loading", void 0);
A([w()], b.prototype, "iconType", void 0);
b = A([u("wui-snackbar")], b);
const De = v`
  :host {
    display: block;
    position: absolute;
...
let X = class extends f {
  ...
  render() {
    const { message: e, variant: t, svg: o } = T.state,
      n = je[t],
      { icon: i, iconColor: s } = o ?? n ?? {};
    return a`
      <wui-snackbar
        message=${e}
    ...
    (clearTimeout(this.timeout),
      this.open
        ? (this.animate(
          ...
          T.state.autoClose && (this.timeout = setTimeout(() => T.hide(), 2500)))
        : this.animate(
            [
              { opacity: 1, transform: "translateX(-50%) scale(1)" },
              { opacity: 0, transform: "translateX(-50%) scale(0.85)" },
...
X.styles = De;
pe([d()], X.prototype, "open", void 0);
X = pe([u("w3m-snackbar")], X);
const Le = v`
  :host {
    pointer-events: none;
  }
...
let $ = class extends f {
  constructor() {
    (super(),
      ...
      (this.message = O.state.message),
      (this.triggerRect = O.state.triggerRect),
      (this.variant = O.state.variant),
      this.unsubscribe.push(
        O.subscribe((e) => {
          ((this.open = e.open),
...
$.styles = [Le];
D([d()], $.prototype, "open", void 0);
D([d()], $.prototype, "message", void 0);
D([d()], $.prototype, "triggerRect", void 0);
D([d()], $.prototype, "variant", void 0);
$ = D([u("w3m-tooltip"), u("w3m-tooltip")], $);
const Ue = v`
  :host {
    --prev-height: 0px;
    --new-height: 0px;
...
let I = class extends f {
  constructor() {
    (super(),
      ...
      (this.view = l.state.view),
      (this.viewDirection = ""),
      this.unsubscribe.push(l.subscribeKey("view", (e) => this.onViewChange(e))));
  }
  firstUpdated() {
    var e;
    ((this.resizeObserver = new ResizeObserver(([t]) => {
      ...
      (this.prevHeight !== "0px" &&
        ...
        this.style.setProperty("--new-height", o),
  ...
  onViewChange(e) {
    ...
    (o.length < this.prevHistoryLength && (t = S.VIEW_DIRECTION.Prev),
      (this.prevHistoryLength = o.length),
      (this.viewDirection = t),
      setTimeout(() => {
        this.view = e;
...
I.styles = Ue;
Q([d()], I.prototype, "view", void 0);
Q([d()], I.prototype, "viewDirection", void 0);
I = Q([u("w3m-router")], I);
const ze = v`
  :host {
...
class x extends f {
  constructor() {
    (super(),
      ...
      (this.open = g.state.open),
      (this.caipAddress = m.state.activeCaipAddress),
      (this.caipNetwork = m.state.activeCaipNetwork),
      (this.shake = g.state.shake),
      (this.filterByNamespace = q.state.filterByNamespace),
      this.initializeTheming(),
      H.prefetchAnalyticsConfig(),
      this.unsubscribe.push(
        g.subscribeKey("open", (e) => (e ? this.onOpen() : this.onClose())),
        g.subscribeKey("shake", (e) => (this.shake = e)),
        m.subscribeKey("activeCaipNetwork", (e) => this.onNewNetwork(e)),
        m.subscribeKey("activeCaipAddress", (e) => this.onNewAddress(e)),
        E.subscribeKey("enableEmbedded", (e) => (this.enableEmbedded = e)),
        q.subscribeKey("filterByNamespace", (e) => {
          var t;
          this.filterByNamespace !== e &&
            !((t = m.getAccountData(e)) != null && t.caipAddress) &&
            (H.fetchRecommendedWallets(), (this.filterByNamespace = e));
        }),
      ));
  }
  firstUpdated() {
  ...
  initializeTheming() {
    const { themeVariables: e, themeMode: t } = xe.state,
      o = We.getColorTheme(t);
    Ce(e, o);
  }
  onClose() {
  ...
  async onNewAddress(e) {
    const t = m.state.isSwitchingNamespace,
      o = ke.getPlainAddress(e);
    (!o && !t ? g.close() : t && o && l.goBack(),
      await se.initializeIfEnabled(),
      (this.caipAddress = e),
  ...
  onNewNetwork(e) {
    ...
    const t = this.caipNetwork,
      o = (Z = t == null ? void 0 : t.caipNetworkId) == null ? void 0 : Z.toString(),
      n = t == null ? void 0 : t.chainNamespace,
      i = (ee = e == null ? void 0 : e.caipNetworkId) == null ? void 0 : ee.toString(),
      s = e == null ? void 0 : e.chainNamespace,
      c = o !== i,
      k = c && !(n !== s),
      j = (t == null ? void 0 : t.name) === Se.UNSUPPORTED_NETWORK_NAME,
      L = l.state.view === "ConnectingExternal",
      U = !((te = m.getAccountData(e == null ? void 0 : e.chainNamespace)) != null && te.caipAddress),
      me = l.state.view === "UnsupportedChain",
      he = g.state.open;
    let z = !1;
    (he && !L && (U ? c && (z = !0) : (me || (k && !j)) && (z = !0)),
      z && l.state.view !== "SIWXSignMessage" && l.goBack(),
      (this.caipNetwork = e));
  }
  prefetch() {
...
x.styles = ze;
C([w({ type: Boolean })], x.prototype, "enableEmbedded", void 0);
C([d()], x.prototype, "open", void 0);
C([d()], x.prototype, "caipAddress", void 0);
C([d()], x.prototype, "caipNetwork", void 0);
C([d()], x.prototype, "shake", void 0);
C([d()], x.prototype, "filterByNamespace", void 0);
let ne = class extends x {};
ne = C([u("w3m-modal")], ne);
let re = class extends x {};
re = C([u("appkit-modal")], re);
export { re as AppKitModal, ne as W3mModal, x as W3mModalBase };
