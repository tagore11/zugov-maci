...
var L = (e, t, n) => hs(e, typeof t != "symbol" ? t + "" : t, n);
import {
  A as gs,
  y as nr,
  z as ut,
...
function ro(e, t) {
  if (e.length !== t.length) throw new gs({ expectedLength: e.length, givenLength: t.length });
  const n = [];
...
function Da(e, t, n = !1) {
  if (e === "address") {
    const s = t;
    if (!ut(s)) throw new bs({ address: s });
    return de(s.toLowerCase(), { size: n ? 32 : null });
  }
  if (e === "string") return Oa(t);
  if (e === "bytes") return t;
  if (e === "bool") return de(ws(t), { size: n ? 32 : 1 });
  const r = e.match(vs);
  if (r) {
    const [s, o, u = "256"] = r,
      c = Number.parseInt(u, 10) / 8;
    return j(t, { size: n ? 32 : c, signed: o === "int" });
  }
  const a = e.match(xs);
  if (a) {
    const [s, o] = a;
    if (Number.parseInt(o, 10) !== (t.length - 2) / 2)
      throw new Es({ expectedSize: Number.parseInt(o, 10), givenSize: (t.length - 2) / 2 });
    return de(t, { dir: "right", size: n ? 32 : null });
  }
  const i = e.match(Ss);
  if (i && Array.isArray(t)) {
    const [s, o] = i,
      u = [];
    for (let c = 0; c < t.length; c++) u.push(Da(o, t[c], !0));
    return u.length === 0 ? "0x" : nr(u);
  }
  throw new ks(e);
}
function ao(e) {
  ...
  return {
    async consume({ address: s, chainId: o, client: u }) {
      const c = i({ address: s, chainId: o }),
        l = this.get({ address: s, chainId: o, client: u });
      this.increment({ address: s, chainId: o });
      const d = await l;
      return (await t.set({ address: s, chainId: o }, d), r.set(c, d), d);
    },
    ...
    async get({ address: s, chainId: o, client: u }) {
      const c = i({ address: s, chainId: o });
      let l = a.get(c);
      return (
        l ||
          ((l = (async () => {
            try {
              const p = await t.get({ address: s, chainId: o, client: u }),
                f = r.get(c) ?? 0;
              return f > 0 && p <= f ? f + 1 : (r.delete(c), p);
            } finally {
...
const io = "0x6492649264926492649264926492649264926492649264926492649264926492";
function nn(e) {
  const { address: t, data: n, signature: r, to: a = "hex" } = e,
    i = nr([Ve([{ type: "address" }, { type: "bytes" }, { type: "bytes" }], [t, n, r]), io]);
  return a === "hex" ? i : Bt(i);
}
function so(e) {
  const { key: t = "public", name: n = "Public Client" } = e;
  return Ia({ ...e, key: t, name: n, type: "publicClient" }).extend(Ps);
}
function oo(e) {
  const { r: t, s: n } = Os.Signature.fromCompact(e.slice(2, 130)),
    r = +`0x${e.slice(130)}`,
    [a, i] = (() => {
  ...
  return typeof a < "u"
    ? { r: j(t, { size: 32 }), s: j(n, { size: 32 }), v: a, yParity: i }
    : { r: j(t, { size: 32 }), s: j(n, { size: 32 }), yParity: i };
}
const co = be({
    id: 43114,
    name: "Avalanche",
    ...
    blockExplorers: { default: { name: "SnowTrace", url: "https://snowtrace.io", apiUrl: "https://api.snowtrace.io" } },
  ...
  Ma = be({
    ...
    blockExplorers: {
      default: { name: "Basescan", url: "https://basescan.org", apiUrl: "https://api.basescan.org/api" },
    },
    contracts: {
      ...Ce.contracts,
      disputeGameFactory: { [nt]: { address: "0x43edB88C4B80fDD2AdFF2412A7BebF9dF42cB40e" } },
      l2OutputOracle: { [nt]: { address: "0x56315b90c40730925ec5485cf004d835058518A0" } },
      multicall3: { address: "0xca11bde05977b3631167028862be2a173976ca11", blockCreated: 5022 },
      portal: { [nt]: { address: "0x49048044D57e1C92A77f79988d21Fa8fAF74E97e", blockCreated: 17482143 } },
      l1StandardBridge: { [nt]: { address: "0x3154Cf16ccdb4C6d922629664174b904d80F2C35", blockCreated: 17482143 } },
    },
    sourceId: nt,
  });
({ ...Ma });
const rt = 11155111,
  La = be({
    ...
    contracts: {
      ...Ce.contracts,
      disputeGameFactory: { [rt]: { address: "0xd6E6dBf4F7EA0ac412fD8b65ED297e64BB7a06E1" } },
      l2OutputOracle: { [rt]: { address: "0x84457ca9D0163FbC4bbfe4Dfbb20ba46e48DF254" } },
      portal: { [rt]: { address: "0x49f53e41452c74589e85ca1677426ba426459e85", blockCreated: 4446677 } },
      l1StandardBridge: { [rt]: { address: "0xfd0Bf71F60660E2f608ed56e1659C450eB113120", blockCreated: 4446677 } },
      multicall3: { address: "0xca11bde05977b3631167028862be2a173976ca11", blockCreated: 1059647 },
    },
    testnet: !0,
    sourceId: rt,
  });
...
const uo = be({
    ...
    blockExplorers: { default: { name: "BscScan", url: "https://bscscan.com", apiUrl: "https://api.bscscan.com/api" } },
  ...
  lo = be({
    ...
    contracts: {
      ...
      multicall3: { address: "0xca11bde05977b3631167028862be2a173976ca11", blockCreated: 1620204 },
      portal: { [at]: { address: "0x16Fc5058F25648194471939df75CF27A2fdC48BC" } },
      l1StandardBridge: { [at]: { address: "0xFBb0621E0B23b5478B630BD55a5f21f67730B0F1" } },
    },
    testnet: !0,
    sourceId: at,
  }),
  fo = be({
    ...
    contracts: {
      ...
      ensUniversalResolver: { address: "0xeeeeeeee14d718c2b47d9923deab1335e144eeee", blockCreated: 8928790 },
    },
    testnet: !0,
  }),
  it = 1,
  po = be({
    ...
    rpcUrls: { default: { http: ["https://rpc.zora.energy"], webSocket: ["wss://rpc.zora.energy"] } },
    blockExplorers: {
      default: { name: "Explorer", url: "https://explorer.zora.energy", apiUrl: "https://explorer.zora.energy/api" },
    },
    contracts: {
      ...Ce.contracts,
      disputeGameFactory: { [it]: { address: "0xB0F15106fa1e473Ddb39790f197275BC979Aa37e" } },
      l2OutputOracle: { [it]: { address: "0x9E6204F750cD866b299594e2aC9eA824E2e5f95c" } },
      multicall3: { address: "0xcA11bde05977b3631167028862bE2a173976CA11", blockCreated: 5882 },
      portal: { [it]: { address: "0x1a0ad011913A150f69f6A19DF447A0CfD9551054" } },
      l1StandardBridge: { [it]: { address: "0x3e2Ea9B92B7E48A52296fD261dc26fd995284631" } },
    },
    sourceId: it,
  });
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */ const sr = BigInt(0),
  hn = BigInt(1);
function Ut(e, t = "") {
  if (typeof e != "boolean") {
    const n = t && `"${t}"`;
...
function Re(e, t, n = "") {
  const r = rr(e),
    a = e == null ? void 0 : e.length,
    i = t !== void 0;
  if (!r || (i && a !== t)) {
    const s = n && `"${n}" `,
      o = i ? ` of length ${t}` : "",
      u = r ? `length=${a}` : `type=${typeof e}`;
...
function Fa(e) {
  ...
  return e === "" ? sr : BigInt("0x" + e);
}
function Wt(e) {
  return Fa(qe(e));
}
function Ga(e) {
  return (Is(e), Fa(qe(Uint8Array.from(e).reverse())));
}
function or(e, t) {
  return Rt(e.toString(16).padStart(t * 2, "0"));
}
function za(e, t) {
...
function ue(e, t, n) {
  ...
  else if (rr(t)) r = Uint8Array.from(t);
  else throw new Error(e + " must be hex string or Uint8Array");
  return (r.length, r);
}
const rn = (e) => typeof e == "bigint" && sr <= e;
function mo(e, t, n) {
  return rn(e) && rn(t) && rn(n) && t <= e && e < n;
}
function yo(e, t, n, r) {
  if (!mo(t, n, r)) throw new Error("expected valid " + e + ": " + n + " <= n < " + r + ", got " + t);
}
function Ha(e) {
  let t;
  for (t = 0; e > sr; e >>= hn, t += 1);
  return t;
}
const mt = (e) => (hn << BigInt(e)) - hn;
function ho(e, t, n) {
  ...
  const u = () => {
    ...
    c = (...f) => n(s, i, ...f),
    l = (f = r(0)) => {
      ((s = c(a(0), f)), (i = c()), f.length !== 0 && ((s = c(a(1), f)), (i = c())));
    },
    d = () => {
...
function cr(e, t, n = {}) {
  ...
  function r(a, i, s) {
    ...
    const u = typeof o;
    if (u !== i || o === null) throw new Error(`param "${a}" is invalid: expected ${i}, got ${u}`);
  }
...
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */ const le = BigInt(0),
  se = BigInt(1),
  Ue = BigInt(2),
  Ka = BigInt(3),
  Va = BigInt(4),
...
function Dr(e, t) {
  if (e === le) throw new Error("invert: expected non-zero number");
  if (t <= le) throw new Error("invert: expected positive modulus, got " + t);
  let n = ye(e, t),
    r = t,
    a = le,
    i = se;
  ...
  if (r !== se) throw new Error("invert: does not exist");
  return ye(a, t);
}
function ur(e, t, n) {
...
function Ja(e, t) {
  const n = (e.ORDER + se) / Va,
    r = e.pow(t, n);
  return (ur(e, r, t), r);
}
function wo(e, t) {
  const n = (e.ORDER - qa) / Za,
    r = e.mul(t, Ue),
    a = e.pow(r, n),
    i = e.mul(t, a),
    s = e.mul(e.mul(i, Ue), a),
...
function vo(e) {
  ...
  return (o, u) => {
    ...
    const d = o.mul(c, a),
      ...
      f = o.eql(o.sqr(l), u),
      m = o.eql(o.sqr(d), u);
    ((c = o.cmov(c, l, f)), (l = o.cmov(p, d, m)));
    const y = o.eql(o.sqr(l), u),
      b = o.cmov(c, l, y);
    return (ur(o, b, u), b);
  };
}
function Ya(e) {
  if (e < Ka) throw new Error("sqrt is not defined for small field");
  let t = e - se,
    n = 0;
  for (; t % Ue === le; ) ((t /= Ue), n++);
  let r = Ue;
  const a = Fe(e);
  for (; Mr(a, r) === 1; ) if (r++ > 1e3) throw new Error("Cannot find square root: probably non-prime P");
  if (n === 1) return Ja;
  let i = a.pow(r, t);
  const s = (t + se) / Ue;
  return function (u, c) {
    if (u.is0(c)) return c;
    if (Mr(u, c) !== 1) throw new Error("Cannot find square root");
    let l = n,
      d = u.mul(u.ONE, i),
      p = u.pow(c, t),
      f = u.pow(c, s);
    for (; !u.eql(p, u.ONE); ) {
      ...
      let m = 1,
        y = u.sqr(p);
      for (; !u.eql(y, u.ONE); ) if ((m++, (y = u.sqr(y)), m === l)) throw new Error("Cannot find square root");
      const b = se << BigInt(l - m - 1),
        E = u.pow(d, b);
      ((l = m), (d = u.sqr(E)), (p = u.mul(p, d)), (f = u.mul(f, E)));
    }
    return f;
  };
}
function xo(e) {
  return e % Va === Ka ? Ja : e % Za === qa ? wo : e % Wa === bo ? vo(e) : Ya(e);
}
const Eo = [
  "create",
  "isValid",
...
function So(e) {
  const t = { ORDER: "bigint", MASK: "bigint", BYTES: "number", BITS: "number" },
    n = Eo.reduce((r, a) => ((r[a] = "function"), r), t);
  return (cr(e, n), e);
}
function ko(e, t, n) {
  if (n < le) throw new Error("invalid exponent, negatives unsupported");
  if (n === le) return e.ONE;
  if (n === se) return t;
  let r = e.ONE,
    a = t;
  for (; n > le; ) (n & se && (r = e.mul(r, a)), (a = e.sqr(a)), (n >>= se));
  return r;
}
function Xa(e, t, n = !1) {
  const r = new Array(t.length).fill(n ? e.ZERO : void 0),
    a = t.reduce((s, o, u) => (e.is0(o) ? s : ((r[u] = s), e.mul(s, o))), e.ONE),
    i = e.inv(a);
  return (t.reduceRight((s, o, u) => (e.is0(o) ? s : ((r[u] = e.mul(s, r[u])), e.mul(s, o))), i), r);
}
function Mr(e, t) {
  const n = (e.ORDER - se) / Ue,
    r = e.pow(t, n),
    a = e.eql(r, e.ONE),
    i = e.eql(r, e.ZERO),
    s = e.eql(r, e.neg(e.ONE));
  if (!a && !i && !s) throw new Error("invalid Legendre symbol result");
  return a ? 1 : i ? 0 : -1;
}
function Qa(e, t) {
  t !== void 0 && Cs(t);
...
function Fe(e, t, n = !1, r = {}) {
  if (e <= le) throw new Error("invalid field: expected ORDER > 0, got " + e);
  let a,
    i,
    s = !1,
    o;
  if (typeof t == "object" && t != null) {
    ...
    (p.BITS && (a = p.BITS),
      p.sqrt && (i = p.sqrt),
      typeof p.isLE == "boolean" && (n = p.isLE),
      typeof p.modFromBytes == "boolean" && (s = p.modFromBytes),
      (o = p.allowedLengths));
  } else (typeof t == "number" && (a = t), r.sqrt && (i = r.sqrt));
  const { nBitLength: u, nByteLength: c } = Qa(e, a);
  ...
  const d = Object.freeze({
    ...
    create: (p) => ye(p, e),
    isValid: (p) => {
      if (typeof p != "bigint") throw new Error("invalid field element: expected bigint, got " + typeof p);
      return le <= p && p < e;
    },
    is0: (p) => p === le,
    ...
    mul: (p, f) => ye(p * f, e),
    pow: (p, f) => ko(d, p, f),
    div: (p, f) => ye(p * Dr(f, e), e),
    sqrN: (p) => p * p,
    addN: (p, f) => p + f,
    subN: (p, f) => p - f,
    mulN: (p, f) => p * f,
    inv: (p) => Dr(p, e),
    sqrt: i || ((p) => (l || (l = xo(e)), l(d, p))),
    toBytes: (p) => (n ? za(p, c) : or(p, c)),
    fromBytes: (p, f = !0) => {
      if (o) {
        if (!o.includes(p.length) || p.length > c)
          throw new Error("Field.fromBytes: expected " + o + " bytes, got " + p.length);
        const y = new Uint8Array(c);
        (y.set(p, n ? 0 : y.length - p.length), (p = y));
      }
      if (p.length !== c) throw new Error("Field.fromBytes: expected " + c + " bytes, got " + p.length);
      let m = n ? Ga(p) : Wt(p);
      if ((s && (m = ye(m, e)), !f && !d.isValid(m)))
        throw new Error("invalid field element: outside of range 0..ORDER");
      return m;
    },
    invertBatch: (p) => Xa(d, p),
    cmov: (p, f, m) => (m ? f : p),
  });
...
function Ao(e, t, n = !1) {
  ...
  const s = n ? Ga(e) : Wt(e),
    o = ye(s, t - se) + se;
  return n ? za(o, a) : or(o, a);
}
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */ const Je = BigInt(0),
  Ne = BigInt(1);
function Nt(e, t) {
  const n = t.negate();
  return e ? n : t;
...
function sn(e, t) {
  ...
  const n = Math.ceil(t / e) + 1,
    ...
    i = mt(e),
    s = BigInt(e);
  return { windows: n, windowSize: r, mask: i, maxNumber: a, shiftBy: s };
}
function Lr(e, t, n) {
  const { windowSize: r, mask: a, maxNumber: i, shiftBy: s } = n;
  let o = Number(e & a),
    u = e >> s;
  o > r && ((o -= i), (u += Ne));
  const c = t * r,
    ...
    p = o < 0,
    f = t % 2 !== 0;
  return { nextN: u, offset: l, isZero: d, isNeg: p, isNegF: f, offsetF: c };
}
function Po(e, t) {
...
function Fr(e) {
  if (e !== Je) throw new Error("invalid wNAF");
}
class Io {
  constructor(t, n) {
  ...
  _unsafeLadder(t, n, r = this.ZERO) {
    let a = t;
    for (; n > Je; ) (n & Ne && (r = r.add(a)), (a = a.double()), (n >>= Ne));
    return r;
  }
  precomputeWindow(t, n) {
    const { windows: r, windowSize: a } = sn(n, this.bits),
      i = [];
    let s = t,
      o = s;
    for (let u = 0; u < r; u++) {
      ((o = s), i.push(o));
      for (let c = 1; c < a; c++) ((o = o.add(s)), i.push(o));
      s = o.double();
    }
    return i;
  }
  wNAF(t, n, r) {
    ...
    let a = this.ZERO,
      i = this.BASE;
    const s = sn(t, this.bits);
    for (let o = 0; o < s.windows; o++) {
      const { nextN: u, offset: c, isZero: l, isNeg: d, isNegF: p, offsetF: f } = Lr(r, o, s);
      ((r = u), l ? (i = i.add(Nt(p, n[f]))) : (a = a.add(Nt(d, n[c]))));
    }
    return (Fr(r), { p: a, f: i });
  }
  wNAFUnsafe(t, n, r, a = this.ZERO) {
    const i = sn(t, this.bits);
    for (let s = 0; s < i.windows && r !== Je; s++) {
      const { nextN: o, offset: u, isZero: c, isNeg: l } = Lr(r, s, i);
      if (((r = o), !c)) {
        const d = n[u];
        a = a.add(l ? d.negate() : d);
      }
    }
    return (Fr(r), a);
  }
  getPrecomputes(t, n, r) {
    let a = on.get(n);
    return (
      a || ((a = this.precomputeWindow(n, t)), t !== 1 && (typeof r == "function" && (a = r(a)), on.set(n, a))),
      a
    );
  }
  cached(t, n, r) {
  ...
  createCache(t, n) {
    (ti(n, this.bits), ni.set(t, n), on.delete(t));
  }
  hasCache(t) {
    return cn(t) !== 1;
  }
...
function Co(e, t, n, r) {
  let a = t,
    ...
    s = e.ZERO;
  for (; n > Je || r > Je; )
    (n & Ne && (i = i.add(a)), r & Ne && (s = s.add(a)), (a = a.double()), (n >>= Ne), (r >>= Ne));
  return { p1: i, p2: s };
}
function To(e, t, n, r) {
  (Po(n, e), Oo(r, t));
  const a = n.length,
    i = r.length;
  if (a !== i) throw new Error("arrays of points and scalars must have equal length");
  const s = e.ZERO,
    o = Ha(BigInt(a));
  let u = 1;
  ...
  for (let f = d; f >= 0; f -= u) {
    ...
    for (let y = 0; y < i; y++) {
      const b = r[y],
        E = Number((b >> BigInt(f)) & c);
      l[E] = l[E].add(n[y]);
    }
    let m = s;
    for (let y = l.length - 1, b = s; y > 0; y--) ((b = b.add(l[y])), (m = m.add(b)));
    if (((p = p.add(m)), f !== 0)) for (let y = 0; y < u; y++) p = p.double();
  }
  return p;
}
function Gr(e, t, n) {
...
function _o(e, t, n = {}, r) {
  ...
  for (const u of ["p", "n", "h"]) {
    const c = t[u];
    if (!(typeof c == "bigint" && c > Je)) throw new Error(`CURVE.${u} must be positive bigint`);
  }
  const a = Gr(t.p, n.Fp, r),
    i = Gr(t.n, n.Fn, r),
    o = ["Gx", "Gy", "a", "b"];
  for (const u of o) if (!a.isValid(t[u])) throw new Error(`CURVE.${u} must be valid field element of CURVE.Fp`);
  return ((t = Object.freeze(Object.assign({}, t))), { CURVE: t, Fp: a, Fn: i });
}
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */ const zr = (e, t) =>
  (e + (e >= 0 ? t : -t) / ri) / t;
function Bo(e, t, n) {
  const [[r, a], [i, s]] = t,
    o = zr(s * e, n),
  ...
  const d = c < ke,
    p = l < ke;
  (d && (c = -c), p && (l = -l));
  const f = mt(Math.ceil(Ha(n) / 2)) + We;
  if (c < ke || c >= f || l < ke || l >= f) throw new Error("splitScalar (endomorphism): failed, k=" + e);
  return { k1neg: d, k1: c, k2neg: p, k2: l };
}
function gn(e) {
...
function un(e, t) {
  ...
  return (Ut(n.lowS, "lowS"), Ut(n.prehash, "prehash"), n.format !== void 0 && gn(n.format), n);
}
...
const xe = {
    ...
    _tlv: {
      encode: (e, t) => {
        ...
        const i = r > 127 ? gt((a.length / 2) | 128) : "";
        return gt(e) + i + a + t;
      },
      decode(e, t) {
        const { Err: n } = xe;
        ...
        if (!i) s = a;
          ...
          const u = a & 127;
          if (!u) throw new n("tlv.decode(long): indefinite length not supported");
          if (u > 4) throw new n("tlv.decode(long): byte length is too big");
          const c = t.subarray(r, r + u);
          if (c.length !== u) throw new n("tlv.decode: length bytes not complete");
          if (c[0] === 0) throw new n("tlv.decode(long): zero leftmost byte");
          for (const l of c) s = (s << 8) | l;
          if (((r += u), s < 128)) throw new n("tlv.decode(long): not minimal encoding");
        }
        const o = t.subarray(r, r + s);
        if (o.length !== s) throw new n("tlv.decode: wrong value length");
    ...
    _int: {
      encode(e) {
        const { Err: t } = xe;
        if (e < ke) throw new t("integer: negative integers are not allowed");
        let n = gt(e);
...
function No(e, t = {}) {
  ...
  const { endo: u } = t;
  if (u && (!r.is0(i.a) || typeof u.beta != "bigint" || !Array.isArray(u.basises)))
  ...
  function d(M, v, g) {
    const { x: h, y: k } = v.toAffine(),
      P = r.toBytes(h);
    if ((Ut(g, "isCompressed"), g)) {
      l();
      const T = !r.isOdd(k);
      return Pe(ai(T), P);
    } else return Pe(Uint8Array.of(4), P, r.toBytes(k));
  }
  function p(M) {
    Re(M, void 0, "Point");
    const { publicKey: v, publicKeyUncompressed: g } = c,
      h = M.length,
      k = M[0],
      P = M.subarray(1);
    if (h === v && (k === 2 || k === 3)) {
      const T = r.fromBytes(P);
      if (!r.isValid(T)) throw new Error("bad point: is not on curve, wrong x");
      const C = y(T);
      let I;
      try {
        I = r.sqrt(C);
      } catch (te) {
        const K = te instanceof Error ? ": " + te.message : "";
        throw new Error("bad point: is not on curve, sqrt error" + K);
      }
      l();
      const _ = r.isOdd(I);
      return (((k & 1) === 1) !== _ && (I = r.neg(I)), { x: T, y: I });
    } else if (h === g && k === 4) {
      const T = r.BYTES,
        C = r.fromBytes(P.subarray(0, T)),
        I = r.fromBytes(P.subarray(T, T * 2));
      if (!b(C, I)) throw new Error("bad point: is not on curve");
      return { x: C, y: I };
    } else throw new Error(`bad point: got length ${h}, expected compressed=${v} or uncompressed=${g}`);
  }
  const f = t.toBytes || d,
    m = t.fromBytes || p;
  function y(M) {
    const v = r.sqr(M),
      g = r.mul(v, M);
    return r.add(r.add(g, r.mul(M, i.a)), i.b);
  }
  function b(M, v) {
    const g = r.sqr(v),
      h = y(M);
  ...
  const E = r.mul(r.pow(i.a, bt), Uo),
    w = r.mul(r.sqr(i.b), BigInt(27));
  if (r.is0(r.add(E, w))) throw new Error("bad curve params: a or b");
  function O(M, v, g = !1) {
    if (!r.isValid(v) || (g && r.is0(v))) throw new Error(`bad point coordinate ${M}`);
    return v;
  }
  function U(M) {
    if (!(M instanceof A)) throw new Error("ProjectivePoint expected");
  }
  function $(M) {
    if (!u || !u.basises) throw new Error("no endo");
    return Bo(M, u.basises, a.ORDER);
  }
  const re = jr((M, v) => {
      const { X: g, Y: h, Z: k } = M;
      if (r.eql(k, r.ONE)) return { x: g, y: h };
      const P = M.is0();
    ...
    ge = jr((M) => {
      if (M.is0()) {
        if (t.allowInfinityPoint && !r.is0(M.Y)) return;
        throw new Error("bad point: ZERO");
      }
      const { x: v, y: g } = M.toAffine();
      if (!r.isValid(v) || !r.isValid(g)) throw new Error("bad point: x or y not field elements");
      if (!b(v, g)) throw new Error("bad point: equation left != right");
      if (!M.isTorsionFree()) throw new Error("bad point: not in prime-order subgroup");
      return !0;
    });
  function oe(M, v, g, h, k) {
    return ((g = new A(r.mul(g.X, M), g.Y, g.Z)), (v = Nt(h, v)), (g = Nt(k, g)), v.add(g));
  }
  class A {
    constructor(v, g, h) {
      ((this.X = O("x", v)), (this.Y = O("y", g, !0)), (this.Z = O("z", h)), Object.freeze(this));
    }
    static CURVE() {
      return i;
    }
    static fromAffine(v) {
      const { x: g, y: h } = v || {};
      if (!v || !r.isValid(g) || !r.isValid(h)) throw new Error("invalid affine point");
      if (v instanceof A) throw new Error("projective point not allowed");
      return r.is0(g) && r.is0(h) ? A.ZERO : new A(g, h, r.ONE);
    }
    static fromBytes(v) {
      const g = A.fromAffine(m(Re(v, void 0, "point")));
      return (g.assertValidity(), g);
    }
    static fromHex(v) {
      return A.fromBytes(ue("pointHex", v));
    }
    get x() {
    ...
    precompute(v = 8, g = !0) {
      return (ae.createCache(this, v), g || this.multiply(bt), this);
    }
    assertValidity() {
      ge(this);
    }
    ...
    equals(v) {
      U(v);
      const { X: g, Y: h, Z: k } = this,
        { X: P, Y: T, Z: C } = v,
        I = r.eql(r.mul(g, C), r.mul(P, k)),
        _ = r.eql(r.mul(h, C), r.mul(T, k));
      return I && _;
    }
    negate() {
    ...
    add(v) {
      ...
      let D = r.mul(g, P),
        ...
        ce = r.add(g, h),
        W = r.add(P, T);
      ((ce = r.mul(ce, W)), (W = r.add(D, Z)), (ce = r.sub(ce, W)), (W = r.add(g, k)));
      let ie = r.add(P, C);
      return (
        (W = r.mul(W, ie)),
        (ie = r.add(D, ne)),
    ...
    multiply(v) {
      const { endo: g } = t;
      if (!a.isValidNot0(v)) throw new Error("invalid scalar: out of range");
      let h, k;
      const P = (T) => ae.cached(this, T, (C) => an(A, C));
      if (g) {
        const { k1neg: T, k1: C, k2neg: I, k2: _ } = $(v),
          { p: R, f: te } = P(C),
          { p: K, f: D } = P(_);
        ((k = te.add(D)), (h = oe(g.beta, R, K, T, I)));
      } else {
        const { p: T, f: C } = P(v);
        ((h = T), (k = C));
      }
    ...
    multiplyUnsafe(v) {
      const { endo: g } = t,
        h = this;
      if (!a.isValid(v)) throw new Error("invalid scalar: out of range");
      if (v === ke || h.is0()) return A.ZERO;
      if (v === We) return h;
      if (ae.hasCache(this)) return this.multiply(v);
      if (g) {
        const { k1neg: k, k1: P, k2neg: T, k2: C } = $(v),
          { p1: I, p2: _ } = Co(A, h, P, C);
        return oe(g.beta, I, _, k, T);
      } else return ae.unsafe(h, v);
    }
    multiplyAndAddUnsafe(v, g, h) {
      const k = this.multiplyUnsafe(g).add(v.multiplyUnsafe(h));
    ...
    isTorsionFree() {
      ...
      return s === We ? !0 : v ? v(A, this) : ae.unsafe(this, o).is0();
    }
    clearCofactor() {
      const { clearCofactor: v } = t;
      return s === We ? this : v ? v(A, this) : this.multiplyUnsafe(s);
    }
    isSmallOrder() {
      return this.multiplyUnsafe(s).is0();
    }
    toBytes(v = !0) {
      return (Ut(v, "isCompressed"), this.assertValidity(), f(A, this, v));
    }
    toHex(v = !0) {
      return qe(this.toBytes(v));
    }
    toString() {
    ...
    static fromPrivateKey(v) {
      return A.BASE.multiply(Ke(a, v));
    }
  }
  ((A.BASE = new A(i.Gx, i.Gy, r.ONE)), (A.ZERO = new A(r.ZERO, r.ONE, r.ZERO)), (A.Fp = r), (A.Fn = a));
  const N = a.BITS,
    ae = new Io(A, t.endo ? Math.ceil(N / 2) : N);
...
function jo(e, t = {}) {
  const { Fn: n } = e,
    r = t.randomBytes || Ca,
    a = Object.assign(ii(e.Fp, n), { seed: ei(n.ORDER) });
  function i(f) {
    try {
      return !!Ke(n, f);
    } catch {
  ...
  function s(f, m) {
    const { publicKey: y, publicKeyUncompressed: b } = a;
    try {
      const E = f.length;
      return (m === !0 && E !== y) || (m === !1 && E !== b) ? !1 : !!e.fromBytes(f);
    } catch {
      return !1;
    }
  }
  function o(f = r(a.seed)) {
    return Ao(Re(f, a.seed, "seed"), n.ORDER);
  }
  function u(f, m = !0) {
    return e.BASE.multiply(Ke(n, f)).toBytes(m);
  }
  function c(f) {
    const m = o(f);
    return { secretKey: m, publicKey: u(m) };
  }
  function l(f) {
    if (typeof f == "bigint") return !1;
    if (f instanceof e) return !0;
    const { secretKey: m, publicKey: y, publicKeyUncompressed: b } = a;
    if (n.allowedLengths || m === y) return;
    const E = ue("key", f).length;
    return E === y || E === b;
  }
  function d(f, m, y = !0) {
    if (l(f) === !0) throw new Error("first arg must be private key");
    if (l(m) === !1) throw new Error("second arg must be public key");
    const b = Ke(n, f);
    return e.fromHex(m).multiply(b).toBytes(y);
  }
  return Object.freeze({
    ...
    utils: {
      ...
      isValidPrivateKey: i,
      randomPrivateKey: o,
      normPrivateKeyToScalar: (f) => Ke(n, f),
      precompute(f = 8, m = e.BASE) {
        return m.precompute(f, !1);
      },
    },
    lengths: a,
  });
...
function Do(e, t, n = {}) {
  (Ts(t),
    cr(
      n,
      {},
      { hmac: "function", lowS: "boolean", randomBytes: "function", bits2int: "function", bits2int_modN: "function" },
    ));
  const r = n.randomBytes || Ca,
    a = n.hmac || ((g, ...h) => _s(t, g, Pe(...h))),
    { Fp: i, Fn: s } = e,
    { ORDER: o, BITS: u } = s,
    { keygen: c, getPublicKey: l, getSharedSecret: d, utils: p, lengths: f } = jo(e, n),
    m = { prehash: !1, lowS: typeof n.lowS == "boolean" ? n.lowS : !1, format: void 0, extraEntropy: !1 },
    y = "compact";
  function b(g) {
    const h = o >> We;
    return g > h;
  ...
  function E(g, h) {
    if (!s.isValidNot0(h)) throw new Error(`invalid signature ${g}: out of range 1..Point.Fn.ORDER`);
    return h;
  }
  function w(g, h) {
    gn(h);
    const k = f.signature,
      P = h === "compact" ? k : h === "recovered" ? k + 1 : void 0;
    return Re(g, P, `${h} signature`);
  }
  class O {
    constructor(h, k, P) {
      ((this.r = E("r", h)), (this.s = E("s", k)), P != null && (this.recovery = P), Object.freeze(this));
    }
    static fromBytes(h, k = y) {
      w(h, k);
      let P;
      if (k === "der") {
        const { r: _, s: R } = xe.toSig(Re(h));
        return new O(_, R);
      }
      k === "recovered" && ((P = h[0]), (k = "compact"), (h = h.subarray(1)));
      const T = s.BYTES,
        C = h.subarray(0, T),
        I = h.subarray(T, T * 2);
      return new O(s.fromBytes(C), s.fromBytes(I), P);
    }
    static fromHex(h, k) {
      return this.fromBytes(Rt(h), k);
    }
    addRecoveryBit(h) {
      return new O(this.r, this.s, h);
    }
    recoverPublicKey(h) {
      const k = i.ORDER,
        { r: P, s: T, recovery: C } = this;
      if (C == null || ![0, 1, 2, 3].includes(C)) throw new Error("recovery id invalid");
      if (o * ri < k && C > 1) throw new Error("recovery id is ambiguous for h>1 curve");
      const _ = C === 2 || C === 3 ? P + o : P;
      if (!i.isValid(_)) throw new Error("recovery id 2 or 3 invalid");
      const R = i.toBytes(_),
        te = e.fromBytes(Pe(ai((C & 1) === 0), R)),
        K = s.inv(_),
        D = $(ue("msgHash", h)),
        Z = s.create(-D * K),
        ne = s.create(T * K),
        ce = e.BASE.multiplyUnsafe(Z).add(te.multiplyUnsafe(ne));
    ...
    toBytes(h = y) {
      if ((gn(h), h === "der")) return Rt(xe.hexFromSig(this));
      const k = s.toBytes(this.r),
        P = s.toBytes(this.s);
      if (h === "recovered") {
        if (this.recovery == null) throw new Error("recovery bit must be present");
        return Pe(Uint8Array.of(this.recovery), k, P);
      }
      return Pe(k, P);
    }
    toHex(h) {
      return qe(this.toBytes(h));
    }
    assertValidity() {}
    static fromCompact(h) {
      return O.fromBytes(ue("sig", h), "compact");
    }
    static fromDER(h) {
      return O.fromBytes(ue("sig", h), "der");
    }
    normalizeS() {
      return this.hasHighS() ? new O(this.r, s.neg(this.s), this.recovery) : this;
    }
    toDERRawBytes() {
      return this.toBytes("der");
    }
    toDERHex() {
      return qe(this.toBytes("der"));
    }
    toCompactRawBytes() {
      return this.toBytes("compact");
    }
    toCompactHex() {
      return qe(this.toBytes("compact"));
    }
  }
  const U =
      n.bits2int ||
    ...
    re = mt(u);
  function ge(g) {
    return (yo("num < 2^" + u, g, ke, re), s.toBytes(g));
  }
  function oe(g, h) {
    return (Re(g, void 0, "message"), h ? Re(t(g), void 0, "prehashed message") : g);
  }
  function A(g, h, k) {
    if (["recovered", "canonical"].some((Z) => Z in k)) throw new Error("sign() legacy options not supported");
    const { lowS: P, prehash: T, extraEntropy: C } = un(k, m);
    g = oe(g, T);
    const I = $(g),
      _ = Ke(s, h),
      R = [ge(_), ge(I)];
    if (C != null && C !== !1) {
      ...
      R.push(ue("extraEntropy", Z));
    }
    const te = Pe(...R),
      K = I;
    function D(Z) {
      const ne = U(Z);
      if (!s.isValidNot0(ne)) return;
      const ce = s.inv(ne),
        W = e.BASE.multiply(ne).toAffine(),
        ie = s.create(W.x);
      if (ie === ke) return;
      const yt = s.create(ce * s.create(K + ie * _));
      if (yt === ke) return;
      let Cr = (W.x === ie ? 0 : 2) | Number(W.y & We),
        Tr = yt;
      return (P && b(yt) && ((Tr = s.neg(yt)), (Cr ^= 1)), new O(ie, Tr, Cr));
    }
    return { seed: te, k2sig: D };
  }
  function N(g, h, k = {}) {
    g = ue("message", g);
    const { seed: P, k2sig: T } = A(g, h, k);
    return ho(t.outputLen, s.BYTES, a)(P, T);
  }
  function ae(g) {
    let h;
    const k = typeof g == "string" || rr(g),
      P = !k && g !== null && typeof g == "object" && typeof g.r == "bigint" && typeof g.s == "bigint";
    if (!k && !P) throw new Error("invalid signature, expected Uint8Array, hex string or Signature instance");
    if (P) h = new O(g.r, g.s);
    else if (k) {
      try {
        h = O.fromBytes(ue("sig", g), "der");
      } catch (T) {
        if (!(T instanceof xe.Err)) throw T;
      }
      if (!h)
        try {
          h = O.fromBytes(ue("sig", g), "compact");
        } catch {
          return !1;
        }
    }
  ...
  function M(g, h, k, P = {}) {
    const { lowS: T, prehash: C, format: I } = un(P, m);
    if (((k = ue("publicKey", k)), (h = oe(ue("message", h), C)), "strict" in P))
      throw new Error("options.strict was renamed to lowS");
    const _ = I === void 0 ? ae(g) : O.fromBytes(ue("sig", g), I);
    if (_ === !1) return !1;
    try {
      ...
      const { r: te, s: K } = _,
        ...
        ne = s.create(D * Z),
        ce = s.create(te * Z),
        W = e.BASE.multiplyUnsafe(ne).add(R.multiplyUnsafe(ce));
      return W.is0() ? !1 : s.create(W.x) === te;
    } catch {
      return !1;
    }
  }
  function v(g, h, k = {}) {
    const { prehash: P } = un(k, m);
    return ((h = oe(h, P)), O.fromBytes(g, "recovered").recoverPublicKey(h).toBytes());
  }
  return Object.freeze({
    keygen: c,
    getPublicKey: l,
...
function Mo(e) {
  const t = { a: e.a, b: e.b, p: e.Fp.ORDER, n: e.n, h: e.h, Gx: e.Gx, Gy: e.Gy },
    n = e.Fp;
  let r = e.allowedPrivateKeyLengths
    ? Array.from(new Set(e.allowedPrivateKeyLengths.map((s) => Math.ceil(s / 2))))
    : void 0;
  const a = Fe(t.n, { BITS: e.nBitLength, allowedLengths: r, modFromBytes: e.wrapPrivateKey }),
    i = {
      Fp: n,
      Fn: a,
...
function Lo(e) {
  const { CURVE: t, curveOpts: n } = Mo(e),
    r = {
      hmac: e.hmac,
...
function Fo(e, t) {
  const n = t.Point;
  return Object.assign({}, t, { ProjectivePoint: n, CURVE: Object.assign({}, e, Qa(n.Fn.ORDER, n.Fn.BITS)) });
}
function Go(e) {
  const { CURVE: t, curveOpts: n, hash: r, ecdsaOpts: a } = Lo(e),
    i = No(t, n),
    s = Do(i, r, a);
  return Fo(e, s);
}
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */ function dr(e, t) {
  const n = (r) => Go({ ...e, hash: r });
  return { ...n(t), create: n };
}
const zo = "@base-org/account",
  Ho = "2.4.0",
  si = { name: zo, version: Ho },
  Ko = "https://keys.coinbase.com/connect",
  bn = "https://rpc.wallet.coinbase.com",
  Jt = si.name,
  tt = si.version;
function oi(e, t) {
  let n;
...
const wn = (e) => (t) => {
  ...
  Vo = (e, t) => (n, r, a) => {
    ...
    const l = () => {
        ...
        return c.setItem(i.name, { state: y, version: i.version });
      },
      d = a.setState;
    a.setState = (y, b) => {
      (d(y, b), l());
    ...
    const m = () => {
      ...
      ((s = !1),
        o.forEach((w) => {
          var O;
          return w((O = r()) != null ? O : p);
        }));
      const E = ((b = i.onRehydrateStorage) == null ? void 0 : b.call(i, (y = r()) != null ? y : p)) || void 0;
      return wn(c.getItem.bind(c))(i.name)
        .then((w) => {
          if (w)
            if (typeof w.version == "number" && w.version !== i.version) {
              if (i.migrate) {
                const O = i.migrate(w.state, w.version);
                return O instanceof Promise ? O.then((U) => [!0, U]) : [!0, O];
              }
        ...
        .then((w) => {
          var O;
          const [U, $] = w;
          if (((f = i.merge($, (O = r()) != null ? O : p)), n(f, !0), U)) return l();
        })
        .then(() => {
          (E == null || E(f, void 0), (f = r()), (s = !0), u.forEach((w) => w(f)));
        })
        .catch((w) => {
          E == null || E(void 0, w);
        });
  ...
  Hr = (e) => {
    ...
    const n = new Set(),
      r = (c, l) => {
        ...
        if (!Object.is(d, t)) {
          const p = t;
          ((t = (l ?? (typeof d != "object" || d === null)) ? d : Object.assign({}, t, d)), n.forEach((f) => f(t, p)));
        }
      },
      a = () => t,
      o = { setState: r, getState: a, getInitialState: () => u, subscribe: (c) => (n.add(c), () => n.delete(c)) },
      u = (t = e(r, a, o));
    return o;
  },
  lr = (e) => (e ? Hr(e) : Hr),
  ...
  Wo = () => ({ keys: {} }),
  Jo = () => ({ account: {} }),
  Yo = () => ({ subAccount: void 0 }),
  Xo = () => ({ subAccountConfig: {} }),
  Qo = () => ({ spendPermissions: [] }),
  $o = () => ({ config: { version: tt } }),
  Q = lr(
    qo((...e) => ({ ...Zo(...e), ...Wo(...e), ...Jo(...e), ...Yo(...e), ...Qo(...e), ...$o(...e), ...Xo(...e) }), {
  ...
  ec = {
    ...
    set: (e) => {
      Q.setState((t) => ({ subAccountConfig: { ...t.subAccountConfig, ...e } }));
    },
    clear: () => {
      Q.setState({ subAccountConfig: {} });
    },
  },
  tc = {
    get: () => Q.getState().subAccount,
    set: (e) => {
      Q.setState((t) => ({ subAccount: t.subAccount ? { ...t.subAccount, ...e } : { address: e.address, ...e } }));
    },
    clear: () => {
      Q.setState({ subAccount: void 0 });
    },
  },
  fr = {
    ...
    clear: () => {
      Q.setState({ spendPermissions: [] });
    },
  },
  nc = {
    get: () => Q.getState().account,
    set: (e) => {
      Q.setState((t) => ({ account: { ...t.account, ...e } }));
    },
    clear: () => {
      Q.setState({ account: {} });
    },
  ...
  ci = {
    ...
    set: (e) => {
      Q.setState((t) => ({ config: { ...t.config, ...e } }));
    },
  },
  ic = { subAccounts: tc, subAccountsConfig: ec, spendPermissions: fr, account: nc, chains: rc, keys: ac, config: ci },
  x = { ...Q, ...ic },
  sc =
  ...
  cc = () => {
    if (typeof window < "u") {
      const e = x.config.get().deviceId ?? (crypto == null ? void 0 : crypto.randomUUID()) ?? "";
      if (window.ClientAnalytics) {
        const { init: t, identify: n, PlatformName: r } = window.ClientAnalytics;
        (t({
          isProd: !0,
          ...
          n({ deviceId: e }),
          x.config.set({ deviceId: e }));
      }
    }
  },
  uc = "0xba5ed110efdba3d005bfc882d75358acbbb85842",
  he = [
  ...
  ui = [
    { inputs: [{ name: "implementation_", type: "address" }], stateMutability: "payable", type: "constructor" },
  ...
  di = "Unspecified error message.",
  dc = "Unspecified server error.";
function pr(e, t = di) {
  if (e && Number.isInteger(e)) {
    const n = e.toString();
    if (xn(vn, n)) return vn[n].message;
    if (li(e)) return dc;
  }
  return t;
}
...
function fc(e, { shouldIncludeStack: t = !1 } = {}) {
  const n = {};
  if (e && typeof e == "object" && !Array.isArray(e) && xn(e, "code") && lc(e.code)) {
    const r = e;
    ((n.code = r.code),
      r.message && typeof r.message == "string"
        ? ((n.message = r.message), xn(r, "data") && (n.data = r.data))
        : ((n.message = pr(n.code)), (n.data = { originalError: Kr(e) })));
  } else
    ((n.code = Y.rpc.internal), (n.message = Vr(e, "message") ? e.message : di), (n.data = { originalError: Kr(e) }));
  return (t && (n.stack = Vr(e, "stack") ? e.stack : void 0), n);
}
function li(e) {
...
const S = {
  rpc: {
    parse: (e) => fe(Y.rpc.parse, e),
    invalidRequest: (e) => fe(Y.rpc.invalidRequest, e),
    invalidParams: (e) => fe(Y.rpc.invalidParams, e),
    methodNotFound: (e) => fe(Y.rpc.methodNotFound, e),
    internal: (e) => fe(Y.rpc.internal, e),
    server: (e) => {
    ...
    invalidInput: (e) => fe(Y.rpc.invalidInput, e),
    resourceNotFound: (e) => fe(Y.rpc.resourceNotFound, e),
    resourceUnavailable: (e) => fe(Y.rpc.resourceUnavailable, e),
    transactionRejected: (e) => fe(Y.rpc.transactionRejected, e),
    methodNotSupported: (e) => fe(Y.rpc.methodNotSupported, e),
    limitExceeded: (e) => fe(Y.rpc.limitExceeded, e),
  },
  provider: {
    userRejectedRequest: (e) => Ge(Y.provider.userRejectedRequest, e),
    unauthorized: (e) => Ge(Y.provider.unauthorized, e),
    unsupportedMethod: (e) => Ge(Y.provider.unsupportedMethod, e),
    disconnected: (e) => Ge(Y.provider.disconnected, e),
    chainDisconnected: (e) => Ge(Y.provider.chainDisconnected, e),
    unsupportedChain: (e) => Ge(Y.provider.unsupportedChain, e),
    custom: (e) => {
      if (!e || typeof e != "object" || Array.isArray(e))
...
function fe(e, t) {
  const [n, r] = fi(t);
  return new mr(e, n || pr(e), r);
}
function Ge(e, t) {
  const [n, r] = fi(t);
  return new pi(e, n || pr(e), r);
}
function fi(e) {
  if (e) {
...
class mr extends Error {
  constructor(n, r, a) {
    ...
    L(this, "code");
    L(this, "data");
    ((this.code = n), a !== void 0 && (this.data = a));
  }
}
class pi extends mr {
  constructor(t, n, r) {
    if (!pc(t)) throw new Error('"code" must be an integer such that: 1000 <= code <= 4999');
    super(t, n, r);
  }
}
function pc(e) {
...
function mc(e) {
  try {
    ...
    return new mr(t.code, t.message, t.data);
  } catch {
    return null;
  }
}
function me(e, t, n) {
  if (e == null) throw t ?? S.rpc.invalidParams({ message: "value must be present", data: e });
}
function Ae(e, t) {
  if (!Array.isArray(e)) throw S.rpc.invalidParams({ message: t ?? "value must be an array", data: e });
}
const yc = `Base Account SDK requires the Cross-Origin-Opener-Policy header to not be set to 'same-origin'. This is to ensure that the SDK can communicate with the Base Account app.
...
Please see https://docs.base.org/smart-wallet/quickstart#cross-origin-opener-policy for more information.`,
    ...
    return {
      ...
      checkCrossOriginOpenerPolicy: async () => {
        ...
        try {
          ...
          ((e = n.headers.get("Cross-Origin-Opener-Policy") ?? "null"), e === "same-origin" && console.error(yc));
        } catch (t) {
  ...
  { checkCrossOriginOpenerPolicy: gc, getCrossOriginOpenerPolicy: bc } = hc();
function wc(e) {
  if (e) {
    if (e.attribution && e.attribution.auto !== void 0 && e.attribution.dataSuffix !== void 0)
      throw new Error("Attribution cannot contain both auto and dataSuffix properties");
    if (e.telemetry && typeof e.telemetry != "boolean") throw new Error("Telemetry must be a boolean");
  }
}
function Zr(e) {
    ...
    ((a = window.ClientAnalytics) == null ||
      a.logEvent(
        e,
        {
          ...
          sdkVersion: tt,
          sdkName: Jt,
          appName: ((r = x.config.get().metadata) == null ? void 0 : r.appName) ?? "",
...
const vc = () => {
    q("communicator.popup_setup.started", { action: z.unknown, componentType: G.unknown }, H.high);
  },
  xc = () => {
    q("communicator.popup_setup.completed", { action: z.unknown, componentType: G.unknown }, H.high);
  },
  Ec = () => {
    q("communicator.popup_unload.received", { action: z.unknown, componentType: G.unknown }, H.high);
  },
  yr = ({ dialogContext: e }) => {
    q(`dialog.${e}.shown`, { action: z.render, componentType: G.modal, dialogContext: e }, H.high);
  },
  yi = ({ dialogContext: e }) => {
    q(`dialog.${e}.dismissed`, { action: z.dismiss, componentType: G.modal, dialogContext: e }, H.high);
  },
  Me = ({ dialogContext: e, dialogAction: t }) => {
    q(
      `dialog.${e}.action_clicked`,
      { action: z.click, componentType: G.button, dialogContext: e, dialogAction: t },
      H.high,
    );
  },
  Sc = `
...
`,
  Wr = "BaseSans-Regular";
function kc() {
  if (document.head.querySelector(`style[base-sdk-font="${Wr}"]`)) return;
  const t = document.createElement("style");
  (t.setAttribute("base-sdk-font", Wr), (t.textContent = Sc), document.head.appendChild(t));
}
var Yt,
  F,
  hi,
...
function vi(e, t, n) {
  var r,
    ...
    i,
    s = {};
  for (i in t) i == "key" ? (r = t[i]) : i == "ref" ? (a = t[i]) : (s[i] = t[i]);
  if (
    (arguments.length > 2 && (s.children = arguments.length > 3 ? Yt.call(arguments, 2) : n),
    typeof e == "function" && e.defaultProps != null)
  )
    for (i in e.defaultProps) s[i] === void 0 && (s[i] = e.defaultProps[i]);
  return Ct(e, s, r, a, null);
}
...
function Yr(e) {
  ((!e.__d && (e.__d = !0) && Be.push(e) && !jt.__r++) || Jr !== F.debounceRendering) &&
    ((Jr = F.debounceRendering) || gi)(jt);
}
function jt() {
  var e, t, n, r, a, i, s, o;
  for (Be.sort(En); (e = Be.shift()); )
    e.__d &&
      ((t = Be.length),
      (r = void 0),
      (i = (a = (n = e).__v).__e),
      ...
      n.__P &&
        (((r = Oe({}, a)).__v = a.__v + 1),
        F.vnode && F.vnode(r),
        br(n.__P, r, a, n.__n, n.__P.namespaceURI, 32 & a.__u ? [i] : null, s, i ?? Ye(a), !!(32 & a.__u), o),
        (r.__v = a.__v),
        (r.__.__k[r.__i] = r),
        ki(s, r, o),
        r.__e != i && xi(r)),
      Be.length > t && Be.sort(En));
  jt.__r = 0;
}
function Ei(e, t, n, r, a, i, s, o, u, c, l) {
  var d,
    p,
    f,
    m,
    ...
    b = (r && r.__k) || bi,
    E = t.length;
  for (n.__d = u, Pc(n, t, b), u = n.__d, d = 0; d < E; d++)
    (f = n.__k[d]) != null &&
      ((p = f.__i === -1 ? lt : b[f.__i] || lt),
      (f.__i = d),
      br(e, f, p, a, i, s, o, u, c, l),
      (m = f.__e),
      f.ref && p.ref != f.ref && (p.ref && wr(p.ref, null, f), l.push(f.ref, f.__c || m, f)),
      y == null && m != null && (y = m),
      ...
      ? ((s = r + d),
        ((a = e.__k[r] =
          typeof a == "string" || typeof a == "number" || typeof a == "bigint" || a.constructor == String
            ? Ct(null, a, null, null, null)
            : gr(a)
              ? Ct(Xt, { children: a }, null, null, null)
              : a.constructor === void 0 && a.__b > 0
                ? Ct(a.type, a.props, a.key, a.ref ? a.ref : null, a.__v)
                : a).__ = e),
        (a.__b = e.__b + 1),
        (i = null),
        (o = a.__i = Oc(a, n, s, l)) !== -1 && (l--, (i = n[o]) && (i.__u |= 131072)),
        i == null || i.__v === null
          ? (o == -1 && d--, typeof a.type != "function" && (a.__u |= 65536))
          : o !== s && (o == s - 1 ? d-- : o == s + 1 ? d++ : (o > s ? d-- : d++, (a.__u |= 65536))))
      : (a = e.__k[r] = null);
  if (l)
    for (r = 0; r < c; r++)
      (i = n[r]) != null && (131072 & i.__u) == 0 && (i.__e == e.__d && (e.__d = Ye(i)), Ai(i, i));
}
function Si(e, t, n) {
  var r, a;
  if (typeof e.type == "function") {
    for (r = e.__k, a = 0; r && a < r.length; a++) r[a] && ((r[a].__ = e), (t = Si(r[a], t, n)));
    return t;
  }
  e.__e != t && (t && e.type && !n.contains(t) && (t = Ye(e)), n.insertBefore(e.__e, t || null), (t = e.__e));
...
function Oc(e, t, n, r) {
  var a = e.key,
    ...
    o = n + 1,
    u = t[n];
  if (u === null || (u && a == u.key && i === u.type && (131072 & u.__u) == 0)) return n;
  if (r > (u != null && (131072 & u.__u) == 0 ? 1 : 0))
    for (; s >= 0 || o < t.length; ) {
      if (s >= 0) {
        if ((u = t[s]) && (131072 & u.__u) == 0 && a == u.key && i === u.type) return s;
        s--;
      }
      if (o < t.length) {
        if ((u = t[o]) && (131072 & u.__u) == 0 && a == u.key && i === u.type) return o;
        o++;
      }
    }
  return -1;
...
function Xr(e, t, n) {
  t[0] === "-"
    ? e.setProperty(t, n ?? "")
    : (e[t] = n == null ? "" : typeof n != "number" || Ac.test(t) ? n : n + "px");
}
  ...
  e: if (t === "style")
    ...
    ((i = t !== (t = t.replace(/(PointerCapture)$|Capture$/i, "$1"))),
      ...
      n
        ? r
          ? (n.u = r.u)
          : ((n.u = hr), e.addEventListener(t, i ? kn : Sn, i))
        : e.removeEventListener(t, i ? kn : Sn, i));
  else {
...
function br(e, t, n, r, a, i, s, o, u, c) {
  var l,
    d,
    p,
    f,
  ...
  (128 & n.__u && ((u = !!(32 & n.__u)), (i = [(o = t.__e = n.__e)])), (l = F.__b) && l(t));
  e: if (typeof N == "function")
    try {
      if (
        ((E = t.props),
        (w = "prototype" in N && N.prototype.render),
        (O = (l = N.contextType) && r[l.__c]),
        (U = l ? (O ? O.props.value : l.__) : r),
        n.__c
          ? (b = (d = t.__c = n.__c).__ = d.__E)
          : (w ? (t.__c = d = new N(E, U)) : ((t.__c = d = new Tt(E, U)), (d.constructor = N), (d.render = Cc)),
            O && O.sub(d),
            (d.props = E),
            d.state || (d.state = {}),
            (d.context = U),
            ...
            (d.__h = []),
            (d._sb = [])),
        w && d.__s == null && (d.__s = d.state),
        w &&
          N.getDerivedStateFromProps != null &&
          (d.__s == d.state && (d.__s = Oe({}, d.__s)), Oe(d.__s, N.getDerivedStateFromProps(E, d.__s))),
        (f = d.props),
        (m = d.state),
        (d.__v = t),
        p)
      )
        (w && N.getDerivedStateFromProps == null && d.componentWillMount != null && d.componentWillMount(),
          w && d.componentDidMount != null && d.__h.push(d.componentDidMount));
      else {
        if (
          (w &&
            N.getDerivedStateFromProps == null &&
            ...
            d.componentWillReceiveProps(E, U),
          !d.__e &&
            ((d.shouldComponentUpdate != null && d.shouldComponentUpdate(E, d.__s, U) === !1) || t.__v === n.__v))
        ) {
          for (
            t.__v !== n.__v && ((d.props = E), (d.state = d.__s), (d.__d = !1)),
              t.__e = n.__e,
              t.__k = n.__k,
              t.__k.some(function (ae) {
                ae && (ae.__ = t);
              }),
              $ = 0;
            $ < d._sb.length;
        ...
        (d.componentWillUpdate != null && d.componentWillUpdate(E, d.__s, U),
          w &&
      ...
      if (((d.context = U), (d.props = E), (d.__P = e), (d.__e = !1), (re = F.__r), (ge = 0), w)) {
        for (
          d.state = d.__s, d.__d = !1, re && re(t), l = d.render(d.props, d.state, d.context), oe = 0;
          oe < d._sb.length;
          oe++
        )
          d.__h.push(d._sb[oe]);
        ...
        do ((d.__d = !1), re && re(t), (l = d.render(d.props, d.state, d.context)), (d.state = d.__s));
        while (d.__d && ++ge < 25);
      ((d.state = d.__s),
        d.getChildContext != null && (r = Oe(Oe({}, r), d.getChildContext())),
        w && !p && d.getSnapshotBeforeUpdate != null && (y = d.getSnapshotBeforeUpdate(f, m)),
        Ei(
          e,
          gr((A = l != null && l.type === Xt && l.key == null ? l.props.children : l)) ? A : [A],
          t,
          n,
          r,
          a,
  ...
  else i == null && t.__v === n.__v ? ((t.__k = n.__k), (t.__e = n.__e)) : (t.__e = Ic(n.__e, t, n, r, a, i, s, u, c));
  (l = F.diffed) && l(t);
}
function ki(e, t, n) {
  t.__d = void 0;
...
function Ic(e, t, n, r, a, i, s, o, u) {
  ...
  if (
    ...
    for (c = 0; c < i.length; c++)
      if ((f = i[c]) && "setAttribute" in f == !!w && (w ? f.localName === w : f.nodeType === 3)) {
        ((e = f), (i[c] = null));
        break;
      }
  }
  if (e == null) {
    if (w === null) return document.createTextNode(E);
    ((e = document.createElementNS(a, w, E.is && E)), o && (F.__m && F.__m(t, i), (o = !1)), (i = null));
  }
  if (w === null) b === E || (o && e.data === E) || (e.data = E);
  else {
    if (((i = i && Yt.call(e.childNodes)), (b = n.props || lt), !o && i != null))
      for (b = {}, c = 0; c < e.attributes.length; c++) b[(f = e.attributes[c]).name] = f.value;
    for (c in b)
      if (((f = b[c]), c != "children")) {
        ...
        c == "children"
          ...
          : c == "dangerouslySetInnerHTML"
            ...
            : c == "value"
              ...
              : c == "checked"
                ? (y = f)
                : (o && typeof f != "function") || b[c] === f || wt(e, c, f, b[c], a));
    if (l) (o || (d && (l.__html === d.__html || l.__html === e.innerHTML)) || (e.innerHTML = l.__html), (t.__k = []));
    else if (
      (d && (e.innerHTML = ""),
      Ei(
        e,
        ...
        n,
        r,
        w === "foreignObject" ? "http://www.w3.org/1999/xhtml" : a,
        i,
        s,
        i ? i[0] : n.__k && Ye(n, 0),
        o,
      ...
      for (c = i.length; c--; ) wi(i[c]);
    o ||
      ((c = "value"),
      w === "progress" && m == null
        ? e.removeAttribute("value")
        : m !== void 0 &&
          (m !== e[c] || (w === "progress" && !m) || (w === "option" && m !== b[c])) &&
          wt(e, c, m, b[c], a),
      (c = "checked"),
      y !== void 0 && y !== e[c] && wt(e, c, y, b[c], a));
  }
  return e;
}
function wr(e, t, n) {
...
function Ai(e, t, n) {
  ...
  if ((r = e.__k)) for (a = 0; a < r.length; a++) r[a] && Ai(r[a], t, n || typeof e.type != "function");
  (n || wi(e.__e), (e.__c = e.__ = e.__e = e.__d = void 0));
}
function Cc(e, t, n) {
...
function $r(e, t, n) {
  ...
  (F.__ && F.__(e, t),
    ...
    br(
      t,
      (e = t.__k = vi(Xt, null, [e])),
      a || lt,
      lt,
      t.namespaceURI,
      a ? null : t.firstChild ? Yt.call(t.childNodes) : null,
      i,
...
((Yt = bi.slice),
        ...
        if ((a = t.__c) && !a.__)
          try {
            if (
              ...
              a.componentDidCatch != null && (a.componentDidCatch(e, r || {}), (s = a.__d)),
              s)
            )
              return (a.__E = a);
          } catch (o) {
  ...
  (Tt.prototype.setState = function (e, t) {
    ...
    ((n = this.__s != null && this.__s !== this.state ? this.__s : (this.__s = Oe({}, this.state))),
      ...
      e && Oe(n, e),
      e != null && this.__v && (t && this._sb.push(t), Yr(this)));
  }),
  (Tt.prototype.forceUpdate = function (e) {
    this.__v && ((this.__e = !0), e && this.__h.push(e), Yr(this));
  }),
  (Tt.prototype.render = Xt),
  (Be = []),
  (gi = typeof Promise == "function" ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout),
  (En = function (e, t) {
...
function Pi(e) {
  ...
  if (typeof e == "string" || typeof e == "number") r += e;
    ...
    if (Array.isArray(e)) for (t = 0; t < e.length; t++) e[t] && (n = Pi(e[t])) && (r && (r += " "), (r += n));
  ...
  if (
    ...
    var a = function (o, u, c) {
      ...
      return (
        ...
        !(!d && r.__c.props === o) && (!i || i.call(this, o, u, c))
      );
    };
    X.u = !0;
    var i = X.shouldComponentUpdate,
      s = X.componentWillUpdate;
    ((X.componentWillUpdate = function (o, u, c) {
      if (this.__e) {
        var l = i;
        ((i = void 0), a(o, u, c), (i = l));
      }
      s && s.call(this, o, u, c);
    }),
...
function On(e, t) {
  var n = vr(ft++, 3);
  !ee.__s && Ii(n.__H, t) && ((n.__ = e), (n.i = t), X.__H.__h.push(n));
}
function Dc(e, t) {
  var n = vr(ft++, 7);
  return (Ii(n.__H, t) && ((n.__ = e()), (n.__H = t), (n.__h = e)), n.__);
}
function Mc() {
  for (var e; (e = Oi.shift()); )
    if (e.__P && e.__H)
      try {
        (e.__H.__h.forEach(_t), e.__H.__h.forEach(In), (e.__H.__h = []));
      } catch (t) {
...
((ee.__b = function (e) {
  ...
  (ee.__r = function (e) {
    ...
    (t &&
      (dn === X
        ...
        : (t.__h.forEach(_t), t.__h.forEach(In), (t.__h = []), (ft = 0))),
      (dn = X));
  }),
  (ee.diffed = function (e) {
    ...
    (t &&
      t.__H &&
      (t.__H.__h.length &&
        ((Oi.push(t) !== 1 && ea === ee.requestAnimationFrame) || ((ea = ee.requestAnimationFrame) || Lc)(Mc)),
...
class Hc {
  constructor() {
    L(this, "items", new Map());
    L(this, "nextItemKey", 0);
    L(this, "root", null);
  }
  attach(t) {
  ...
  clear() {
    (this.items.clear(), this.root && $r(null, this.root));
  }
  render() {
    this.root &&
      $r(
          ...
          children: J(Kc, {
            children: Array.from(this.items.entries()).map(([t, n]) =>
              vi(Vc, {
                ...
                handleClose: () => {
                  var r;
                  (this.clear(), (r = n.onClose) == null || r.call(n));
                },
              }),
            ),
          }),
...
const Kc = (e) => {
    const [t, n] = Le(0),
      ...
      u = (l) => {
        if (!r) return;
        const p = l.touches[0].clientY - i;
        p > 0 && (n(p), l.preventDefault());
      },
      c = () => {
        if (r)
          if ((a(!1), t > 100)) {
            const l = document.querySelector(".-base-acc-sdk-dialog-instance-header-close");
            l && l.click();
          } else n(0);
      };
    return J("div", {
      class: An("-base-acc-sdk-dialog-container"),
      children: [
        J("style", { children: Fc }),
        J("div", {
          ...
          children: J("div", {
            ...
            style: { transform: `translateY(${t}px)`, transition: r ? "none" : "transform 0.2s ease-out" },
            children: [J(zc, {}), e.children],
          }),
        }),
      ],
    });
  },
  Vc = ({ title: e, message: t, actionItems: n, handleClose: r }) => {
    const [a, i] = Le(!0),
      [s, o] = Le(!0),
      [u, c] = Le(null);
    (On(() => {
      ...
      On(() => {
        (async () => {
          var m;
          const f = (m = x.account.get().accounts) == null ? void 0 : m[0];
          if (f) {
            const y = await _c(f);
            c(y);
          }
    ...
    const l = Dc(() => (u ? `Signed in as ${u}` : "Base Account"), [u]),
      d = !s;
    return J("div", {
      class: An("-base-acc-sdk-dialog-instance", a && "-base-acc-sdk-dialog-instance-hidden"),
      children: [
        J("div", {
          ...
          children: [
            J("div", {
              ...
              children: [
                J(Nc, { fill: "blue" }),
                d && J("div", { class: "-base-acc-sdk-dialog-instance-header-icon-and-title-title", children: l }),
              ],
            }),
            J("div", {
              class: "-base-acc-sdk-dialog-instance-header-close",
              onClick: r,
              children: J("img", { src: Gc, class: "-base-acc-sdk-dialog-instance-header-close-icon" }),
            }),
          ],
        }),
        J("div", {
          ...
          children: [
            J("div", { class: "-base-acc-sdk-dialog-instance-content-title", children: e }),
            J("div", { class: "-base-acc-sdk-dialog-instance-content-message", children: t }),
          ],
        }),
        n &&
          n.length > 0 &&
              ...
              J(
                "button",
                {
                  class: An(
                    ...
                    p.variant === "primary" && "-base-acc-sdk-dialog-instance-button-primary",
                    p.variant === "secondary" && "-base-acc-sdk-dialog-instance-button-secondary",
                  ),
                  onClick: p.onClick,
                  children: p.text,
                },
...
function xr() {
  if (!vt) {
    ...
    ((e.className = "-base-acc-sdk-css-reset"), document.body.appendChild(e), (vt = new Hc()), vt.attach(e));
  }
  return (kc(), vt);
}
const ca = 420,
  ua = 700,
  qc = "{app} wants to continue in Base Account",
  Zc = "This action requires your permission to open a new window.";
function Wc(e) {
  const t = (window.innerWidth - ca) / 2 + window.screenX,
    n = (window.innerHeight - ua) / 2 + window.screenY;
  Yc(e);
  function r() {
    const i = `wallet_${crypto.randomUUID()}`,
      s = window.open(e, i, `width=${ca}, height=${ua}, left=${t}, top=${n}`);
    return (s == null || s.focus(), s || null);
  }
  const a = r();
  return a ? Promise.resolve(a) : Xc(r);
}
function Jc(e) {
  e && !e.closed && e.close();
}
function Yc(e) {
  const t = { sdkName: Jt, sdkVersion: tt, origin: window.location.origin, coop: bc() };
  for (const [n, r] of Object.entries(t)) e.searchParams.has(n) || e.searchParams.append(n, r.toString());
}
function Xc(e) {
  var r;
  const t = ((r = x.config.get().metadata) == null ? void 0 : r.appName) ?? "App",
    n = xr();
  return new Promise((a, i) => {
    (yr({ dialogContext: "popup_blocked" }),
      n.presentItem({
        title: qc.replace("{app}", t),
        message: Zc,
        onClose: () => {
          (Me({ dialogContext: "popup_blocked", dialogAction: "cancel" }),
        ...
        actionItems: [
          {
            ...
            variant: "primary",
            onClick: () => {
              Me({ dialogContext: "popup_blocked", dialogAction: "confirm" });
              const s = e();
...
class Qc {
  constructor({ url: t = Ko, metadata: n, preference: r }) {
    L(this, "metadata");
    L(this, "preference");
    L(this, "url");
    L(this, "popup", null);
    L(this, "listeners", new Map());
    L(this, "postMessage", async (t) => {
      (await this.waitForPopupLoaded()).postMessage(t, this.url.origin);
    });
    L(this, "postRequestAndWaitForResponse", async (t) => {
      const n = this.onMessage(({ requestId: r }) => r === t.id);
      ...
      async (t) =>
        new Promise((n, r) => {
          const a = (i) => {
            ...
            const s = i.data;
            t(s) && (n(s), window.removeEventListener("message", a), this.listeners.delete(a));
          };
          (window.addEventListener("message", a), this.listeners.set(a, { reject: r }));
        }),
    );
    L(this, "disconnect", () => {
      (Jc(this.popup),
    ...
    L(this, "waitForPopupLoaded", async () =>
      this.popup && !this.popup.closed
        ? (this.popup.focus(), this.popup)
        : (vc(),
          (this.popup = await Wc(this.url)),
...
function $c(e) {
  const t = fc(tu(e), { shouldIncludeStack: !0 }),
    n = new URL("https://docs.cloud.coinbase.com/wallet-sdk/docs/errors");
  return (
    n.searchParams.set("version", tt),
...
function tu(e) {
  if (typeof e == "string") return { message: e, code: Y.rpc.internal };
  if (eu(e)) {
    const t = e.errorMessage,
      n = e.errorCode ?? (t.match(/(denied|rejected)/i) ? Y.provider.userRejectedRequest : void 0);
    return { ...e, message: t, code: n, data: { method: e.method } };
  }
  return e;
}
class nu extends Bs {}
const ru = ({ method: e, correlationId: t }) => {
    q(
      "provider.request.started",
      { action: z.unknown, componentType: G.unknown, method: e, signerType: "base-account", correlationId: t },
      H.high,
    );
  },
  au = ({ method: e, correlationId: t, errorMessage: n }) => {
    q(
  ...
  He = (e) => ("message" in e && typeof e.message == "string" ? e.message : "");
function su() {
  return (e) => e;
}
const Dt = su();
...
function Bi(e) {
  return Dt(`0x${BigInt(e).toString(16)}`);
}
function du(e) {
  return e.startsWith("0x") || e.startsWith("0X");
}
function Ri(e) {
  return du(e) ? e.slice(2) : e;
}
function lu(e) {
...
function Cn(e, t = !1) {
  if (typeof e == "string") {
    const n = Ri(e).toLowerCase();
    if (_i.test(n)) return Dt(t ? `0x${n}` : n);
  }
  throw S.rpc.invalidParams(`"${String(e)}" is not a hexadecimal string`);
}
function fu(e, t = !1) {
  let n = Cn(e, !1);
  return (n.length % 2 === 1 && (n = Dt(`0${n}`)), t ? Dt(`0x${n}`) : n);
}
function pu(e) {
  if (typeof e == "number" && Number.isInteger(e)) return ln(e);
  if (typeof e == "string") {
    if (ou.test(e)) return ln(Number(e));
    if (lu(e)) return ln(Number(BigInt(fu(e, !0))));
  }
  throw S.rpc.invalidParams(`Not an integer: ${String(e)}`);
}
const mu = ({ method: e, correlationId: t }) => {
    ...
    q(
      "scw_signer.handshake.started",
      {
        ...
        method: e,
        correlationId: t,
        subAccountCreation: n == null ? void 0 : n.creation,
        subAccountDefaultAccount: n == null ? void 0 : n.defaultAccount,
        subAccountFunding: n == null ? void 0 : n.funding,
      },
      H.high,
    );
  },
  yu = ({ method: e, correlationId: t, errorMessage: n }) => {
    const r = x.subAccountsConfig.get();
    q(
      "scw_signer.handshake.error",
      {
        ...
        correlationId: t,
        errorMessage: n,
        subAccountCreation: r == null ? void 0 : r.creation,
        subAccountDefaultAccount: r == null ? void 0 : r.defaultAccount,
        subAccountFunding: r == null ? void 0 : r.funding,
      },
      H.high,
    );
  },
  hu = ({ method: e, correlationId: t }) => {
    const n = x.subAccountsConfig.get();
    q(
  ...
  bu = ({ method: e, correlationId: t, errorMessage: n }) => {
    const r = x.subAccountsConfig.get();
    q(
  ...
  Eu = ({ method: e, correlationId: t, errorMessage: n }) => {
    const r = x.subAccountsConfig.get();
    q(
  ...
  Iu = ({ method: e, correlationId: t, errorMessage: n }) => {
    const r = x.subAccountsConfig.get();
    q(
  ...
  Tu = "0x5FF137D4b0FDCD49DcA30c7CF57E578a026d2789";
function Ui(e, t = {}) {
  const { forHash: n } = t,
    { authorization: r, factory: a, factoryData: i } = e;
  return n && (a === "0x7702" || a === "0x7702000000000000000000000000000000000000")
    ? r
      ? De([r.address, i ?? "0x"])
...
function Ni(e, t = {}) {
  const {
    ...
    m = De([de(j(f || 0n), { size: 16 }), de(j(n || 0n), { size: 16 })]),
    y = Ui(e, t),
    b = De([de(j(a || 0n), { size: 16 }), de(j(i || 0n), { size: 16 })]),
    E = e.nonce ?? 0n,
    w = s
      ? De([
          s,
          ...
          de(j(u || 0n), { size: 16 }),
          o || "0x",
          ...(c ? (t.forHash ? [da] : [c, de(j(Ta(c)), { size: 2 }), da]) : []),
        ])
      : "0x",
...
function Ru(e) {
  ...
  if (r === "0.8" || r === "0.9") return Zt(Bu({ chainId: t, entryPointAddress: n, userOperation: a }));
  const y = (() => {
    var b, E;
    if (r === "0.6") {
      const w = (b = a.initCode) == null ? void 0 : b.slice(0, 42),
        O = (E = a.initCode) == null ? void 0 : E.slice(42),
        U = Ui({ authorization: i, factory: w, factoryData: O }, { forHash: !0 });
      return Ve(
        [
          { type: "address" },
          { type: "uint256" },
        ...
        [f, l, ve(U), ve(s), o, m, p, u, c, ve(d)],
      );
    }
    if (r === "0.7") {
      const w = Ni(a, { forHash: !0 });
      return Ve(
        [
          { type: "address" },
          { type: "uint256" },
        ...
        [
          ...
          w.gasFees,
          ve(w.paymasterAndData),
        ],
      );
    }
    throw new Error(`entryPointVersion "${r}" not supported.`);
  })();
  return ve(Ve([{ type: "bytes32" }, { type: "address" }, { type: "uint256" }], [ve(y), n, BigInt(t)]));
}
async function Uu(e) {
  const {
    extend: t,
    nonceKeyManager: n = ao({
      source: {
        get() {
          return Date.now();
        },
  ...
  return {
    ...
    async getNonce(s) {
      const o =
        (s == null ? void 0 : s.key) ??
        BigInt(await n.consume({ address: i, chainId: e.client.chain.id, client: e.client }));
      return e.getNonce
        ? await e.getNonce({ ...s, key: o })
        : await yn(e.client, {
            abi: Rs(["function getNonce(address, uint192) pure returns (uint256)"]),
    ...
    async isDeployed() {
      return a ? !0 : ((a = !!(await Se(e.client, _a, "getCode")({ address: i }))), a);
    },
    ...(e.sign
      ? {
          async sign(s) {
            const [{ factory: o, factoryData: u }, c] = await Promise.all([this.getFactoryArgs(), e.sign(s)]);
            return o && u ? nn({ address: o, data: u, signature: c }) : c;
          },
        }
      : {}),
    async signMessage(s) {
      const [{ factory: o, factoryData: u }, c] = await Promise.all([this.getFactoryArgs(), e.signMessage(s)]);
      return o && u && o !== "0x7702" ? nn({ address: o, data: u, signature: c }) : c;
    },
    async signTypedData(s) {
      const [{ factory: o, factoryData: u }, c] = await Promise.all([this.getFactoryArgs(), e.signTypedData(s)]);
      return o && u && o !== "0x7702" ? nn({ address: o, data: u, signature: c }) : c;
    },
    type: "smart",
  };
...
Object.defineProperty(Tn, "message", { enumerable: !0, configurable: !0, writable: !0, value: /aa20/ });
class Xe extends B {
  constructor({ cause: t, data: n, message: r } = {}) {
    ...
    (super(`Execution reverted ${a ? `with reason: ${a}` : "for an unknown reason"}.`, {
      cause: t,
...
Object.defineProperty(Xe, "code", { enumerable: !0, configurable: !0, writable: !0, value: -32521 });
Object.defineProperty(Xe, "message", { enumerable: !0, configurable: !0, writable: !0, value: /execution reverted/ });
class _n extends B {
  constructor({ cause: t }) {
    super("Failed to send funds to beneficiary.", { cause: t, name: "FailedToSendToBeneficiaryError" });
  }
}
Object.defineProperty(_n, "message", { enumerable: !0, configurable: !0, writable: !0, value: /aa91/ });
class Bn extends B {
  constructor({ cause: t }) {
...
Object.defineProperty(Bn, "message", { enumerable: !0, configurable: !0, writable: !0, value: /aa94/ });
class Rn extends B {
  constructor({ cause: t }) {
...
Object.defineProperty(Rn, "message", { enumerable: !0, configurable: !0, writable: !0, value: /aa95/ });
class Un extends B {
...
Object.defineProperty(Un, "message", { enumerable: !0, configurable: !0, writable: !0, value: /aa13/ });
class Nn extends B {
  constructor({ cause: t, factory: n, factoryData: r, initCode: a }) {
...
Object.defineProperty(Nn, "message", { enumerable: !0, configurable: !0, writable: !0, value: /aa15/ });
class jn extends B {
  constructor({ cause: t, factory: n, factoryData: r, initCode: a, sender: i }) {
...
Object.defineProperty(jn, "message", { enumerable: !0, configurable: !0, writable: !0, value: /aa14/ });
class Dn extends B {
  constructor({ cause: t }) {
...
Object.defineProperty(Dn, "message", { enumerable: !0, configurable: !0, writable: !0, value: /aa21/ });
class Mn extends B {
  constructor({ cause: t }) {
...
Object.defineProperty(Mn, "message", { enumerable: !0, configurable: !0, writable: !0, value: /aa92/ });
class Ln extends B {
  constructor({ cause: t }) {
...
Object.defineProperty(Ln, "message", { enumerable: !0, configurable: !0, writable: !0, value: /aa96/ });
class Fn extends B {
...
Object.defineProperty(Fn, "message", { enumerable: !0, configurable: !0, writable: !0, value: /aa25/ });
class Gn extends B {
  constructor({ cause: t }) {
    super("Bundler has not set a beneficiary address.", { cause: t, name: "InvalidBeneficiaryError" });
  }
}
Object.defineProperty(Gn, "message", { enumerable: !0, configurable: !0, writable: !0, value: /aa90/ });
class Mt extends B {
  constructor({ cause: t }) {
    super("Invalid fields set on User Operation.", { cause: t, name: "InvalidFieldsError" });
  }
}
Object.defineProperty(Mt, "code", { enumerable: !0, configurable: !0, writable: !0, value: -32602 });
class zn extends B {
...
Object.defineProperty(zn, "message", { enumerable: !0, configurable: !0, writable: !0, value: /aa93/ });
class je extends B {
  constructor({ cause: t }) {
...
Object.defineProperty(je, "code", { enumerable: !0, configurable: !0, writable: !0, value: -32508 });
Object.defineProperty(je, "message", { enumerable: !0, configurable: !0, writable: !0, value: /aa31/ });
class Hn extends B {
  constructor({ cause: t }) {
...
Object.defineProperty(Hn, "message", { enumerable: !0, configurable: !0, writable: !0, value: /aa33/ });
class Kn extends B {
  constructor({ cause: t }) {
    super("The Paymaster contract has not been deployed.", { cause: t, name: "PaymasterNotDeployedError" });
  }
}
Object.defineProperty(Kn, "message", { enumerable: !0, configurable: !0, writable: !0, value: /aa30/ });
class Lt extends B {
  constructor({ cause: t }) {
...
Object.defineProperty(Lt, "code", { enumerable: !0, configurable: !0, writable: !0, value: -32504 });
class Ft extends B {
  constructor({ cause: t }) {
...
Object.defineProperty(Ft, "code", { enumerable: !0, configurable: !0, writable: !0, value: -32505 });
class Vn extends B {
  constructor({ cause: t }) {
    super("Paymaster `postOp` function reverted.", { cause: t, name: "PaymasterPostOpFunctionRevertedError" });
  }
}
Object.defineProperty(Vn, "message", { enumerable: !0, configurable: !0, writable: !0, value: /aa50/ });
class qn extends B {
  constructor({ cause: t, factory: n, factoryData: r, initCode: a }) {
...
Object.defineProperty(qn, "message", { enumerable: !0, configurable: !0, writable: !0, value: /aa10/ });
class Gt extends B {
  constructor({ cause: t }) {
    super(
...
Object.defineProperty(Gt, "code", { enumerable: !0, configurable: !0, writable: !0, value: -32507 });
class Zn extends B {
  constructor({ cause: t }) {
...
Object.defineProperty(Zn, "message", { enumerable: !0, configurable: !0, writable: !0, value: /aa23/ });
class zt extends B {
  constructor({ cause: t }) {
...
Object.defineProperty(zt, "code", { enumerable: !0, configurable: !0, writable: !0, value: -32506 });
class Wn extends B {
  constructor({ cause: t }) {
...
Object.defineProperty(Wn, "message", { enumerable: !0, configurable: !0, writable: !0, value: /aa22/ });
class Jn extends B {
  constructor({ cause: t }) {
...
Object.defineProperty(Jn, "message", { enumerable: !0, configurable: !0, writable: !0, value: /aa32/ });
class Yn extends B {
  constructor({ cause: t }) {
...
Object.defineProperty(Yn, "message", { enumerable: !0, configurable: !0, writable: !0, value: /aa24/ });
class Xn extends B {
  constructor({ cause: t }) {
    super("Signature provided for the User Operation is invalid.", {
      cause: t,
...
Object.defineProperty(Xn, "message", { enumerable: !0, configurable: !0, writable: !0, value: /aa34/ });
class Ht extends B {
  constructor({ cause: t }) {
...
Object.defineProperty(Ht, "code", { enumerable: !0, configurable: !0, writable: !0, value: -32500 });
class Kt extends B {
  constructor({ cause: t }) {
...
Object.defineProperty(Kt, "code", { enumerable: !0, configurable: !0, writable: !0, value: -32501 });
class Vt extends B {
  constructor({ cause: t }) {
...
Object.defineProperty(Vt, "code", { enumerable: !0, configurable: !0, writable: !0, value: -32502 });
class qt extends B {
  constructor({ cause: t }) {
    super(
...
Object.defineProperty(qt, "code", { enumerable: !0, configurable: !0, writable: !0, value: -32503 });
class Nu extends B {
  constructor({ cause: t }) {
    super(`An error occurred while executing user operation: ${t == null ? void 0 : t.shortMessage}`, {
      cause: t,
...
Object.defineProperty(Qn, "message", { enumerable: !0, configurable: !0, writable: !0, value: /aa40/ });
class $n extends B {
  constructor({ cause: t }) {
...
Object.defineProperty($n, "message", { enumerable: !0, configurable: !0, writable: !0, value: /aa41/ });
class ju extends B {
  constructor(
    t,
    {
      ...
      preVerificationGas: b,
      sender: E,
      signature: w,
      verificationGasLimit: O,
    },
  ) {
    const U = Us({
      callData: n,
      ...
      factoryData: s,
      initCode: o,
      maxFeePerGas: typeof u < "u" && `${_r(u)} gwei`,
      maxPriorityFeePerGas: typeof c < "u" && `${_r(c)} gwei`,
      nonce: l,
      paymaster: d,
      paymasterAndData: p,
      paymasterData: f,
    ...
    (super(t.shortMessage, {
      cause: t,
      docsPath: a,
      metaMessages: [...(t.metaMessages ? [...t.metaMessages, " "] : []), "Request Arguments:", U].filter(Boolean),
...
class Mu extends B {
  constructor({ hash: t }) {
    super(`User Operation with hash "${t}" could not be found.`, { name: "UserOperationNotFoundError" });
  }
}
class la extends B {
  constructor({ hash: t }) {
    super(`Timed out while waiting for User Operation with hash "${t}" to be confirmed.`, {
      name: "WaitForUserOperationReceiptTimeoutError",
    });
  }
}
const Lu = [Xe, Mt, je, Lt, Ft, Gt, zt, qt, Ht, Kt, Vt];
function Fu(e, t) {
  const n = (e.details || "").toLowerCase();
  if (Tn.message.test(n)) return new Tn({ cause: e });
  if (_n.message.test(n)) return new _n({ cause: e });
  if (Bn.message.test(n)) return new Bn({ cause: e });
  if (Rn.message.test(n)) return new Rn({ cause: e });
  if (Un.message.test(n))
    return new Un({ cause: e, factory: t.factory, factoryData: t.factoryData, initCode: t.initCode });
  if (Nn.message.test(n))
    return new Nn({ cause: e, factory: t.factory, factoryData: t.factoryData, initCode: t.initCode });
  if (jn.message.test(n))
    return new jn({ cause: e, factory: t.factory, factoryData: t.factoryData, initCode: t.initCode, sender: t.sender });
  if (Dn.message.test(n)) return new Dn({ cause: e });
  if (Mn.message.test(n)) return new Mn({ cause: e });
  if (Fn.message.test(n)) return new Fn({ cause: e, nonce: t.nonce });
  if (Ln.message.test(n)) return new Ln({ cause: e });
  if (Gn.message.test(n)) return new Gn({ cause: e });
  if (zn.message.test(n)) return new zn({ cause: e });
  if (je.message.test(n)) return new je({ cause: e });
  if (Hn.message.test(n)) return new Hn({ cause: e });
  if (Kn.message.test(n)) return new Kn({ cause: e });
  if (Vn.message.test(n)) return new Vn({ cause: e });
  if (Zn.message.test(n)) return new Zn({ cause: e });
  if (qn.message.test(n))
    return new qn({ cause: e, factory: t.factory, factoryData: t.factoryData, initCode: t.initCode });
  if (Wn.message.test(n)) return new Wn({ cause: e });
  if (Jn.message.test(n)) return new Jn({ cause: e });
  if (Xn.message.test(n)) return new Xn({ cause: e });
  if (Yn.message.test(n)) return new Yn({ cause: e });
  if (Qn.message.test(n)) return new Qn({ cause: e });
  if ($n.message.test(n)) return new $n({ cause: e });
  const r = e.walk((a) => Lu.some((i) => i.code === a.code));
  if (r) {
    if (r.code === Xe.code) return new Xe({ cause: e, data: r.data, message: r.details });
    if (r.code === Mt.code) return new Mt({ cause: e });
    if (r.code === je.code) return new je({ cause: e });
    if (r.code === Lt.code) return new Lt({ cause: e });
    if (r.code === Ft.code) return new Ft({ cause: e });
    if (r.code === Gt.code) return new Gt({ cause: e });
    if (r.code === zt.code) return new zt({ cause: e });
    if (r.code === qt.code) return new qt({ cause: e });
    if (r.code === Ht.code) return new Ht({ cause: e });
    if (r.code === Kt.code) return new Kt({ cause: e });
    if (r.code === Vt.code) return new Vt({ cause: e });
  }
  return new Nu({ cause: e });
}
function ji(e, { calls: t, docsPath: n, ...r }) {
  const a = (() => {
    const i = Fu(e, r);
    if (t && i instanceof Xe) {
      const s = Gu(i),
        o = t == null ? void 0 : t.filter((u) => u.abi);
      if (s && o.length > 0) return zu({ calls: o, revertData: s });
    }
    return i;
  })();
  return new ju(a, { docsPath: n, ...r });
}
function Gu(e) {
  let t;
  return (
    e.walk((n) => {
      ...
      if (
        ...
        (!(r instanceof B) && typeof r.message == "string")
      ) {
        const u =
          (o = (s = ((i = r.data) == null ? void 0 : i.revertData) || r.data || r.message).match) == null
            ? void 0
  ...
  const { calls: t, revertData: n } = e,
    {
      ...
      const u = t == null ? void 0 : t.filter((l) => !!l.abi);
      if (u.length === 1) return u[0];
      const c = u.filter((l) => {
        try {
          return !!Ns({ abi: l.abi, data: n });
        } catch {
          return !1;
        }
      });
      return c.length === 1
        ...
        : {
            abi: [],
            functionName: u.reduce((l, d) => `${l ? `${l} | ` : ""}${d.functionName}`, ""),
            args: void 0,
            to: void 0,
          };
    })(),
    o = n === "0x" ? new js({ functionName: a }) : new Ds({ abi: r, data: n, functionName: a });
  return new Ms(o, { abi: r, args: i, contractAddress: s, functionName: a });
}
function Hu(e) {
  const t = {};
  return (
    e.callGasLimit && (t.callGasLimit = BigInt(e.callGasLimit)),
    e.preVerificationGas && (t.preVerificationGas = BigInt(e.preVerificationGas)),
    e.verificationGasLimit && (t.verificationGasLimit = BigInt(e.verificationGasLimit)),
    e.paymasterPostOpGasLimit && (t.paymasterPostOpGasLimit = BigInt(e.paymasterPostOpGasLimit)),
    e.paymasterVerificationGasLimit && (t.paymasterVerificationGasLimit = BigInt(e.paymasterVerificationGasLimit)),
    t
  );
}
function Qt(e) {
  ...
  return (
    ...
    typeof e.callGasLimit < "u" && (t.callGasLimit = j(e.callGasLimit)),
    ...
    typeof e.maxFeePerGas < "u" && (t.maxFeePerGas = j(e.maxFeePerGas)),
    typeof e.maxPriorityFeePerGas < "u" && (t.maxPriorityFeePerGas = j(e.maxPriorityFeePerGas)),
    typeof e.nonce < "u" && (t.nonce = j(e.nonce)),
    typeof e.paymaster < "u" && (t.paymaster = e.paymaster),
    typeof e.paymasterAndData < "u" && (t.paymasterAndData = e.paymasterAndData || "0x"),
    typeof e.paymasterData < "u" && (t.paymasterData = e.paymasterData),
    typeof e.paymasterPostOpGasLimit < "u" && (t.paymasterPostOpGasLimit = j(e.paymasterPostOpGasLimit)),
    typeof e.paymasterSignature < "u" && (t.paymasterSignature = e.paymasterSignature),
    typeof e.paymasterVerificationGasLimit < "u" &&
      (t.paymasterVerificationGasLimit = j(e.paymasterVerificationGasLimit)),
    typeof e.preVerificationGas < "u" && (t.preVerificationGas = j(e.preVerificationGas)),
    typeof e.sender < "u" && (t.sender = e.sender),
    typeof e.signature < "u" && (t.signature = e.signature),
    typeof e.verificationGasLimit < "u" && (t.verificationGasLimit = j(e.verificationGasLimit)),
    typeof e.authorization < "u" && (t.eip7702Auth = Ku(e.authorization)),
    t
  );
}
function Ku(e) {
  return {
    ...
    chainId: j(e.chainId),
    nonce: j(e.nonce),
    r: e.r ? j(BigInt(e.r), { size: 32 }) : de("0x", { size: 32 }),
    s: e.s ? j(BigInt(e.s), { size: 32 }) : de("0x", { size: 32 }),
    yParity: e.yParity ? j(e.yParity, { size: 1 }) : de("0x", { size: 32 }),
  };
}
async function Vu(e, t) {
  ...
  return { ...c, ...(o && { paymasterPostOpGasLimit: dt(o) }), ...(u && { paymasterVerificationGasLimit: dt(u) }) };
}
...
const Zu = ["factory", "fees", "gas", "paymaster", "nonce", "signature", "authorization"];
async function Er(e, t) {
  var ge, oe;
  const n = t,
    {
      account: r = e.account,
      dataSuffix: a = typeof e.dataSuffix == "string" ? e.dataSuffix : (ge = e.dataSuffix) == null ? void 0 : ge.value,
      parameters: i = Zu,
      stateOverride: s,
    } = n;
  if (!r) throw new ar();
  const o = ir(r),
    u = e,
    c = n.paymaster ?? (u == null ? void 0 : u.paymaster),
    l = typeof c == "string" ? c : void 0,
    { getPaymasterStubData: d, getPaymasterData: p } = (() => {
      if (c === !0)
        return {
          getPaymasterStubData: (A) => Se(u, qu, "getPaymasterStubData")(A),
          getPaymasterData: (A) => Se(u, Vu, "getPaymasterData")(A),
        };
      if (typeof c == "object") {
        const { getPaymasterStubData: A, getPaymasterData: N } = c;
        return { getPaymasterStubData: N && A ? A : N, getPaymasterData: N && A ? N : void 0 };
      }
      return { getPaymasterStubData: void 0, getPaymasterData: void 0 };
    })(),
    f = n.paymasterContext ? n.paymasterContext : u == null ? void 0 : u.paymasterContext;
  let m = { ...n, paymaster: l, sender: o.address };
  const [y, b, E, w, O] = await Promise.all([
    (async () =>
      n.calls
        ? o.encodeCalls(
            n.calls.map((A) => {
              const N = A;
              return N.abi ? { data: Te(N), to: N.to, value: N.value } : N;
            }),
          )
        : n.callData)(),
    (async () => {
      ...
      if (n.factory && n.factoryData) return { factory: n.factory, factoryData: n.factoryData };
      const { factory: A, factoryData: N } = await o.getFactoryArgs();
      return o.entryPoint.version === "0.6"
        ? { initCode: A && N ? De([A, N]) : void 0 }
        : { factory: A, factoryData: N };
    })(),
    (async () => {
      var A;
      if (i.includes("fees")) {
        if (typeof n.maxFeePerGas == "bigint" && typeof n.maxPriorityFeePerGas == "bigint") return m;
        if ((A = u == null ? void 0 : u.userOperation) != null && A.estimateFeesPerGas) {
          const N = await u.userOperation.estimateFeesPerGas({ account: o, bundlerClient: u, userOperation: m });
          return { ...m, ...N };
        }
        try {
          const N = u.client ?? e,
            ae = await Se(N, Ls, "estimateFeesPerGas")({ chain: N.chain, type: "eip1559" });
          return {
            maxFeePerGas: typeof n.maxFeePerGas == "bigint" ? n.maxFeePerGas : BigInt(2n * ae.maxFeePerGas),
            maxPriorityFeePerGas:
              typeof n.maxPriorityFeePerGas == "bigint" ? n.maxPriorityFeePerGas : BigInt(2n * ae.maxPriorityFeePerGas),
          };
        } catch {
          return;
        }
    ...
    (async () => {
      if (i.includes("nonce")) return typeof n.nonce == "bigint" ? n.nonce : o.getNonce();
    })(),
    (async () => {
      if (i.includes("authorization")) {
        ...
        if (o.authorization && !(await o.isDeployed()))
          return {
            ...(await Fs(o.client, o.authorization)),
  ...
  (typeof y < "u" && (m.callData = a ? De([y, a]) : y),
    typeof b < "u" && (m = { ...m, ...b }),
    typeof E < "u" && (m = { ...m, ...E }),
    typeof w < "u" && (m.nonce = w),
    typeof O < "u" && (m.authorization = O),
    i.includes("signature") &&
      (typeof n.signature < "u" ? (m.signature = n.signature) : (m.signature = await o.getStubSignature(m))),
    o.entryPoint.version === "0.6" && !m.initCode && (m.initCode = "0x"));
  let U;
  async function $() {
    return U || (e.chain ? e.chain.id : ((U = await Se(e, Ba, "getChainId")({})), U));
  }
  let re = !1;
  if (i.includes("paymaster") && d && !l && !n.paymasterAndData) {
    const {
      isFinal: A = !1,
      sponsor: N,
      ...ae
    } = await d({ chainId: await $(), entryPointAddress: o.entryPoint.address, context: f, ...m });
    ((re = A), (m = { ...m, ...ae }));
  }
  if ((o.entryPoint.version === "0.6" && !m.paymasterAndData && (m.paymasterAndData = "0x"), i.includes("gas"))) {
    if ((oe = o.userOperation) != null && oe.estimateGas) {
      const A = await o.userOperation.estimateGas(m);
      m = { ...m, ...A };
    }
    if (
      typeof m.callGasLimit > "u" ||
      typeof m.preVerificationGas > "u" ||
      typeof m.verificationGasLimit > "u" ||
      (m.paymaster && typeof m.paymasterPostOpGasLimit > "u") ||
      (m.paymaster && typeof m.paymasterVerificationGasLimit > "u")
    ) {
      const A = await Se(
        u,
        Di,
        ...
        stateOverride: s,
        ...(m.paymaster ? { paymasterPostOpGasLimit: 0n, paymasterVerificationGasLimit: 0n } : {}),
        ...m,
      });
      m = {
        ...m,
        callGasLimit: m.callGasLimit ?? A.callGasLimit,
        preVerificationGas: m.preVerificationGas ?? A.preVerificationGas,
        verificationGasLimit: m.verificationGasLimit ?? A.verificationGasLimit,
        paymasterPostOpGasLimit: m.paymasterPostOpGasLimit ?? A.paymasterPostOpGasLimit,
        paymasterVerificationGasLimit: m.paymasterVerificationGasLimit ?? A.paymasterVerificationGasLimit,
      };
    }
  }
  if (i.includes("paymaster") && p && !l && !n.paymasterAndData && !re) {
    const A = await p({ chainId: await $(), entryPointAddress: o.entryPoint.address, context: f, ...m });
    m = { ...m, ...A };
  }
  return (
    delete m.calls,
...
async function Di(e, t) {
  ...
  if (!n && !t.sender) throw new ar();
  const i = n ? ir(n) : void 0,
    s = Gs(a),
    o = i
      ? await Se(
          e,
        ...
        )({ ...t, parameters: ["authorization", "factory", "nonce", "paymaster", "signature"] })
      : t;
  try {
    const c = [Qt(o), r ?? ((u = i == null ? void 0 : i.entryPoint) == null ? void 0 : u.address)],
      l = await e.request({ method: "eth_estimateUserOperationGas", params: s ? [...c, s] : [...c] });
    return Hu(l);
  } catch (c) {
    const l = t.calls;
    throw ji(c, { ...o, ...(l ? { calls: l } : {}) });
  }
}
function Wu(e) {
...
function Ju(e) {
  ...
  return (
    ...
    e.maxPriorityFeePerGas && (t.maxPriorityFeePerGas = BigInt(e.maxPriorityFeePerGas)),
...
async function Yu(e, { hash: t }) {
  const n = await e.request({ method: "eth_getUserOperationByHash", params: [t] }, { dedupe: !0 });
  if (!n) throw new Mu({ hash: t });
  const { blockHash: r, blockNumber: a, entryPoint: i, transactionHash: s, userOperation: o } = n;
  return { blockHash: r, blockNumber: BigInt(a), entryPoint: i, transactionHash: s, userOperation: Ju(o) };
}
function Xu(e) {
  const t = { ...e };
  return (
    ...
    e.logs && (t.logs = e.logs.map((n) => zs(n))),
    e.receipt && (t.receipt = Hs(t.receipt)),
    t
  );
}
async function Mi(e, { hash: t }) {
  const n = await e.request({ method: "eth_getUserOperationReceipt", params: [t] }, { dedupe: !0 });
  if (!n) throw new Du({ hash: t });
  return Xu(n);
}
async function Qu(e, t) {
  var u, c;
  ...
  if (!n && !t.sender) throw new ar();
  const a = n ? ir(n) : void 0,
    i = a ? await Se(e, Er, "prepareUserOperation")(t) : t,
    s = t.signature || (await ((u = a == null ? void 0 : a.signUserOperation) == null ? void 0 : u.call(a, i))),
    o = Qt({ ...i, signature: s });
  try {
    ...
    const d = t.calls;
    throw ji(l, { ...i, ...(d ? { calls: d } : {}), signature: s });
  }
}
function $u(e, t) {
  const { hash: n, pollingInterval: r = e.pollingInterval, retryCount: a, timeout: i = 12e4 } = t;
  let s = 0;
  const o = Ks(["waitForUserOperationReceipt", e.uid, n]);
  return new Promise((u, c) => {
    const l = Vs(o, { resolve: u, reject: c }, (d) => {
      const p = (y) => {
          (m(), y(), l());
        },
        f = i ? setTimeout(() => p(() => d.reject(new la({ hash: n }))), i) : void 0,
        m = qs(
          async () => {
            a && s >= a && (clearTimeout(f), p(() => d.reject(new la({ hash: n }))));
            try {
              const y = await Se(e, Mi, "getUserOperationReceipt")({ hash: n });
              (clearTimeout(f), p(() => d.resolve(y)));
            } catch (y) {
              const b = y;
              b.name !== "UserOperationReceiptNotFoundError" && (clearTimeout(f), p(() => d.reject(b)));
            }
            s++;
          },
...
function ed(e) {
  return {
    estimateUserOperationGas: (t) => Di(e, t),
    getChainId: () => Ba(e),
    getSupportedEntryPoints: () => Wu(e),
    getUserOperation: (t) => Yu(e, t),
    getUserOperationReceipt: (t) => Mi(e, t),
    prepareUserOperation: (t) => Er(e, t),
    sendUserOperation: (t) => Qu(e, t),
    waitForUserOperationReceipt: (t) => $u(e, t),
  };
}
function td(e) {
  const {
  ...
  return Object.assign(
    ...
    {
      client: t,
      dataSuffix: n ?? (t == null ? void 0 : t.dataSuffix),
      paymaster: i,
      paymasterContext: s,
      userOperation: u,
    },
...
const Li = lr(() => ({})),
  nd = [Ma, co, Zs, Ws, Js, uo, po, Ys],
  rd = [La, fo, lo],
  ad = [...nd, ...rd].reduce((e, t) => (e.set(t.id, t), e), new Map());
function Sr(e) {
  return ad.get(e);
}
function Fi(e) {
  ...
  const t = Sr(e);
  if (
    (a = (r = (n = t == null ? void 0 : t.rpcUrls) == null ? void 0 : n.default) == null ? void 0 : r.http) != null &&
    a[0]
  )
    return t.rpcUrls.default.http[0];
}
function id(e, t, n) {
  var u, c;
  const r = n == null ? void 0 : n.viemChain,
    a = n == null ? void 0 : n.nativeCurrency,
    i = (a == null ? void 0 : a.name) ?? (r == null ? void 0 : r.name) ?? "",
    s =
      (a == null ? void 0 : a.symbol) ??
      ((u = r == null ? void 0 : r.nativeCurrency) == null ? void 0 : u.symbol) ??
      "",
    o =
      (a == null ? void 0 : a.decimal) ??
      ((c = r == null ? void 0 : r.nativeCurrency) == null ? void 0 : c.decimals) ??
      18;
  return be({
    id: e,
    name: i,
    nativeCurrency: { name: i, symbol: s, decimals: o },
...
function fa(e) {
  e.forEach((t) => {
    let n = t.rpcUrl;
    if ((n || (n = Fi(t.id)), !n)) return;
    const r = Sr(t.id),
      a = Gi({ chainId: t.id, rpcUrl: n, nativeCurrency: t.nativeCurrency, viemChain: r });
    zi(t.id, a);
  });
}
function Gi(e) {
  const { chainId: t, rpcUrl: n, nativeCurrency: r, viemChain: a } = e,
    i = id(t, n, { viemChain: a, nativeCurrency: r }),
    s = so({ chain: i, transport: Br(n) }),
    o = td({ client: s, transport: Br(n) });
  return { client: s, bundlerClient: o };
}
function sd(e) {
  const t = Fi(e),
    n = Sr(e);
  if (t) return Gi({ chainId: e, rpcUrl: t, viemChain: n });
}
function zi(e, t) {
  Li.setState((n) => ({ ...n, [e]: { client: t.client, bundlerClient: t.bundlerClient } }));
}
function Hi(e) {
  var r;
  const t = (r = Li.getState()[e]) == null ? void 0 : r.client;
  if (t) return t;
  const n = sd(e);
  if (n) return (zi(e, n), n.client);
}
const xt = lr(() => ({ correlationIds: new Map() })),
  Ee = {
...
function Et(e) {
  if (typeof e != "object" || e === null) throw S.rpc.internal("sub account info is not an object");
  if (!("address" in e)) throw S.rpc.internal("sub account is invalid");
  if ("address" in e && typeof e.address == "string" && !ut(e.address))
    throw S.rpc.internal("sub account address is invalid");
  if ("factory" in e && typeof e.factory == "string" && !ut(e.factory))
    throw S.rpc.internal("sub account factory address is invalid");
  if ("factoryData" in e && typeof e.factoryData == "string" && !ze(e.factoryData))
...
async function cd(e, t) {
  return crypto.subtle.deriveKey({ name: "ECDH", public: t }, e, { name: "AES-GCM", length: 256 }, !1, [
    "encrypt",
    "decrypt",
  ]);
}
async function ud(e, t) {
  const n = crypto.getRandomValues(new Uint8Array(12)),
    r = await crypto.subtle.encrypt({ name: "AES-GCM", iv: n }, e, new TextEncoder().encode(t));
  return { iv: n, cipherText: r };
}
async function dd(e, { iv: t, cipherText: n }) {
...
async function ld(e, t) {
  const n = JSON.stringify(e, (r, a) => {
    ...
    const i = a;
    return { ...(i.code ? { code: i.code } : {}), message: i.message };
  });
  return ud(t, n);
}
async function fd(e, t) {
  return JSON.parse(await dd(t, e));
}
async function ot(e, t) {
  const n = { ...e, jsonrpc: "2.0", id: crypto.randomUUID() },
    r = await fetch(t, {
      method: "POST",
      body: JSON.stringify(n),
      mode: "cors",
      headers: { "Content-Type": "application/json", "X-Cbw-Sdk-Version": tt, "X-Cbw-Sdk-Platform": Jt },
    }),
...
function pd(e) {
  if (!e || typeof e != "object" || Array.isArray(e))
    throw S.rpc.invalidParams({ message: "Expected a single, non-array, object argument.", data: e });
  const { method: t, params: n } = e;
  if (typeof t != "string" || t.length === 0)
    throw S.rpc.invalidParams({ message: "'args.method' must be a non-empty string.", data: e });
  if (n !== void 0 && !Array.isArray(n) && (typeof n != "object" || n === null))
    throw S.rpc.invalidParams({ message: "'args.params' must be an object or array if provided.", data: e });
  switch (t) {
    case "eth_sign":
  ...
  constructor(t, n = {}) {
    const r = (() => {
      ...
      o = [
        ...
        ...(r || a ? ["", r ? `Details: ${r}` : void 0, a ? `See: ${s}` : void 0] : []),
...
`);
    (super(o, n.cause ? { cause: n.cause } : void 0),
      ...
      Object.defineProperty(this, "version", { enumerable: !0, configurable: !0, writable: !0, value: `ox@${yd()}` }),
      (this.cause = n.cause),
      (this.details = r),
      (this.docs = s),
      (this.docsPath = a),
...
function Zi(e, t) {
  return t != null && t(e) ? e : e && typeof e == "object" && "cause" in e && e.cause ? Zi(e.cause, t) : t ? null : e;
}
const hd = "#__bigint";
function $t(e, t, n) {
  return JSON.stringify(e, (r, a) => (typeof a == "bigint" ? a.toString() + hd : a), n);
}
function gd(e, t) {
  if ($e(e) > t) throw new Rd({ givenSize: $e(e), maxSize: t });
}
function bd(e, t) {
  if (typeof t == "number" && t > 0 && t > $e(e) - 1) throw new ns({ offset: t, position: "start", size: $e(e) });
}
function wd(e, t, n) {
  if (typeof t == "number" && typeof n == "number" && $e(e) !== n - t)
    throw new ns({ offset: n, position: "end", size: $e(e) });
}
const we = { zero: 48, nine: 57, A: 65, F: 70, a: 97, f: 102 };
function pa(e) {
  if (e >= we.zero && e <= we.nine) return e - we.zero;
  if (e >= we.A && e <= we.F) return e - (we.A - 10);
  if (e >= we.a && e <= we.f) return e - (we.a - 10);
}
function kr(e, t) {
  if (_e(e) > t) throw new Cd({ givenSize: _e(e), maxSize: t });
}
function vd(e, t) {
  if (typeof t == "number" && t > 0 && t > _e(e) - 1) throw new Qi({ offset: t, position: "start", size: _e(e) });
}
function xd(e, t, n) {
  if (typeof t == "number" && typeof n == "number" && _e(e) !== n - t)
    throw new Qi({ offset: n, position: "end", size: _e(e) });
}
function Wi(e, t = {}) {
  const { dir: n, size: r = 32 } = t;
  if (r === 0) return e;
  const a = e.replace("0x", "");
  if (a.length > r * 2) throw new Td({ size: Math.ceil(a.length / 2), targetSize: r, type: "Hex" });
  return `0x${a[n === "right" ? "padEnd" : "padStart"](r * 2, "0")}`;
}
const Ed = new TextEncoder(),
  Sd = Array.from({ length: 256 }, (e, t) => t.toString(16).padStart(2, "0"));
function kd(e, t = {}) {
  const { strict: n = !1 } = t;
  if (!e) throw new ma(e);
  if (typeof e != "string") throw new ma(e);
  if (n && !/^0x[0-9a-fA-F]*$/.test(e)) throw new ya(e);
  if (!e.startsWith("0x")) throw new ya(e);
}
function en(...e) {
...
function Qe(e, t = {}) {
  let n = "";
  for (let a = 0; a < e.length; a++) n += Sd[e[a]];
  const r = `0x${n}`;
  return typeof t.size == "number" ? (kr(r, t.size), Xi(r, t.size)) : r;
}
function Ie(e, t = {}) {
  ...
  if ((i && a > i) || a < s) {
    ...
    throw new Id({ max: i ? `${i}${c}` : void 0, min: `${s}${c}`, signed: n, size: r, value: `${e}${c}` });
  }
  const u = `0x${(n && a < 0 ? (1n << BigInt(r * 8)) + BigInt(a) : a).toString(16)}`;
  return r ? Ad(u, r) : u;
}
function Yi(e, t = {}) {
  return Qe(Ed.encode(e), t);
}
function Ad(e, t) {
  return Wi(e, { dir: "left", size: t });
}
function Xi(e, t) {
  return Wi(e, { dir: "right", size: t });
}
function pe(e, t, n, r = {}) {
  const { strict: a } = r;
  vd(e, t);
...
class ma extends V {
  constructor(t) {
    (super(`Value \`${typeof t == "object" ? $t(t) : t}\` of type \`${typeof t}\` is an invalid hex type.`, {
...
function _d(e) {
  if (!(e instanceof Uint8Array)) {
    if (!e) throw new St(e);
    if (typeof e != "object") throw new St(e);
    if (!("BYTES_PER_ELEMENT" in e)) throw new St(e);
    if (e.BYTES_PER_ELEMENT !== 1 || e.constructor.name !== "Uint8Array") throw new St(e);
  }
}
function $i(e) {
  return e instanceof Uint8Array ? e : typeof e == "string" ? ts(e) : es(e);
}
function es(e) {
...
function ts(e, t = {}) {
  ...
  for (let o = 0, u = 0; o < i; o++) {
    const c = pa(a.charCodeAt(u++)),
      l = pa(a.charCodeAt(u++));
    if (c === void 0 || l === void 0) throw new V(`Invalid byte sequence ("${a[u - 2]}${a[u - 1]}" in "${a}").`);
    s[o] = c * 16 + l;
  }
  return s;
}
...
class St extends V {
  constructor(t) {
    (super(`Value \`${typeof t == "object" ? $t(t) : t}\` of type \`${typeof t}\` is an invalid Bytes value.`, {
...
function as(e, t = {}) {
  ...
  if (n === !1 || (typeof a == "bigint" && typeof i == "bigint")) {
    if (r !== 4) throw new ba({ prefix: r, cause: new Md() });
    return;
  }
  if (n === !0 || (typeof a == "bigint" && typeof i > "u")) {
    if (r !== 3 && r !== 2) throw new ba({ prefix: r, cause: new Dd() });
    return;
  }
  throw new jd({ publicKey: e });
}
function Ud(e) {
  const t = (() => {
    if (Od(e)) return is(e);
...
function is(e) {
  if (e.length !== 132 && e.length !== 130 && e.length !== 68) throw new Ld({ publicKey: e });
  if (e.length === 130) {
    const r = BigInt(pe(e, 0, 32)),
      a = BigInt(pe(e, 32, 64));
    return { prefix: 4, x: r, y: a };
  }
  if (e.length === 132) {
    const r = Number(pe(e, 0, 1)),
      a = BigInt(pe(e, 1, 33)),
      i = BigInt(pe(e, 33, 65));
    return { prefix: r, x: a, y: i };
  }
  const t = Number(pe(e, 0, 1)),
    n = BigInt(pe(e, 1, 33));
  return { prefix: t, x: n };
}
function Ar(e, t = {}) {
  ...
  const { prefix: n, x: r, y: a } = e,
    { includePrefix: i = !0 } = t;
  return en(i ? Ie(n, { size: 1 }) : "0x", Ie(r, { size: 32 }), typeof a == "bigint" ? Ie(a, { size: 32 }) : "0x");
}
class jd extends V {
  constructor({ publicKey: t }) {
    (super(`Value \`${$t(t)}\` is not a valid public key.`, {
      metaMessages: [
...
function Fd(e, t = {}) {
  const { recovered: n } = t;
  if (typeof e.r > "u") throw new fn({ signature: e });
  if (typeof e.s > "u") throw new fn({ signature: e });
  if (n && typeof e.yParity > "u") throw new fn({ signature: e });
  if (e.r < 0n || e.r > wa) throw new Vd({ value: e.r });
  if (e.s < 0n || e.s > wa) throw new qd({ value: e.s });
  if (typeof e.yParity == "number" && e.yParity !== 0 && e.yParity !== 1) throw new Pr({ value: e.yParity });
}
function ss(e) {
  if (e.length !== 130 && e.length !== 132) throw new Kd({ signature: e });
  const t = BigInt(pe(e, 0, 32)),
    n = BigInt(pe(e, 32, 64)),
    r = (() => {
...
function Gd(e) {
  ...
  return en(
    Ie(t, { size: 32 }),
    Ie(n, { size: 32 }),
    typeof e.yParity == "number" ? Ie(Hd(e.yParity), { size: 1 }) : "0x",
  );
}
function zd(e) {
  ...
  throw new Zd({ value: e });
}
function Hd(e) {
  if (e === 0) return 27;
  if (e === 1) return 28;
  throw new Pr({ value: e });
}
class Kd extends V {
  constructor({ signature: t }) {
    (super(`Value \`${t}\` is an invalid signature size.`, {
      metaMessages: ["Expected: 64 bytes or 65 bytes.", `Received ${_e(Ji(t))} bytes.`],
    }),
      Object.defineProperty(this, "name", {
        enumerable: !0,
        configurable: !0,
...
class fn extends V {
  constructor({ signature: t }) {
    (super(`Signature \`${$t(t)}\` is missing either an \`r\`, \`s\`, or \`yParity\` property.`),
      Object.defineProperty(this, "name", {
        enumerable: !0,
        configurable: !0,
        writable: !0,
...
const Wd = new TextDecoder(),
  kt = Object.fromEntries(
    Array.from("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/").map((e, t) => [t, e.charCodeAt(0)]),
  );
({
  ...Object.fromEntries(
    Array.from("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/").map((e, t) => [e.charCodeAt(0), t]),
  ),
});
function Jd(e, t = {}) {
  const { pad: n = !0, url: r = !1 } = t,
    a = new Uint8Array(Math.ceil(e.length / 3) * 4);
  for (let u = 0, c = 0; c < e.length; u += 4, c += 3) {
    const l = (e[c] << 16) + (e[c + 1] << 8) + (e[c + 2] | 0);
    ((a[u] = kt[l >> 18]), (a[u + 1] = kt[(l >> 12) & 63]), (a[u + 2] = kt[(l >> 6) & 63]), (a[u + 3] = kt[l & 63]));
  }
  const i = e.length % 3,
    s = Math.floor(e.length / 3) * 4 + (i && i + 1);
  let o = Wd.decode(new Uint8Array(a.buffer, 0, s));
  return (
    n && i === 1 && (o += "=="),
    n && i === 2 && (o += "="),
...
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */ const os = {
  ...
  Qd = Fe(cs.p),
  $d = Fe(us.p),
  el = dr({ ...os, Fp: Xd, lowS: !1 }, Qs);
dr({ ...cs, Fp: Qd, lowS: !1 }, $s);
dr({ ...us, Fp: $d, lowS: !1, allowedPrivateKeyLengths: [130, 131, 132] }, eo);
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */ const va = el;
Uint8Array.from([105, 171, 180, 181, 160, 222, 75, 198, 42, 42, 32, 31, 141, 37, 186, 233]);
function tl(e = {}) {
  const { flag: t = 5, rpId: n = window.location.hostname, signCount: r = 0 } = e,
    a = rs(Yi(n)),
    i = Ie(t, { size: 1 }),
    s = Ie(r, { size: 4 });
  return en(a, i, s);
...
function rl(e) {
  const {
      ...
      rpId: s,
      signCount: o,
      userVerification: u = "required",
    } = e,
    c = tl({ flag: a, rpId: s, signCount: o }),
    l = nl({ challenge: t, crossOrigin: n, extraClientData: r, origin: i }),
    d = rs(Yi(l)),
    ...
    y = en(c, d);
  return { metadata: m, payload: y };
}
async function al(e = {}) {
  const { extractable: t = !1 } = e,
    n = await globalThis.crypto.subtle.generateKey({ name: "ECDSA", namedCurve: "P-256" }, t, ["sign", "verify"]),
    r = await globalThis.crypto.subtle.exportKey("raw", n.publicKey),
    a = Ud(new Uint8Array(r));
  return { privateKey: n.privateKey, publicKey: a };
}
async function il(e) {
  const { payload: t, privateKey: n } = e,
    r = await globalThis.crypto.subtle.sign({ name: "ECDSA", hash: "SHA-256" }, n, $i(t)),
    a = es(new Uint8Array(r)),
    i = ga(ha(a, 0, 32));
  let s = ga(ha(a, 32, 64));
  return (s > va.CURVE.n / 2n && (s = va.CURVE.n - s), { r: i, s });
}
function tn(e) {
...
let pn;
function Or() {
  return (pn || (pn = ds("keyval-store", "keyval")), pn);
}
function sl(e, t = Or()) {
  return t("readonly", (n) => tn(n.get(e)));
}
function ol(e, t, n = Or()) {
  return n("readwrite", (r) => (r.put(t, e), tn(r.transaction)));
}
function cl(e, t = Or()) {
  return t("readwrite", (n) => (n.delete(e), tn(n.transaction)));
}
function ul(e, t) {
  const n = typeof indexedDB < "u" ? ds(e, t) : void 0;
  return {
    getItem: async (r) => {
      const a = await sl(r, n);
      return a || null;
    },
    removeItem: async (r) => cl(r, n),
    setItem: async (r, a) => ol(r, a, n),
  };
}
const dl = "base-acc-sdk",
  ll = "keys",
  Ir = "activeId",
  et = ul(dl, ll);
async function fl() {
  const e = await al({ extractable: !1 }),
    t = pe(Ar(e.publicKey), 1);
  return (await et.setItem(t, e), await et.setItem(Ir, t), e);
}
async function pl() {
  const e = await et.getItem(Ir);
  if (!e) return null;
  const t = await et.getItem(e);
  return t || null;
}
async function ml() {
  const e = await pl();
  if (!e) {
    const t = await fl(),
      n = pe(Ar(t.publicKey), 1);
    return (await et.setItem(n, t), await et.setItem(Ir, n), t);
  }
  return e;
}
async function yl() {
  const e = await ml(),
    t = pe(Ar(e.publicKey), 1),
    n = async (r) => {
      const { payload: a, metadata: i } = rl({
          challenge: r,
          origin: "https://keys.coinbase.com",
          userVerification: "preferred",
        }),
        s = await il({ payload: a, privateKey: e.privateKey });
      return { signature: Gd(s), raw: {}, webauthn: i };
    };
  return {
    id: t,
    publicKey: t,
...
async function er() {
  return { account: await yl() };
}
const xa = { storageKey: "ownPrivateKey", keyType: "private" },
  Ea = { storageKey: "ownPublicKey", keyType: "public" },
  Sa = { storageKey: "peerPublicKey", keyType: "public" };
class hl {
  constructor() {
    L(this, "ownPrivateKey", null);
    L(this, "ownPublicKey", null);
    L(this, "peerPublicKey", null);
    L(this, "sharedSecret", null);
  }
  ...
  async setPeerPublicKey(t) {
    ((this.sharedSecret = null), (this.peerPublicKey = t), await this.storeKey(Sa, t), await this.loadKeysIfNeeded());
  }
  async clear() {
  ...
  async generateKeyPair() {
    ...
    ((this.ownPrivateKey = t.privateKey),
      ...
      await this.storeKey(xa, t.privateKey),
      await this.storeKey(Ea, t.publicKey));
  }
  async loadKeysIfNeeded() {
    if (
      (this.ownPrivateKey === null && (this.ownPrivateKey = await this.loadKey(xa)),
      this.ownPublicKey === null && (this.ownPublicKey = await this.loadKey(Ea)),
      (this.ownPrivateKey === null || this.ownPublicKey === null) && (await this.generateKeyPair()),
      this.peerPublicKey === null && (this.peerPublicKey = await this.loadKey(Sa)),
      this.sharedSecret === null)
    ) {
      if (this.ownPrivateKey === null || this.peerPublicKey === null) return;
      this.sharedSecret = await cd(this.ownPrivateKey, this.peerPublicKey);
    }
  }
  async loadKey(t) {
    const n = x.keys.get(t.storageKey);
    return n ? qi(t.keyType, n) : null;
  }
  async storeKey(t, n) {
    const r = await Vi(t.keyType, n);
    x.keys.set(t.storageKey, r);
  }
}
function ct(e, t) {
...
function ka(e) {
  ...
  switch (e.method) {
    ...
    case "wallet_sendCalls":
      return (t = e.params[0]) == null ? void 0 : t.from;
    default:
      return null;
  }
}
function gl(e, t) {
  if (!Array.isArray(e.params)) throw S.rpc.invalidParams();
  const n = [...e.params];
  switch (e.method) {
    case "eth_signTransaction":
    case "eth_sendTransaction":
...
function Aa(e) {
  ...
  if (
    !e ||
    !Array.isArray(e) ||
    !((t = e[0]) != null && t.chainId) ||
    (typeof e[0].chainId != "string" && typeof e[0].chainId != "number")
  )
    throw S.rpc.invalidParams();
}
function bl(e) {
  if (!e || !Array.isArray(e) || (e.length !== 1 && e.length !== 2) || typeof e[0] != "string" || !ut(e[0]))
    throw S.rpc.invalidParams();
  if (e.length === 2) {
    if (!Array.isArray(e[1])) throw S.rpc.invalidParams();
    for (const t of e[1]) if (typeof t != "string" || !t.startsWith("0x")) throw S.rpc.invalidParams();
  }
}
function pt(e, t) {
  const n = { ...e };
  if (t && e.method.startsWith("wallet_")) {
    ...
    if ((typeof r > "u" && (r = {}), typeof r != "object")) throw S.rpc.invalidParams();
    ((r = { ...t, ...r }), n.params && Array.isArray(n.params) && (n.params[0] = { ...n.params[0], capabilities: r }));
  }
  return n;
}
async function tr() {
  const e = x.subAccountsConfig.get() ?? {},
    t = {};
  if (e.creation === "on-connect") {
    const { account: n } = e.toOwnerAccount ? await e.toOwnerAccount() : await er();
    if (!n) throw S.provider.unauthorized("No owner account found");
    t.addSubAccount = {
      account: {
        type: "create",
        keys: [{ type: n.address ? "address" : "webauthn-p256", publicKey: n.address || n.publicKey }],
      },
    };
  }
  x.subAccountsConfig.set({ ...e, capabilities: t });
}
function wl(e) {
...
function vl(e) {
  ...
  const t = (a = x.getState().account.accounts) == null ? void 0 : a[0],
    n = (i = x.getState().account.chain) == null ? void 0 : i.id,
    r = (s = x.getState().subAccount) == null ? void 0 : s.address;
  if (!t || !r || !n)
    throw S.rpc.invalidParams(
  ...
  return { method: "coinbase_fetchPermissions", params: [{ account: t, chainId: j(n), spender: r }] };
}
async function ls({ client: e, id: t }) {
  var r;
  const n = await Ua(e, { id: t });
  if (n.status === "success") return (r = n.receipts) == null ? void 0 : r[0].transactionHash;
  throw S.rpc.internal("failed to send transaction");
}
function fs({ calls: e, from: t, chainId: n, capabilities: r }) {
  const a = ci.get().paymasterUrls;
  let i = {
    method: "wallet_sendCalls",
    params: [{ version: "1.0", calls: e, chainId: j(n), from: t, atomicRequired: !0, capabilities: r }],
  };
  return (a != null && a[n] && (i = pt(i, { paymasterService: { url: a == null ? void 0 : a[n] } })), i);
}
async function xl() {
  const e = xr();
  return await new Promise((n, r) => {
    (yr({ dialogContext: "sub_account_insufficient_balance" }),
      e.presentItem({
        ...
        onClose: () => {
          (yi({ dialogContext: "sub_account_insufficient_balance" }),
            e.clear(),
        ...
        actionItems: [
          {
            ...
            variant: "primary",
            onClick: () => {
              (Me({ dialogContext: "sub_account_insufficient_balance", dialogAction: "continue_in_popup" }),
                e.clear(),
                n("continue_popup"));
            },
          },
          {
            ...
            variant: "secondary",
            onClick: () => {
              (Me({ dialogContext: "sub_account_insufficient_balance", dialogAction: "cancel" }),
                e.clear(),
                r(new Error("User cancelled funding")));
            },
          },
...
function kl(e) {
  return to(ve(Ze(e)), 0, 16);
}
function Al({ attribution: e, dappOrigin: t }) {
  if (e) {
    if ("auto" in e && e.auto && t) return kl(t);
...
function Ol({ webauthn: e, signature: t, id: n }) {
  const r = ss(t);
  return {
    id: n,
    rawId: Ot(Rr(n)),
    response: {
      authenticatorData: Ot(Bt(e.authenticatorData)),
      clientDataJSON: Ot(Rr(e.clientDataJSON)),
      signature: Ot(Il(r.r, r.s)),
    },
...
async function Cl(e) {
  const { owner: t, ownerIndex: n, address: r, client: a, factoryData: i } = e,
    s = { abi: Cu, address: Tu, version: "0.6" },
    o = { abi: ui, address: uc };
  return Uu({
    client: a,
    entryPoint: s,
    ...
    async decodeCalls(u) {
      const c = Na({ abi: he, data: u });
      if (c.functionName === "execute") return [{ to: c.args[0], value: c.args[1], data: c.args[2] }];
      if (c.functionName === "executeBatch")
        return c.args[0].map((l) => ({ to: l.target, value: l.value, data: l.data }));
      throw new B(`unable to decode calls for "${c.functionName}"`);
    },
    async encodeCalls(u) {
      return u.length === 1
        ? Te({ abi: he, functionName: "execute", args: [u[0].to, u[0].value ?? BigInt(0), u[0].data ?? "0x"] })
        : Te({
            abi: he,
            functionName: "executeBatch",
            args: [u.map((c) => ({ data: c.data ?? "0x", target: c.to, value: c.value ?? BigInt(0) }))],
          });
    },
    async getAddress() {
      return r;
    ...
    async getFactoryArgs() {
      return i ? { factory: o.address, factoryData: i } : { factory: o.address, factoryData: i };
    },
    ...
    async sign(u) {
      const c = await this.getAddress(),
        l = mn({ address: c, chainId: a.chain.id, hash: u.hash }),
        d = await It({ hash: l, owner: t });
      return st({ ownerIndex: n, signature: d });
    },
    async signMessage(u) {
      const { message: c } = u,
        l = await this.getAddress(),
        d = mn({ address: l, chainId: a.chain.id, hash: Ra(c) }),
        p = await It({ hash: d, owner: t });
      return st({ ownerIndex: n, signature: p });
    },
    async signTypedData(u) {
      const { domain: c, types: l, primaryType: d, message: p } = u,
        f = await this.getAddress(),
        m = mn({ address: f, chainId: a.chain.id, hash: Zt({ domain: c, message: p, primaryType: d, types: l }) }),
        y = await It({ hash: m, owner: t });
      return st({ ownerIndex: n, signature: y });
    },
    async signUserOperation(u) {
      const { chainId: c = a.chain.id, ...l } = u,
        d = await this.getAddress(),
        p = Ru({
          chainId: c,
          entryPointAddress: s.address,
          entryPointVersion: s.version,
          userOperation: { ...l, sender: d },
        }),
        f = await It({ hash: p, owner: t });
      return st({ ownerIndex: n, signature: f });
    },
    userOperation: {
      async estimateGas(u) {
        if (t.type === "webAuthn")
          return { verificationGasLimit: BigInt(Math.max(Number(u.verificationGasLimit ?? BigInt(0)), 8e5)) };
      },
    },
  });
}
async function It({ hash: e, owner: t }) {
  if (t.type === "webAuthn") {
    const { signature: n, webauthn: r } = await t.sign({ hash: e });
    return Tl({ signature: n, webauthn: r });
  }
  if (t.sign) return t.sign({ hash: e });
  throw new B("`owner` does not support raw sign.");
}
function mn({ address: e, chainId: t, hash: n }) {
  return Zt({
    domain: { chainId: t, name: "Coinbase Smart Wallet", verifyingContract: e, version: "1" },
    types: { CoinbaseSmartWalletMessage: [{ name: "hash", type: "bytes32" }] },
    primaryType: "CoinbaseSmartWalletMessage",
    message: { hash: n },
  });
}
function Tl({ webauthn: e, signature: t }) {
  const { r: n, s: r } = ss(t);
  return Ve(
    [
      {
    ...
    [
      {
        ...
        clientDataJSON: Oa(e.clientDataJSON),
...
function st(e) {
  const { ownerIndex: t = 0 } = e,
    n = (() => {
      if (Ta(e.signature) !== 65) return e.signature;
      const r = oo(e.signature);
      return ro(["bytes32", "bytes32", "uint8"], [r.r, r.s, r.yParity === 0 ? 27 : 28]);
    })();
  return Ve(
    [
      {
...
async function _l({
  ...
  if (!c) throw S.rpc.internal("chainId not found");
  const l = await Cl({ owner: a, ownerIndex: i ?? 1, address: e, client: t, factoryData: r }),
    d = async (f) => {
      var m;
      try {
        switch (f.method) {
          ...
          case "eth_sendTransaction": {
            Ae(f.params);
            const y = f.params[0];
            me(y.to, S.rpc.invalidParams("to is required"));
            const b = {
                to: y.to,
                data: Cn(y.data ?? "0x", !0),
                value: Cn(y.value ?? "0x", !0),
                from: y.from ?? u.address,
              },
              E = fs({ calls: [b], chainId: c, from: b.from }),
              w = await d(E);
            return ls({ client: t, id: w });
          }
          case "wallet_sendCalls": {
            Ae(f.params);
            const y = ct(f.params[0], "chainId");
            if (!y) throw S.rpc.invalidParams("chainId is required");
            if (!ze(y)) throw S.rpc.invalidParams("chainId must be a hex encoded integer");
            if (!f.params[0]) throw S.rpc.invalidParams("params are required");
            if (!("calls" in f.params[0])) throw S.rpc.invalidParams("calls are required");
            let b = {
                ...
                funding: [
                  {
                    ...
                    data: { autoApply: !0, sources: [s], preference: "PREFER_DIRECT_BALANCE" },
                  },
                ],
              }));
            let E = await d(b);
            const w = await ((m = a.sign) == null ? void 0 : m.call(a, { hash: Nr(E.signatureRequest.hash) }));
            let O;
            if (!w) throw S.rpc.internal("signature not found");
            return (
              ze(w)
                ? (O = { type: "secp256k1", data: { address: a.address, signature: w } })
                : (O = {
                    type: "webauthn",
                    data: { signature: JSON.stringify(Ol({ id: a.id ?? "1", ...w })), publicKey: a.publicKey },
                  }),
              (
                await d({
                  method: "wallet_sendPreparedCalls",
                  params: [{ version: "1.0", type: E.type, data: E.userOp, chainId: E.chainId, signature: O }],
                })
              )[0]
            );
          }
          case "wallet_sendPreparedCalls": {
            ...
            if (!y) throw S.rpc.invalidParams("chainId is required");
            if (!ze(y)) throw S.rpc.invalidParams("chainId must be a hex encoded integer");
            return await t.request({ method: "wallet_sendPreparedCalls", params: f.params });
          }
          case "wallet_prepareCalls": {
            ...
            if (!ze(y)) throw S.rpc.invalidParams("chainId must be a hex encoded integer");
            if (!f.params[0]) throw S.rpc.invalidParams("params are required");
            if (!ct(f.params[0], "calls")) throw S.rpc.invalidParams("calls are required");
            const b = f.params[0];
            return (
              o && b.capabilities && !("attribution" in b.capabilities) && (b.capabilities.attribution = o),
              await t.request({ method: "wallet_prepareCalls", params: [{ ...f.params[0], chainId: y }] })
            );
          }
          case "personal_sign": {
            if ((Ae(f.params), !ze(f.params[0]))) throw S.rpc.invalidParams("message must be a hex encoded string");
            const y = Nr(f.params[0]);
            return l.signMessage({ message: y });
          }
          case "eth_signTypedData_v4": {
            Ae(f.params);
            const y = typeof f.params[1] == "string" ? JSON.parse(f.params[1]) : f.params[1];
            return l.signTypedData(y);
          }
...
async function ps({ address: e, client: t, publicKey: n, factory: r, factoryData: a }) {
  if (!(await _a(t, { address: e })) && r && a) {
    const o = Na({ abi: ui, data: a });
    if (o.functionName !== "createAccount") throw S.rpc.internal("unknown factory function");
    const [u] = o.args;
    return u.findIndex((c) => c.toLowerCase() === Pa(n).toLowerCase());
  }
  const s = await yn(t, { address: e, abi: he, functionName: "ownerCount" });
  for (let o = Number(s) - 1; o >= 0; o--) {
    const u = await yn(t, { address: e, abi: he, functionName: "ownerAtIndex", args: [BigInt(o)] }),
      c = Pa(n);
    if (u.toLowerCase() === c.toLowerCase()) return o;
  }
  return -1;
}
function Pa(e) {
...
async function Bl() {
  var n;
  const e = ((n = x.config.get().metadata) == null ? void 0 : n.appName) ?? "App",
    t = xr();
  return new Promise((r) => {
    (yr({ dialogContext: "sub_account_add_owner" }),
      t.presentItem({
        title: `Re-authorize ${e}`,
        message: `${e} has lost access to your account. Please sign at the next step to re-authorize ${e}`,
        onClose: () => {
          (yi({ dialogContext: "sub_account_add_owner" }), r("cancel"));
        },
        actionItems: [
          {
            text: "Continue",
            variant: "primary",
            onClick: () => {
              (Me({ dialogContext: "sub_account_add_owner", dialogAction: "confirm" }), t.clear(), r("authenticate"));
            },
          },
          {
            text: "Not now",
            variant: "secondary",
            onClick: () => {
              (Me({ dialogContext: "sub_account_add_owner", dialogAction: "cancel" }), t.clear(), r("cancel"));
            },
          },
        ],
      }));
...
async function Rl({ ownerAccount: e, globalAccountRequest: t, chainId: n }) {
  var f, m;
  const r = x.account.get(),
    a = x.subAccounts.get(),
    i =
      (f = r.accounts) == null
        ? void 0
        : f.find((y) => y.toLowerCase() !== (a == null ? void 0 : a.address.toLowerCase()));
  (me(i, S.provider.unauthorized("no global account")),
    me((m = r.chain) == null ? void 0 : m.id, S.provider.unauthorized("no chain id")),
    me(a == null ? void 0 : a.address, S.provider.unauthorized("no sub account")));
  const s = [];
  if (
    (e.type === "local" &&
      e.address &&
      s.push({
        to: a.address,
        data: Te({ abi: he, functionName: "addOwnerAddress", args: [e.address] }),
        value: Ze(0),
      }),
    e.publicKey)
  ) {
    const [y, b] = ja([{ type: "bytes32" }, { type: "bytes32" }], e.publicKey);
    s.push({ to: a.address, data: Te({ abi: he, functionName: "addOwnerPublicKey", args: [y, b] }), value: Ze(0) });
  }
  const o = { method: "wallet_sendCalls", params: [{ version: "1", calls: s, chainId: j(n), from: i }] };
  if ((await Bl()) === "cancel") throw S.provider.unauthorized("user cancelled");
  const c = await t(o),
    l = Hi(r.chain.id);
  if (
    (me(l, S.rpc.internal(`client not found for chainId ${r.chain.id}`)), (await Ua(l, { id: c })).status !== "success")
  )
  ...
  if (p === -1) throw S.rpc.internal("failed to find owner index");
  return p;
}
async function ms({
  request: e,
  ...
  var f;
  let o;
  if (e.method === "wallet_sendCalls" && El(e.params)) o = e.params[0];
  else if (e.method === "eth_sendTransaction" && Sl(e.params))
    o = fs({ calls: [e.params[0]], chainId: i, from: e.params[0].from }).params[0];
  else throw new Error(`Could not get original call from ${e.method} request`);
  const u = Te({
      abi: he,
      functionName: "executeBatch",
      args: [o.calls.map((m) => ({ target: m.to, value: dt(m.value ?? "0x0"), data: m.data ?? "0x" }))],
    }),
    c = [...(s ?? []), { data: u, to: n, value: "0x0" }],
    l = pt(
      { method: "wallet_sendCalls", params: [{ ...o, calls: c, from: t, version: "2.0.0", atomicRequired: !0 }] },
      { spendPermissions: { request: { spender: n } } },
    ),
    d = await a(l);
  let p = d.id;
  return (
    (f = d.capabilities) != null && f.spendPermissions && fr.set(d.capabilities.spendPermissions.permissions),
    e.method === "eth_sendTransaction" ? ls({ client: r, id: p }) : d
  );
}
async function Ul({ globalAccountAddress: e, subAccountAddress: t, client: n, request: r, globalAccountRequest: a }) {
  var o;
  ...
  try {
    ...
    throw S.provider.userRejectedRequest({ message: "User cancelled funding" });
  }
  return await ms({
    request: r,
...
class Nl {
  constructor(t) {
    ...
    L(this, "chain");
    var a;
    ((this.communicator = t.communicator), (this.callback = t.callback), (this.keyManager = new hl()));
    const { account: n, chains: r } = x.getState();
    ((this.accounts = n.accounts ?? []),
      (this.chain = n.chain ?? { id: ((a = t.metadata.appChainIds) == null ? void 0 : a[0]) ?? 1 }),
      r && fa(r));
  }
  get isConnected() {
  ...
  async handshake(t) {
    var r, a;
    const n = Ee.get(t);
    mu({ method: t.method, correlationId: n });
    try {
      await ((a = (r = this.communicator).waitForPopupLoaded) == null ? void 0 : a.call(r));
      const i = await this.createRequestMessage({ handshake: { method: t.method, params: t.params ?? [] } }, n),
        s = await this.communicator.postRequestAndWaitForResponse(i);
      if ("failure" in s.content) throw s.content.failure;
      const o = await qi("public", s.sender);
      await this.keyManager.setPeerPublicKey(o);
      const u = await this.decryptResponseMessage(s);
      (this.handleResponse(t, u), hu({ method: t.method, correlationId: n }));
    } catch (i) {
      throw (yu({ method: t.method, correlationId: n, errorMessage: He(i) }), i);
    }
  }
  async request(t) {
    const n = Ee.get(t);
    gu({ method: t.method, correlationId: n });
    try {
      const r = await this._request(t);
      return (wu({ method: t.method, correlationId: n }), r);
    } catch (r) {
      throw (bu({ method: t.method, correlationId: n, errorMessage: He(r) }), r);
    }
  }
  async _request(t) {
    var n, r, a, i, s, o, u;
    if (this.accounts.length === 0)
      switch (t.method) {
        case "wallet_switchEthereumChain": {
          (Aa(t.params), (this.chain.id = Number(t.params[0].chainId)));
          return;
        }
        case "wallet_connect": {
          (await ((r = (n = this.communicator).waitForPopupLoaded) == null ? void 0 : r.call(n)), await tr());
          const c = x.subAccountsConfig.get(),
            l = pt(t, (c == null ? void 0 : c.capabilities) ?? {});
    ...
    if (this.shouldRequestUseSubAccountSigner(t)) {
      const c = Ee.get(t);
      vu({ method: t.method, correlationId: c });
      try {
        const l = await this.sendRequestToSubAccountSigner(t);
        return (xu({ method: t.method, correlationId: c }), l);
      } catch (l) {
        throw (Eu({ method: t.method, correlationId: c, errorMessage: He(l) }), l);
      }
    }
    switch (t.method) {
      case "eth_requestAccounts":
      case "eth_accounts": {
        const c = x.subAccounts.get(),
          l = x.subAccountsConfig.get();
        return (
          c != null &&
            c.address &&
            (this.accounts =
              (l == null ? void 0 : l.defaultAccount) === "sub"
                ? At(this.accounts, c.address)
                : Pt(this.accounts, c.address)),
          (a = this.callback) == null || a.call(this, "connect", { chainId: j(this.chain.id) }),
          this.accounts
        );
      }
      case "eth_coinbase":
      ...
      case "wallet_grantPermissions":
        return this.sendRequestToPopup(t);
      case "wallet_connect": {
        (await ((s = (i = this.communicator).waitForPopupLoaded) == null ? void 0 : s.call(i)), await tr());
        const c = x.subAccountsConfig.get(),
          l = pt(t, (c == null ? void 0 : c.capabilities) ?? {}),
          d = await this.sendRequestToPopup(l);
        return ((o = this.callback) == null || o.call(this, "connect", { chainId: j(this.chain.id) }), d);
      }
      case "wallet_getSubAccounts": {
        const c = x.subAccounts.get();
        if (c != null && c.address) return { subAccounts: [c] };
        if (!this.chain.rpcUrl) throw S.rpc.internal("No RPC URL set for chain");
        const l = await ot(t, this.chain.rpcUrl);
        if ((Ae(l.subAccounts, "subAccounts"), l.subAccounts.length > 0)) {
          Et(l.subAccounts[0]);
          const d = l.subAccounts[0];
          x.subAccounts.set({ address: d.address, factory: d.factory, factoryData: d.factoryData });
        }
        return l;
      }
      case "wallet_addSubAccount":
      ...
      case "coinbase_fetchPermissions": {
        ...
        const c = vl(t),
          l = await ot(c, bn),
          d = ht((u = c.params) == null ? void 0 : u[0].chainId);
        return (x.spendPermissions.set(l.permissions.map((p) => ({ ...p, chainId: d }))), l);
      }
      case "coinbase_fetchPermission": {
        const l = await ot(t, bn);
        return (l.permission && l.permission.chainId && x.spendPermissions.set([l.permission]), l);
      }
      default:
        if (!this.chain.rpcUrl) throw S.rpc.internal("No RPC URL set for chain");
        return ot(t, this.chain.rpcUrl);
    }
  }
  async sendRequestToPopup(t) {
    var a, i;
    await ((i = (a = this.communicator).waitForPopupLoaded) == null ? void 0 : i.call(a));
    const n = await this.sendEncryptedRequest(t),
  ...
  async handleResponse(t, n) {
    ...
    switch (t.method) {
      case "eth_requestAccounts": {
        const c = r.value;
        ((this.accounts = c),
          x.account.set({ accounts: c, chain: this.chain }),
          (a = this.callback) == null || a.call(this, "accountsChanged", c));
        break;
      }
      case "wallet_connect": {
        const c = r.value,
          l = c.accounts.map((b) => b.address);
        ((this.accounts = l), x.account.set({ accounts: l }));
        const d = c.accounts.at(0),
          p = d == null ? void 0 : d.capabilities;
        if (p != null && p.subAccounts) {
          const b = p == null ? void 0 : p.subAccounts;
          (Ae(b, "subAccounts"),
            Et(b[0]),
            x.subAccounts.set({ address: b[0].address, factory: b[0].factory, factoryData: b[0].factoryData }));
        }
        const f = x.subAccounts.get(),
          m = x.subAccountsConfig.get();
        f != null &&
          f.address &&
          (this.accounts =
            (m == null ? void 0 : m.defaultAccount) === "sub"
              ? At(this.accounts, f.address)
              : Pt(this.accounts, f.address));
        const y =
          (s = (i = c == null ? void 0 : c.accounts) == null ? void 0 : i[0].capabilities) == null
            ? void 0
            : s.spendPermissions;
        (y && "permissions" in y && x.spendPermissions.set(y == null ? void 0 : y.permissions),
          (o = this.callback) == null || o.call(this, "accountsChanged", this.accounts));
        break;
      }
      case "wallet_addSubAccount": {
        Et(r.value);
        const c = r.value;
        x.subAccounts.set(c);
        const l = x.subAccountsConfig.get();
        ((this.accounts =
          (l == null ? void 0 : l.defaultAccount) === "sub"
            ? At(this.accounts, c.address)
            : Pt(this.accounts, c.address)),
          (u = this.callback) == null || u.call(this, "accountsChanged", this.accounts));
        break;
      }
    }
    return r.value;
  ...
  async cleanup() {
    var n;
    const t = x.config.get().metadata;
    (await this.keyManager.clear(),
      x.account.clear(),
      x.subAccounts.clear(),
      x.spendPermissions.clear(),
      x.chains.clear(),
      (this.accounts = []),
      (this.chain = { id: ((n = t == null ? void 0 : t.appChainIds) == null ? void 0 : n[0]) ?? 1 }));
  }
  async handleSwitchChainRequest(t) {
    Aa(t.params);
    const n = pu(t.params[0].chainId);
  ...
  async handleGetCapabilitiesRequest(t) {
    ...
    const n = t.params[0],
      r = t.params[1];
    if (!this.accounts.some((o) => no(o, n)))
  ...
  async sendEncryptedRequest(t) {
    ...
    if (!n) throw S.provider.unauthorized("No shared secret found when encrypting request");
    const r = await ld({ action: t, chainId: this.chain.id }, n),
      a = Ee.get(t),
  ...
  async createRequestMessage(t, n) {
    const r = await Vi("public", await this.keyManager.getOwnPublicKey());
    return { id: crypto.randomUUID(), correlationId: n, sender: r, content: t, timestamp: new Date() };
  }
  async decryptResponseMessage(t) {
    ...
    if (!r) throw S.provider.unauthorized("Invalid session: no shared secret found when decrypting response");
    const a = await fd(n.encrypted, r),
      i = (o = a.data) == null ? void 0 : o.chains;
    if (i) {
      const l = (u = a.data) == null ? void 0 : u.nativeCurrencies,
        d = Object.entries(i).map(([p, f]) => {
          const m = l == null ? void 0 : l[Number(p)];
          return { id: Number(p), rpcUrl: f, ...(m ? { nativeCurrency: m } : {}) };
        });
      (x.chains.set(d), this.updateChain(this.chain.id, d), fa(d));
    }
    const s = (c = a.data) == null ? void 0 : c.capabilities;
    return (s && x.account.set({ capabilities: s }), a);
  }
  updateChain(t, n) {
    var s;
    const r = x.getState(),
      a = n ?? r.chains,
      i = a == null ? void 0 : a.find((o) => o.id === t);
    return i
      ? (i !== this.chain &&
          ((this.chain = i),
          x.account.set({ chain: i }),
          (s = this.callback) == null || s.call(this, "chainChanged", Bi(i.id))),
        !0)
      : !1;
  }
  async addSubAccount(t) {
    var s, o, u;
    const r = x.getState().subAccount,
      a = x.subAccountsConfig.get();
    if (r != null && r.address)
      return (
        (this.accounts =
          (a == null ? void 0 : a.defaultAccount) === "sub"
            ? At(this.accounts, r.address)
            : Pt(this.accounts, r.address)),
        (s = this.callback) == null || s.call(this, "accountsChanged", this.accounts),
        r
      );
    if (
      (await ((u = (o = this.communicator).waitForPopupLoaded) == null ? void 0 : u.call(o)),
      Array.isArray(t.params) && t.params.length > 0 && t.params[0].account && t.params[0].account.type === "create")
    ) {
      let c;
      if (t.params[0].account.keys && t.params[0].account.keys.length > 0) c = t.params[0].account.keys;
      else {
        const l = x.subAccountsConfig.get() ?? {},
          { account: d } = l.toOwnerAccount ? await l.toOwnerAccount() : await er();
        if (!d) throw S.provider.unauthorized("could not get subaccount owner account when adding sub account");
        c = [{ type: d.address ? "address" : "webauthn-p256", publicKey: d.address || d.publicKey }];
      }
      t.params[0].account.keys = c;
    }
  ...
  async sendRequestToSubAccountSigner(t) {
    var y, b, E;
    const n = x.subAccounts.get(),
      r = x.subAccountsConfig.get(),
      a = x.config.get();
    me(
      n == null ? void 0 : n.address,
      S.provider.unauthorized("no active sub account when sending request to sub account signer"),
    );
    const i = r != null && r.toOwnerAccount ? await r.toOwnerAccount() : await er();
    (me(
      i == null ? void 0 : i.account,
      S.provider.unauthorized("no active sub account owner when sending request to sub account signer"),
    ),
      ka(t) === void 0 && (t = gl(t, n.address)));
    ...
    const u = Al({
        attribution: (y = a.preference) == null ? void 0 : y.attribution,
        dappOrigin: window.location.origin,
      }),
      c =
        t.method === "wallet_sendCalls" && ((E = (b = t.params) == null ? void 0 : b[0]) == null ? void 0 : E.chainId),
      l = c ? ht(c) : this.chain.id,
      d = Hi(l);
    if (
      (me(d, S.rpc.internal(`client not found for chainId ${l} when sending request to sub account signer`)),
      ["eth_sendTransaction", "wallet_sendCalls"].includes(t.method))
    ) {
      const w = x.subAccountsConfig.get();
      if ((w == null ? void 0 : w.funding) === "spend-permissions" && fr.get().length === 0)
        return await ms({
          request: t,
    ...
    const p = i.account.type === "local" ? i.account.address : i.account.publicKey;
    let f = await ps({ address: n.address, factory: n.factory, factoryData: n.factoryData, publicKey: p, client: d });
    if (f === -1) {
      const w = Ee.get(t);
      Su({ method: t.method, correlationId: w });
      try {
        ((f = await Rl({
          ...
          ku({ method: t.method, correlationId: w }));
      } catch (O) {
        return (
          Au({ method: t.method, correlationId: w, errorMessage: He(O) }),
          S.provider.unauthorized("failed to add sub account owner when sending request to sub account signer")
        );
      }
    }
    const { request: m } = await _l({
      address: n.address,
      owner: i.account,
      client: d,
      factory: n.factory,
    ...
    try {
      ...
      const O = x.subAccountsConfig.get();
      if ((O == null ? void 0 : O.funding) === "manual") throw w;
      let U;
      if (mi(w)) U = JSON.parse(w.details);
      else if (qr(w)) U = w;
      else throw w;
      if (!(qr(U) && U.data) || !U.data) throw w;
      const $ = Ee.get(t);
      Pu({ method: t.method, correlationId: $ });
      try {
        const re = await Ul({
          errorData: U.data,
          globalAccountAddress: o,
        ...
        return (Ou({ method: t.method, correlationId: $ }), re);
      } catch (re) {
        throw (console.error(re), Iu({ method: t.method, correlationId: $, errorMessage: He(re) }), w);
      }
    }
  }
}
class jl extends nu {
  constructor({ metadata: n, preference: { walletUrl: r, ...a } }) {
    super();
    L(this, "communicator");
    L(this, "signer");
    L(this, "isBaseAccount", !0);
    ((this.communicator = new Qc({ url: r, metadata: n, preference: a })),
      (this.signer = new Nl({ metadata: n, communicator: this.communicator, callback: this.emit.bind(this) })));
  }
  async request(n) {
    const r = crypto.randomUUID();
    (Ee.set(n, r), ru({ method: n.method, correlationId: r }));
    try {
      const a = await this._request(n);
      return (iu({ method: n.method, correlationId: r }), a);
    } catch (a) {
      throw (au({ method: n.method, correlationId: r, errorMessage: He(a) }), a);
    } finally {
      Ee.delete(n);
    }
  }
  async _request(n) {
    var r;
    try {
      if ((pd(n), !this.signer.isConnected))
        switch (n.method) {
          case "eth_requestAccounts": {
            (await this.signer.handshake({ method: "handshake" }),
              ...
              await this.signer.request({
                ...
                params: [
                  {
                    version: "1",
                    capabilities: { ...(((r = x.subAccountsConfig.get()) == null ? void 0 : r.capabilities) ?? {}) },
                  },
                ],
              }));
            break;
          ...
          case "wallet_connect":
            return (await this.signer.handshake({ method: "handshake" }), await this.signer.request(n));
          case "wallet_switchEthereumChain":
      ...
      const { code: i } = a;
      return (i === Y.provider.unauthorized && (await this.disconnect()), Promise.reject($c(a)));
    }
  }
  async disconnect() {
    (await this.signer.cleanup(),
...
const Dl = "isCoinbaseBrowser";
function Ml() {
  var t;
  const e = ((t = window.top) == null ? void 0 : t.ethereum) ?? window.ethereum;
  return e != null && e[Dl] ? e : null;
}
function Kl(e) {
  var a, i, s, o, u;
  const t = {
    metadata: { appName: e.appName || "App", appLogoUrl: e.appLogoUrl || "", appChainIds: e.appChainIds || [] },
    preference: e.preference ?? {},
    paymasterUrls: e.paymasterUrls,
  };
  ((a = e.subAccounts) != null && a.toOwnerAccount && Zr(e.subAccounts.toOwnerAccount),
    x.subAccountsConfig.set({
      toOwnerAccount: (i = e.subAccounts) == null ? void 0 : i.toOwnerAccount,
      creation: ((s = e.subAccounts) == null ? void 0 : s.creation) ?? "manual",
      defaultAccount: ((o = e.subAccounts) == null ? void 0 : o.defaultAccount) ?? "universal",
      funding: ((u = e.subAccounts) == null ? void 0 : u.funding) ?? "spend-permissions",
    }),
    x.config.set(t),
    x.persist.rehydrate(),
    gc(),
    wc(t.preference),
    t.preference.telemetry !== !1 && oc());
  let n = null;
  const r = {
    getProvider: () => (n || (n = Ml() ?? new jl(t)), n),
    subAccount: {
      async create(c) {
        var l;
        return await ((l = r.getProvider()) == null
          ? void 0
          : l.request({ method: "wallet_addSubAccount", params: [{ version: "1", account: c }] }));
      },
      async get() {
        var p, f;
        const c = x.subAccounts.get();
        if (c != null && c.address) return c;
        const d =
          (f = (
            await ((p = r.getProvider()) == null
              ? void 0
              : p.request({ method: "wallet_connect", params: [{ version: "1", capabilities: {} }] }))
          ).accounts[0].capabilities) == null
            ? void 0
            : f.subAccounts;
        return Array.isArray(d) ? d[0] : null;
      },
      addOwner: async ({ address: c, publicKey: l, chainId: d }) => {
        var y, b;
        const p = x.subAccounts.get(),
          f = x.account.get();
        (me(f, new Error("account does not exist")),
          me(p == null ? void 0 : p.address, new Error("subaccount does not exist")));
        const m = [];
        if (l) {
          const [E, w] = ja([{ type: "bytes32" }, { type: "bytes32" }], l);
          m.push({
            to: p.address,
            data: Te({ abi: he, functionName: "addOwnerPublicKey", args: [E, w] }),
            value: Ze(0),
          });
        }
        return (
          c &&
            m.push({ to: p.address, data: Te({ abi: he, functionName: "addOwnerAddress", args: [c] }), value: Ze(0) }),
          await ((b = r.getProvider()) == null
            ? void 0
            : b.request({
                method: "wallet_sendCalls",
                params: [{ calls: m, chainId: Ze(d), from: (y = f.accounts) == null ? void 0 : y[0], version: "1" }],
              }))
        );
      },
      setToOwnerAccount(c) {
        (Zr(c), x.subAccountsConfig.set({ toOwnerAccount: c }));
      },
    },
  };
  return r;
}
export { tt as VERSION, Kl as createBaseAccountSDK, er as getCryptoKeyAccount };
