import {
  ...
  x as yi,
  f as $n,
} from "./core-CcnASMk0.js";
import { n as u, c as B, o as E, r as _, U as he, e as Rn, f as _n, a as In } from "./index-Dd5QMJ5n.js";
import { n as En } from "./index-myL0f5cF.js";
import "./index.es-C5YIhjW9.js";
import "./events-DQ172AOg.js";
const Wn = N`
  :host {
    position: relative;
...
var _e = function (r, e, i, n) {
  var o = arguments.length,
    t = o < 3 ? e : n === null ? (n = Object.getOwnPropertyDescriptor(e, i)) : n,
    a;
...
let Ze = class extends O {
  ...
  render() {
    ...
    return c`${this.walletImages.slice(0, It).map(
      ({ src: i, walletName: n }) => c`
            <wui-wallet-image
              size="inherit"
              imageSrc=${i}
              name=${E(n)}
...
Ze.styles = [q, Sn];
an([u({ type: Array })], Ze.prototype, "walletImages", void 0);
Ze = an([B("wui-all-wallets-image")], Ze);
const Tn = N`
  button {
  ...
  templateStatus() {
    return this.loading
      ...
      : this.tagLabel && this.tagVariant
        ? c`<wui-tag variant=${this.tagVariant}>${this.tagLabel}</wui-tag>`
        : this.icon
          ? c`<wui-icon color="inherit" size="sm" name=${this.icon}></wui-icon>`
          : null;
  }
};
F.styles = [q, G, Tn];
...
let ye = class extends O {
  constructor() {
    (super(),
      ...
      (this.count = z.state.count),
      (this.filteredCount = z.state.filteredWallets.length),
      (this.isFetchingRecommendedWallets = z.state.isFetchingRecommendedWallets),
      this.unsubscribe.push(
        M.subscribeKey("connectors", (e) => (this.connectors = e)),
        z.subscribeKey("count", (e) => (this.count = e)),
        z.subscribeKey("filteredWallets", (e) => (this.filteredCount = e.length)),
        z.subscribeKey("isFetchingRecommendedWallets", (e) => (this.isFetchingRecommendedWallets = e)),
      ));
  }
  ...
  render() {
    const e = this.connectors.find((l) => l.id === "walletConnect"),
      { allWallets: i } = ee.state;
    if (!e || i === "HIDE" || (i === "ONLY_MOBILE" && !k.isMobile())) return null;
    const n = z.state.featured.length,
      o = this.count + n,
      t = o < 10 ? o : Math.floor(o / 10) * 10,
      a = this.filteredCount > 0 ? this.filteredCount : t;
    let s = `${a}`;
    return (
      this.filteredCount > 0 ? (s = `${this.filteredCount}`) : a < o && (s = `${a}+`),
      c`
      <wui-list-wallet
        name="All Wallets"
...
Ae([u()], ye.prototype, "tabIdx", void 0);
Ae([_()], ye.prototype, "connectors", void 0);
Ae([_()], ye.prototype, "count", void 0);
Ae([_()], ye.prototype, "filteredCount", void 0);
Ae([_()], ye.prototype, "isFetchingRecommendedWallets", void 0);
ye = Ae([B("w3m-all-wallets-widget")], ye);
...
ai([u()], et.prototype, "tabIdx", void 0);
ai([_()], et.prototype, "connectors", void 0);
et = ai([B("w3m-connect-announced-widget")], et);
...
let Ue = class extends O {
  constructor() {
    (super(),
      ...
      k.isTelegram() &&
        k.isIos() &&
        ((this.loading = !j.state.wcUri), this.unsubscribe.push(j.subscribeKey("wcUri", (e) => (this.loading = !e)))));
  }
  disconnectedCallback() {
    this.unsubscribe.forEach((e) => e());
  }
  ...
  filterOutDuplicateWallets(e) {
    const i = ft.getRecentWallets(),
      n = this.connectors
        ...
        .filter(Boolean),
      o = i.map((s) => s.rdns).filter(Boolean),
      t = n.concat(o);
...
gt([_()], Ue.prototype, "connectors", void 0);
gt([_()], Ue.prototype, "loading", void 0);
Ue = gt([B("w3m-connect-custom-widget")], Ue);
...
let tt = class extends O {
  ...
  render() {
    const n = this.connectors
      ...
      .filter(Me.showConnector)
      .filter((o) => o.id !== Cn.CONNECTOR_ID.COINBASE_SDK);
...
si([u()], tt.prototype, "tabIdx", void 0);
si([_()], tt.prototype, "connectors", void 0);
tt = si([B("w3m-connect-external-widget")], tt);
...
li([u()], it.prototype, "tabIdx", void 0);
li([u()], it.prototype, "wallets", void 0);
it = li([B("w3m-connect-featured-widget")], it);
...
ci([u()], nt.prototype, "tabIdx", void 0);
ci([u()], nt.prototype, "connectors", void 0);
nt = ci([B("w3m-connect-injected-widget")], nt);
...
ui([u()], ot.prototype, "tabIdx", void 0);
ui([_()], ot.prototype, "connectors", void 0);
ot = ui([B("w3m-connect-multi-chain-widget")], ot);
...
wt([_()], qe.prototype, "connectors", void 0);
wt([_()], qe.prototype, "loading", void 0);
qe = wt([B("w3m-connect-recent-widget")], qe);
...
let Fe = class extends O {
  ...
  render() {
    const { connectors: e } = M.state,
      { customWallets: i, featuredWalletIds: n } = ee.state,
      o = ft.getRecentWallets(),
      t = e.find((p) => p.id === "walletConnect"),
      s = e
        .filter((p) => p.type === "INJECTED" || p.type === "ANNOUNCED" || p.type === "MULTI_CHAIN")
        .filter((p) => p.name !== "Browser Wallet");
    if (!t) return null;
    if (n || i || !this.wallets.length) return ((this.style.cssText = "display: none"), null);
    const l = s.length + o.length,
      d = Math.max(0, 2 - l),
      h = pt.filterOutDuplicateWallets(this.wallets).slice(0, d);
    return h.length
      ? c`
      <wui-flex flexDirection="column" gap="xs">
        ${h.map(
...
bt([u()], Fe.prototype, "tabIdx", void 0);
bt([u()], Fe.prototype, "wallets", void 0);
bt([_()], Fe.prototype, "loading", void 0);
Fe = bt([B("w3m-connect-recommended-widget")], Fe);
...
let Ve = class extends O {
  constructor() {
    (super(),
      ...
      (this.tabIdx = void 0),
      (this.connectors = M.state.connectors),
      (this.connectorImages = vi.state.connectorImages),
      this.unsubscribe.push(
        M.subscribeKey("connectors", (e) => (this.connectors = e)),
        vi.subscribeKey("connectorImages", (e) => (this.connectorImages = e)),
      ));
  }
  disconnectedCallback() {
    this.unsubscribe.forEach((e) => e());
  ...
  render() {
    if (k.isMobile()) return ((this.style.cssText = "display: none"), null);
...
mt([u()], Ve.prototype, "tabIdx", void 0);
mt([_()], Ve.prototype, "connectors", void 0);
mt([_()], Ve.prototype, "connectorImages", void 0);
Ve = mt([B("w3m-connect-walletconnect-widget")], Ve);
const Pn = N`
  :host {
...
let xe = class extends O {
  constructor() {
    (super(),
      ...
      (this.tabIdx = void 0),
      (this.connectors = M.state.connectors),
      (this.recommended = z.state.recommended),
      (this.featured = z.state.featured),
      this.unsubscribe.push(
        M.subscribeKey("connectors", (e) => (this.connectors = e)),
        z.subscribeKey("recommended", (e) => (this.recommended = e)),
        z.subscribeKey("featured", (e) => (this.featured = e)),
      ));
  }
  disconnectedCallback() {
    this.unsubscribe.forEach((e) => e());
  ...
  connectorListTemplate() {
    const {
      ...
      featured: s,
      external: l,
    } = Me.getConnectorsByType(this.connectors, this.recommended, this.featured);
...
Ke([_()], xe.prototype, "connectors", void 0);
Ke([_()], xe.prototype, "recommended", void 0);
Ke([_()], xe.prototype, "featured", void 0);
...
let re = class extends O {
  ...
  animateTabs(e, i) {
    const n = this.buttons[this.activeTab],
      o = this.buttons[e],
      t = n == null ? void 0 : n.querySelector("wui-text"),
      a = o == null ? void 0 : o.querySelector("wui-text"),
      s = o == null ? void 0 : o.getBoundingClientRect(),
      l = a == null ? void 0 : a.getBoundingClientRect();
    (n &&
      t &&
      !i &&
      e !== this.activeTab &&
      ...
      o &&
        ...
        a &&
        (e !== this.activeTab || i) &&
        ((this.localTabWidth = `${Math.round(s.width + l.width) + 6}px`),
        o.animate([{ width: `${s.width + l.width}px` }], { duration: i ? 0 : 500, fill: "forwards", easing: "ease" }),
        a.animate([{ opacity: 1 }], { duration: i ? 0 : 125, delay: i ? 0 : 200, fill: "forwards", easing: "ease" })));
  }
};
re.styles = [q, G, Bn];
ve([u({ type: Array })], re.prototype, "tabs", void 0);
ve([u()], re.prototype, "onTabChange", void 0);
ve([u({ type: Array })], re.prototype, "buttons", void 0);
ve([u({ type: Boolean })], re.prototype, "disabled", void 0);
ve([u()], re.prototype, "localTabWidth", void 0);
ve([_()], re.prototype, "activeTab", void 0);
ve([_()], re.prototype, "isDense", void 0);
re = ve([B("wui-tabs")], re);
...
di([u({ type: Array })], rt.prototype, "platforms", void 0);
di([u()], rt.prototype, "onSelectPlatfrom", void 0);
rt = di([B("w3m-connecting-header")], rt);
const Ln = N`
  :host {
...
const xi = {
  ...
  On = { lg: "paragraph-600", md: "small-600" },
  An = { lg: "md", md: "md" };
let Q = class extends O {
  ...
  loadingTemplate() {
    if (this.loading) {
      const e = An[this.size],
        i = this.disabled ? xi.disabled : xi[this.variant];
...
Q.styles = [q, G, Ln];
ae([u()], Q.prototype, "size", void 0);
ae([u({ type: Boolean })], Q.prototype, "disabled", void 0);
ae([u({ type: Boolean })], Q.prototype, "fullWidth", void 0);
ae([u({ type: Boolean })], Q.prototype, "loading", void 0);
ae([u()], Q.prototype, "variant", void 0);
ae([u({ type: Boolean })], Q.prototype, "hasIconLeft", void 0);
ae([u({ type: Boolean })], Q.prototype, "hasIconRight", void 0);
ae([u()], Q.prototype, "borderRadius", void 0);
ae([u()], Q.prototype, "textVariant", void 0);
Q = ae([B("wui-button")], Q);
const kn = N`
  button {
...
Pe.styles = [q, G, kn];
vt([u()], Pe.prototype, "tabIdx", void 0);
vt([u({ type: Boolean })], Pe.prototype, "disabled", void 0);
vt([u()], Pe.prototype, "color", void 0);
Pe = vt([B("wui-link")], Pe);
const jn = N`
  :host {
    display: block;
...
at.styles = [q, jn];
sn([u({ type: Number })], at.prototype, "radius", void 0);
at = sn([B("wui-loading-thumbnail")], at);
const Dn = N`
  button {
    border: none;
    border-radius: var(--wui-border-radius-3xl);
...
Be.styles = [q, G, zn];
yt([u({ type: Boolean })], Be.prototype, "disabled", void 0);
yt([u()], Be.prototype, "label", void 0);
yt([u()], Be.prototype, "buttonLabel", void 0);
Be = yt([B("wui-cta-button")], Be);
const Nn = N`
  :host {
    display: block;
...
let st = class extends O {
  ...
  render() {
    ...
    const { name: e, app_store: i, play_store: n, chrome_store: o, homepage: t } = this.wallet,
      a = k.isMobile(),
      s = k.isIos(),
      l = k.isAndroid(),
      d = [i, n, t, o].filter(Boolean).length > 1,
      h = he.getTruncateString({ string: e, charsStart: 12, charsEnd: 0, truncate: "end" });
    return d && !a
      ? c`
        <wui-cta-button
          label=${`Don't have ${h}?`}
...
st.styles = [Nn];
ln([u({ type: Object })], st.prototype, "wallet", void 0);
st = ln([B("w3m-mobile-download-links")], st);
const Mn = N`
  @keyframes shake {
    0% {
...
class V extends O {
  constructor() {
    var e, i, n, o, t;
    (super(),
      (this.wallet = (e = U.state.data) == null ? void 0 : e.wallet),
      (this.connector = (i = U.state.data) == null ? void 0 : i.connector),
      (this.timeout = void 0),
      ...
      (this.name =
        ((n = this.wallet) == null ? void 0 : n.name) ?? ((o = this.connector) == null ? void 0 : o.name) ?? "Wallet"),
      (this.isRetrying = !1),
      (this.uri = j.state.wcUri),
      (this.error = j.state.wcError),
      (this.ready = !1),
      (this.showRetry = !1),
      ...
      (this.onRetry = void 0),
      this.unsubscribe.push(
        j.subscribeKey("wcUri", (a) => {
          var s;
          ((this.uri = a),
            this.isRetrying && this.onRetry && ((this.isRetrying = !1), (s = this.onConnect) == null || s.call(this)));
        }),
        j.subscribeKey("wcError", (a) => (this.error = a)),
      ),
      (k.isTelegram() || k.isSafari()) && k.isIos() && j.state.wcUri && ((t = this.onConnect) == null || t.call(this)));
  }
  firstUpdated() {
    var e;
  ...
  onShowRetry() {
    ...
    if (this.error && !this.showRetry) {
      ...
      i == null || i.animate([{ opacity: 0 }, { opacity: 1 }], { fill: "forwards", easing: "ease" });
    }
  }
  onTryAgain() {
    var e, i;
  ...
  loaderTemplate() {
    const e = ei.state.themeVariables["--w3m-border-radius-master"],
...
V.styles = Mn;
se([_()], V.prototype, "isRetrying", void 0);
se([_()], V.prototype, "uri", void 0);
se([_()], V.prototype, "error", void 0);
se([_()], V.prototype, "ready", void 0);
se([_()], V.prototype, "showRetry", void 0);
se([_()], V.prototype, "secondaryBtnLabel", void 0);
se([_()], V.prototype, "secondaryLabel", void 0);
se([_()], V.prototype, "isLoading", void 0);
se([u({ type: Boolean })], V.prototype, "isMobile", void 0);
se([u()], V.prototype, "onRetry", void 0);
...
let Ci = class extends V {
  ...
  async onConnectProxy() {
    ...
    try {
      this.error = !1;
      const { connectors: i } = M.state,
        n = i.find((o) => {
          var t, a, s;
          return (
            (o.type === "ANNOUNCED" &&
              ((t = o.info) == null ? void 0 : t.rdns) === ((a = this.wallet) == null ? void 0 : a.rdns)) ||
            o.type === "INJECTED" ||
            o.name === ((s = this.wallet) == null ? void 0 : s.name)
          );
        });
      if (n) await j.connectExternal(n, n.chain);
...
Ci = Un([B("w3m-connecting-wc-browser")], Ci);
...
let $i = class extends V {
  ...
  onConnectProxy() {
    ...
    if ((e = this.wallet) != null && e.desktop_link && this.uri)
      try {
        this.error = !1;
        const { desktop_link: i, name: n } = this.wallet,
          { redirect: o, href: t } = k.formatNativeUrl(i, this.uri);
...
$i = qn([B("w3m-connecting-wc-desktop")], $i);
var ke = function (r, e, i, n) {
  var o = arguments.length,
    t = o < 3 ? e : n === null ? (n = Object.getOwnPropertyDescriptor(e, i)) : n,
    a;
...
let Ce = class extends V {
  constructor() {
    if (
      ...
      (this.target = void 0),
      (this.preferUniversalLinks = ee.state.experimental_preferUniversalLinks),
      (this.isLoading = !0),
      (this.onConnect = () => {
        var e;
        if ((e = this.wallet) != null && e.mobile_link && this.uri)
          try {
            this.error = !1;
            const { mobile_link: i, link_mode: n, name: o } = this.wallet,
              { redirect: t, redirectUniversalLink: a, href: s } = k.formatNativeUrl(i, this.uri, n);
            ((this.redirectDeeplink = t),
              (this.redirectUniversalLink = a),
              (this.target = k.isIframe() ? "_top" : "_self"),
              j.setWcLinking({ name: o, href: s }),
              j.setRecentWallet(this.wallet),
              this.preferUniversalLinks && this.redirectUniversalLink
                ? k.openHref(this.redirectUniversalLink, this.target)
                : k.openHref(this.redirectDeeplink, this.target));
          } catch (i) {
            (te.sendEvent({
              type: "track",
    ...
    ((this.secondaryBtnLabel = "Open"),
      (this.secondaryLabel = rn.CONNECT_LABELS.MOBILE),
      (this.secondaryBtnIcon = "externalLink"),
      this.onHandleURI(),
      this.unsubscribe.push(
        j.subscribeKey("wcUri", () => {
          this.onHandleURI();
        }),
      ),
      te.sendEvent({
...
ke([_()], Ce.prototype, "redirectDeeplink", void 0);
ke([_()], Ce.prototype, "redirectUniversalLink", void 0);
ke([_()], Ce.prototype, "target", void 0);
ke([_()], Ce.prototype, "preferUniversalLinks", void 0);
ke([_()], Ce.prototype, "isLoading", void 0);
Ce = ke([B("w3m-connecting-wc-mobile")], Ce);
var Te = {},
  Et,
  Ri;
function Fn() {
...
function Vn() {
  ...
  return (
    (r.prototype = {
      ...
      put: function (e, i) {
        for (let n = 0; n < i; n++) this.putBit(((e >>> (i - n - 1)) & 1) === 1);
      },
...
function Kn() {
  ...
  return (
    (r.prototype.set = function (e, i, n, o) {
      ...
      (function (r) {
        ...
        ((r.getRowColCoords = function (n) {
          ...
          const o = Math.floor(n / 7) + 2,
            t = e(n),
            a = t === 145 ? 26 : Math.ceil((t - 13) / (2 * o - 2)) * 2,
            s = [t - 7];
          ...
          (r.getPositions = function (n) {
            const o = [],
              t = r.getRowColCoords(n),
              a = t.length;
            for (let s = 0; s < a; s++)
              for (let l = 0; l < a; l++)
                (s === 0 && l === 0) || (s === 0 && l === a - 1) || (s === a - 1 && l === 0) || o.push([t[s], t[l]]);
            return o;
          }));
      })(Bt)),
    Bt
...
function Gn() {
  if (Ti) return Lt;
  Ti = 1;
  const r = Ee().getSymbolSize,
    e = 7;
  return (
    (Lt.getPositions = function (n) {
      const o = r(n);
      return [
        [0, 0],
        [o - e, 0],
    ...
    Pi ||
      ...
      (function (r) {
        ...
        ((r.isValid = function (o) {
          ...
          (r.getPenaltyN1 = function (o) {
            ...
            for (let p = 0; p < t; p++) {
              ...
              for (let x = 0; x < t; x++) {
                let g = o.get(p, x);
                (g === d ? s++ : (s >= 5 && (a += e.N1 + (s - 5)), (d = g), (s = 1)),
                  (g = o.get(x, p)),
                  g === h ? l++ : (l >= 5 && (a += e.N1 + (l - 5)), (h = g), (l = 1)));
              }
          ...
          (r.getPenaltyN3 = function (o) {
            ...
            for (let d = 0; d < t; d++) {
              s = l = 0;
              for (let h = 0; h < t; h++)
                ((s = ((s << 1) & 2047) | o.get(d, h)),
                  h >= 10 && (s === 1488 || s === 93) && a++,
                  (l = ((l << 1) & 2047) | o.get(h, d)),
                  h >= 10 && (l === 1488 || l === 93) && a++);
            }
            return a * e.N3;
          }),
        ...
        ((r.applyMask = function (o, t) {
          const a = t.size;
          for (let s = 0; s < a; s++) for (let l = 0; l < a; l++) t.isReserved(l, s) || t.xor(l, s, i(o, l, s));
        }),
...
function cn() {
  ...
  return (
    (Qe.getBlocksCount = function (o, t) {
      switch (t) {
        case r.L:
          return e[(o - 1) * 4 + 0];
        case r.M:
...
function Jn() {
  ...
  return (
    (function () {
      let n = 1;
      for (let o = 0; o < 255; o++) ((r[o] = n), (e[n] = o), (n <<= 1), n & 256 && (n ^= 285));
    ...
    Oi ||
      ...
      (function (r) {
        ...
        ((r.mul = function (n, o) {
          ...
          for (let a = 0; a < n.length; a++) for (let s = 0; s < o.length; s++) t[a + s] ^= e.mul(n[a], o[s]);
          return t;
        }),
          (r.mod = function (n, o) {
          ...
          (r.generateECPolynomial = function (n) {
            ...
            for (let t = 0; t < n; t++) o = r.mul(o, new Uint8Array([1, e.exp(t)]));
            return o;
          }));
      })(At)),
    At
...
function Xn() {
  ...
  return (
    ...
    (e.prototype.encode = function (n) {
      ...
      o.set(n);
      const t = r.mod(o, this.genPoly),
        a = this.degree - t.length;
      if (a > 0) {
...
function dn() {
  ...
  ((oe.KANJI = new RegExp(i, "g")),
    (oe.BYTE_KANJI = new RegExp("[^A-Z0-9 $%*+\\-./:]+", "g")),
    (oe.BYTE = new RegExp(n, "g")),
    (oe.NUMERIC = new RegExp(r, "g")),
    (oe.ALPHANUMERIC = new RegExp(e, "g")));
  const o = new RegExp("^" + i + "$"),
    t = new RegExp("^" + r + "$"),
    a = new RegExp("^[A-Z0-9 $%*+\\-./:]+$");
  return (
    (oe.testKanji = function (l) {
      return o.test(l);
    }),
    ...
    zi ||
      ...
      (function (r) {
        const e = Ee(),
          ...
          s = e.getBCHDigit(a);
        function l(x, g, W) {
          for (let v = 1; v <= 40; v++) if (g <= r.getCapacity(v, W, x)) return v;
        }
        function d(x, g) {
        ...
        function p(x, g) {
          for (let W = 1; W <= 40; W++) if (h(x, W) <= r.getCapacity(W, g, o.MIXED)) return W;
        }
        ((r.from = function (g, W) {
          return t.isValid(g) ? parseInt(g, 10) : W;
        }),
          (r.getCapacity = function (g, W, v) {
            if (!t.isValid(g)) throw new Error("Invalid QR Code version");
            typeof v > "u" && (v = o.BYTE);
            const S = e.getSymbolTotalCodewords(g),
              b = i.getTotalCodewordsCount(g, W),
              w = (S - b) * 8;
          ...
          (r.getEncodedBits = function (g) {
            if (!t.isValid(g) || g < 7) throw new Error("Invalid QR Code version");
            let W = g << 12;
...
function eo() {
  ...
  const r = Ee(),
    ...
    n = r.getBCHDigit(e);
  return (
    (Nt.getEncodedBits = function (t, a) {
      const s = (t.bit << 3) | a;
      let l = s << 10;
      for (; r.getBCHDigit(l) - n >= 0; ) l ^= e << (r.getBCHDigit(l) - n);
      return ((s << 10) | l) ^ i;
    }),
    Nt
  );
...
function oo() {
  ...
  return (
    ...
    (i.prototype.write = function (n) {
      for (let o = 0, t = this.data.length; o < t; o++) n.put(this.data[o], 8);
    }),
    (Vt = i),
    Vt
  );
      ...
      (function (r) {
        var e = {
          ...
          extract_shortest_path_from_predecessor_list: function (i, n) {
            for (var o = [], t = n; t; ) (o.push(t), i[t], (t = i[t]));
            return (o.reverse(), o);
          },
    ...
    Hi ||
      ...
      (function (r) {
        ...
        function h(b, w, m) {
          const f = [];
          let D;
          for (; (D = b.exec(m)) !== null; ) f.push({ data: D[0], index: D.index, mode: w, length: D[0].length });
          return f;
        }
        function p(b) {
          const w = h(a.NUMERIC, e.NUMERIC, b),
            m = h(a.ALPHANUMERIC, e.ALPHANUMERIC, b);
          let f, D;
          return (
            s.isKanjiModeEnabled()
              ? ((f = h(a.BYTE, e.BYTE, b)), (D = h(a.KANJI, e.KANJI, b)))
              : ((f = h(a.BYTE_KANJI, e.BYTE, b)), (D = [])),
            w
              .concat(m, f, D)
              .sort(function (T, I) {
          ...
          for (let m = 0; m < b.length; m++) {
            ...
            switch (f.mode) {
              case e.NUMERIC:
                ...
                break;
              case e.ALPHANUMERIC:
                w.push([f, { data: f.data, mode: e.BYTE, length: f.length }]);
                break;
              case e.KANJI:
                w.push([f, { data: f.data, mode: e.BYTE, length: d(f.data) }]);
                break;
              case e.BYTE:
                w.push([{ data: f.data, mode: e.BYTE, length: d(f.data) }]);
            }
          }
          return w;
        }
        function v(b, w) {
          ...
          for (let C = 0; C < b.length; C++) {
            ...
            for (let y = 0; y < T.length; y++) {
              const L = T[y],
                $ = "" + C + y;
              (I.push($), (m[$] = { node: L, lastCount: 0 }), (f[$] = {}));
              for (let P = 0; P < D.length; P++) {
                const R = D[P];
                m[R] && m[R].node.mode === L.mode
                  ? ((f[R][$] = x(m[R].lastCount + L.length, L.mode) - x(m[R].lastCount, L.mode)),
                    (m[R].lastCount += L.length))
                  : (m[R] && (m[R].lastCount = L.length),
                    (f[R][$] = x(L.length, L.mode) + 4 + e.getCharCountIndicator(L.mode, w)));
              }
            }
            D = I;
          }
 ...
 Suggested mode is: ` +
        ...
        ((r.fromArray = function (w) {
          ...
          (r.fromString = function (w, m) {
            const f = p(w, s.isKanjiModeEnabled()),
              D = W(f),
              C = v(D, m),
              T = l.find_path(C.map, "start", "end"),
              I = [];
            for (let y = 1; y < T.length - 1; y++) I.push(C.table[T[y]].node);
            return r.fromArray(g(I));
          }),
          (r.rawSplit = function (w) {
            return r.fromArray(p(w, s.isKanjiModeEnabled()));
          }));
      })(Mt)),
    Mt
  );
...
function lo() {
  ...
  function W(C) {
    ...
    for (let I = 8; I < T - 8; I++) {
      const y = I % 2 === 0;
      (C.set(I, 6, y, !0), C.set(6, I, y, !0));
    }
  }
  function v(C, T) {
    const I = o.getPositions(T);
    for (let y = 0; y < I.length; y++) {
      const L = I[y][0],
        $ = I[y][1];
      for (let P = -2; P <= 2; P++)
        for (let R = -2; R <= 2; R++)
          P === -2 || P === 2 || R === -2 || R === 2 || (P === 0 && R === 0)
            ? C.set(L + P, $ + R, !0, !0)
            : C.set(L + P, $ + R, !1, !0);
    }
  }
  ...
  function b(C, T, I) {
    const y = C.size,
      L = h.getEncodedBits(T, I);
    let $, P;
    for ($ = 0; $ < 15; $++)
      ((P = ((L >> $) & 1) === 1),
        $ < 6 ? C.set($, 8, P, !0) : $ < 8 ? C.set($ + 1, 8, P, !0) : C.set(y - 15 + $, 8, P, !0),
        $ < 8 ? C.set(8, y - $ - 1, P, !0) : $ < 9 ? C.set(8, 15 - $ - 1 + 1, P, !0) : C.set(8, 15 - $ - 1, P, !0));
    C.set(y - 8, 8, 1, !0);
  }
  function w(C, T) {
    const I = C.size;
  ...
  function m(C, T, I) {
    ...
    const L = r.getSymbolTotalCodewords(C),
      $ = s.getTotalCodewordsCount(C, T),
      P = (L - $) * 8;
    for (y.getLengthInBits() + 4 <= P && y.put(0, 4); y.getLengthInBits() % 8 !== 0; ) y.putBit(0);
    const R = (P - y.getLengthInBits()) / 8;
    for (let A = 0; A < R; A++) y.put(A % 2 ? 17 : 236, 8);
    return f(y, C, T);
  }
  function f(C, T, I) {
    const y = r.getSymbolTotalCodewords(T),
      L = s.getTotalCodewordsCount(T, I),
      $ = y - L,
      P = s.getBlocksCount(T, I),
      R = y % P,
      A = P - R,
      we = Math.floor(y / P),
      De = Math.floor($ / P),
    ...
    let mi = 0,
      ce,
      ue;
    for (ce = 0; ce < $t; ce++) for (ue = 0; ue < P; ue++) ce < Je[ue].length && (Rt[mi++] = Je[ue][ce]);
    for (ce = 0; ce < wi; ce++) for (ue = 0; ue < P; ue++) Rt[mi++] = bi[ue][ce];
    return Rt;
  }
  function D(C, T, I, y) {
    let L;
    if (Array.isArray(C)) L = x.fromArray(C);
      ...
      if (!we) {
        ...
        we = d.getBestVersionForData(De, I);
      }
      L = x.fromString(C, we || 40);
    } else throw new Error("Invalid data");
    const $ = d.getBestVersionForData(L, I);
    if (!$) throw new Error("The amount of data is too big to be stored in a QR Code");
    if (!T) T = $;
    else if (T < $)
      throw new Error(
        `
...
`,
    ...
    return (
      ...
      T >= 7 && S(A, T),
      w(A, P),
      isNaN(y) && (y = a.getBestMask(A, b.bind(null, A, I))),
      a.applyMask(y, A),
      b(A, I, y),
      { modules: A, version: T, errorCorrectionLevel: I, maskPattern: y, segments: L }
    );
  }
  return (
    (Wt.create = function (T, I) {
      ...
      return (
        typeof I < "u" &&
          ((y = e.from(I.errorCorrectionLevel, e.M)),
          (L = d.from(I.version)),
          ($ = a.from(I.maskPattern)),
          I.toSJISFunc && r.setToSJISFunction(I.toSJISFunc)),
        D(T, L, y, $)
      );
    }),
    Wt
      ...
      (function (r) {
        ...
        ((r.getOptions = function (n) {
          ...
          const o = typeof n.margin > "u" || n.margin === null || n.margin < 0 ? 4 : n.margin,
            t = n.width && n.width >= 21 ? n.width : void 0,
            a = n.scale || 4;
          return {
            width: t,
            scale: t ? 4 : a,
          ...
          (r.qrToImageData = function (n, o, t) {
            const a = o.modules.size,
              s = o.modules.data,
              l = r.getScale(a, t),
              d = Math.floor((a + t.margin * 2) * l),
              h = t.margin * l,
              p = [t.color.light, t.color.dark];
            for (let x = 0; x < d; x++)
              for (let g = 0; g < d; g++) {
                let W = (x * d + g) * 4,
                  v = t.color.light;
                if (x >= h && g >= h && x < d - h && g < d - h) {
                  const S = Math.floor((x - h) / l),
                    b = Math.floor((g - h) / l);
                  v = p[s[S * a + b] ? 1 : 0];
                }
    ...
    Ji ||
      ...
      (function (r) {
        ...
        ((r.render = function (t, a, s) {
          ...
          const h = e.getImageWidth(t.modules.size, l),
            p = d.getContext("2d"),
            x = p.createImageData(h, h);
...
function uo() {
  ...
  function n(o, t, a) {
    ...
    for (let p = 0; p < o.length; p++) {
      const x = Math.floor(p % t),
        g = Math.floor(p / t);
      (!x && !d && (d = !0),
        o[p]
          ? (h++,
            (p > 0 && x > 0 && o[p - 1]) || ((s += d ? i("M", x + a, 0.5 + g + a) : i("m", l, 0)), (l = 0), (d = !1)),
            (x + 1 < t && o[p + 1]) || ((s += i("h", h)), (h = 0)))
          : l++);
    }
    return s;
  }
  return (
    (Jt.render = function (t, a, s) {
      const l = r.getOptions(a),
        d = t.modules.size,
        h = t.modules.data,
        p = d + l.margin * 2,
        x = l.color.light.a ? "<path " + e(l.color.light, "fill") + ' d="M0 0h' + p + "v" + p + 'H0z"/>' : "",
        g = "<path " + e(l.color.dark, "stroke") + ' d="' + n(h, d, l.margin) + '"/>',
        W = 'viewBox="0 0 ' + p + " " + p + '"',
        S =
...
function ho() {
  ...
  function o(t, a, s, l, d) {
    ...
    if (x) {
      ...
      p === 2
        ? ((d = s), (s = a), (a = l = void 0))
        : p === 3 &&
          (a.getContext && typeof d > "u" ? ((d = l), (l = void 0)) : ((d = l), (l = s), (s = a), (a = void 0)));
    } else {
      if (p < 1) throw new Error("Too few arguments provided");
      return (
        p === 1 ? ((s = a), (a = l = void 0)) : p === 2 && !a.getContext && ((l = s), (s = a), (a = void 0)),
  ...
  return (
    (Te.create = e.create),
    (Te.toCanvas = o.bind(null, i.render)),
    (Te.toDataURL = o.bind(null, i.renderToDataURL)),
    (Te.toString = o.bind(null, function (t, a, s) {
      return n.render(t, s);
    })),
    Te
  );
...
function wo(r, e) {
  const i = Array.prototype.slice.call(po.create(r, { errorCorrectionLevel: e }).modules.data, 0),
    ...
    generate({ uri: r, size: e, logoSize: i, dotColor: n = "#141414" }) {
      ...
      s.forEach((v, S) => {
        v.forEach((b, w) => {
          if (
            s[S][w] &&
            !((S < de && w < de) || (S > s.length - (de + 1) && w < de) || (S < de && w > s.length - (de + 1))) &&
            !(S > p && S < x && w > p && w < x)
          ) {
            const m = S * l + l / 2,
              f = w * l + l / 2;
...
let ie = class extends O {
  ...
  templateVisual() {
    return this.imageSrc
      ? c`<wui-image src=${this.imageSrc} alt=${this.alt ?? "logo"}></wui-image>`
      : this.farcaster
        ? c`<wui-icon
        class="farcaster"
        size="inherit"
...
ie.styles = [q, mo];
ge([u()], ie.prototype, "uri", void 0);
ge([u({ type: Number })], ie.prototype, "size", void 0);
ge([u()], ie.prototype, "theme", void 0);
ge([u()], ie.prototype, "imageSrc", void 0);
ge([u()], ie.prototype, "alt", void 0);
ge([u()], ie.prototype, "color", void 0);
ge([u({ type: Boolean })], ie.prototype, "arenaClear", void 0);
ge([u({ type: Boolean })], ie.prototype, "farcaster", void 0);
ie = ge([B("wui-qr-code")], ie);
const yo = N`
  :host {
    display: block;
    box-shadow: inset 0 0 0 1px var(--wui-color-gray-glass-005);
...
$e.styles = [yo];
He([u()], $e.prototype, "width", void 0);
He([u()], $e.prototype, "height", void 0);
He([u()], $e.prototype, "borderRadius", void 0);
He([u()], $e.prototype, "variant", void 0);
$e = He([B("wui-shimmer")], $e);
const xo = "https://reown.com",
  Co = N`
  .reown-logo {
...
let ii = class extends V {
  ...
  disconnectedCallback() {
    ...
    (super.disconnectedCallback(),
      (e = this.unsubscribe) == null || e.forEach((i) => i()),
...
ii.styles = Ro;
ii = _o([B("w3m-connecting-wc-qrcode")], ii);
var Io = function (r, e, i, n) {
  var o = arguments.length,
    t = o < 3 ? e : n === null ? (n = Object.getOwnPropertyDescriptor(e, i)) : n,
    a;
  if (typeof Reflect == "object" && typeof Reflect.decorate == "function") t = Reflect.decorate(r, e, i, n);
...
en = Io([B("w3m-connecting-wc-unsupported")], en);
...
let ni = class extends V {
  constructor() {
    ...
    ((this.onConnect = this.onConnectProxy.bind(this)),
      ...
      te.sendEvent({ type: "track", event: "SELECT_WALLET", properties: { name: this.wallet.name, platform: "web" } }));
  }
  updateLoadingState() {
    this.isLoading = !this.uri;
  }
  onConnectProxy() {
    ...
    if ((e = this.wallet) != null && e.webapp_link && this.uri)
      try {
        this.error = !1;
        const { webapp_link: i, name: n } = this.wallet,
          { redirect: o, href: t } = k.formatUniversalUrl(i, this.uri);
        (j.setWcLinking({ name: n, href: t }), j.setRecentWallet(this.wallet), k.openHref(o, "_blank"));
      } catch {
        this.error = !0;
      }
...
fn([_()], ni.prototype, "isLoading", void 0);
ni = fn([B("w3m-connecting-wc-web")], ni);
var Ge = function (r, e, i, n) {
  var o = arguments.length,
    t = o < 3 ? e : n === null ? (n = Object.getOwnPropertyDescriptor(e, i)) : n,
    a;
...
let Le = class extends O {
  constructor() {
    ...
    (super(),
      ...
      (this.platforms = []),
      (this.isSiwxEnabled = !!ee.state.siwx),
      (this.remoteFeatures = ee.state.remoteFeatures),
      this.determinePlatforms(),
      this.initializeConnection(),
      this.unsubscribe.push(ee.subscribeKey("remoteFeatures", (i) => (this.remoteFeatures = i))));
  }
  disconnectedCallback() {
    this.unsubscribe.forEach((e) => e());
  }
  ...
  async initializeConnection(e = !1) {
    if (!(this.platform === "browser" || (ee.state.manualWCControl && !e)))
      try {
        ...
        (e || ee.state.enableEmbedded || k.isPairingExpired(i) || n === "connecting") &&
          (await j.connectWalletConnect(), this.isSiwxEnabled || on.close());
      } catch (i) {
        (te.sendEvent({
          type: "track",
          event: "CONNECT_ERROR",
          ...
          j.setWcError(!0),
          Xe.showError(i.message ?? "Connection error"),
          j.resetWcConnection(),
          U.goBack());
      }
  }
  determinePlatforms() {
    ...
    const { mobile_link: e, desktop_link: i, webapp_link: n, injected: o, rdns: t } = this.wallet,
      a = o == null ? void 0 : o.map(({ injected_id: W }) => W).filter(Boolean),
      s = [...(t ? [t] : (a ?? []))],
      l = ee.state.isUniversalProvider ? !1 : s.length,
      d = e,
      h = n,
      p = j.checkInstalled(s),
      x = l && p,
      g = i && !k.isMobile();
    (x && !Zt.state.noAdapters && this.platforms.push("browser"),
      d && this.platforms.push(k.isMobile() ? "mobile" : "qrcode"),
      h && this.platforms.push("web"),
      g && this.platforms.push("desktop"),
      !x && l && !Zt.state.noAdapters && this.platforms.push("unsupported"),
  ...
  async onSelectPlatform(e) {
    ...
    i &&
      (await i.animate([{ opacity: 1 }, { opacity: 0 }], { duration: 200, fill: "forwards", easing: "ease" }).finished,
      (this.platform = e),
      i.animate([{ opacity: 0 }, { opacity: 1 }], { duration: 200, fill: "forwards", easing: "ease" }));
  }
};
Ge([_()], Le.prototype, "platform", void 0);
Ge([_()], Le.prototype, "platforms", void 0);
Ge([_()], Le.prototype, "isSiwxEnabled", void 0);
Ge([_()], Le.prototype, "remoteFeatures", void 0);
Le = Ge([B("w3m-connecting-wc-view")], Le);
...
let oi = class extends O {
  ...
  render() {
    if (this.isMobile) {
      const { featured: e, recommended: i } = z.state,
        { customWallets: n } = ee.state,
        o = ft.getRecentWallets(),
        t = e.length || i.length || (n == null ? void 0 : n.length) || o.length;
      return c`<wui-flex
        flexDirection="column"
        gap="xs"
        .margin=${["3xs", "s", "s", "s"]}
...
pn([_()], oi.prototype, "isMobile", void 0);
oi = pn([B("w3m-connecting-wc-basic-view")], oi);
/**
 * @license
    ...
    class extends _n {
      ...
      update(r, [e]) {
        ...
        return (
          ...
          (i || this.lt !== this.ct) &&
            ((this.G = e), (this.ht = (n = r.options) == null ? void 0 : n.host), this.rt((this.ct = r.element))),
          yi
        );
      }
      rt(r) {
        if ((this.isConnected || (r = void 0), typeof this.G == "function")) {
          ...
          let i = Xt.get(e);
          (i === void 0 && ((i = new WeakMap()), Xt.set(e, i)),
            i.get(this.G) !== void 0 && this.G.call(this.ht, void 0),
            i.set(this.G, r),
            r !== void 0 && this.G.call(this.ht, r));
        } else this.G.value = r;
      }
      get lt() {
        var r, e;
        return typeof this.G == "function"
          ? (r = Xt.get(this.ht ?? globalThis)) == null
            ? void 0
            : r.get(this.G)
          : (e = this.G) == null
            ? void 0
...
lt.styles = [q, G, $n, Wo];
gn([u({ type: Boolean })], lt.prototype, "checked", void 0);
lt = gn([B("wui-switch")], lt);
const So = N`
  :host {
    height: 100%;
  }
...
ct.styles = [q, G, So];
wn([u({ type: Boolean })], ct.prototype, "checked", void 0);
ct = wn([B("wui-certified-switch")], ct);
const To = N`
  button {
...
ut.styles = [q, G, To];
bn([u()], ut.prototype, "icon", void 0);
ut = bn([B("wui-input-element")], ut);
const Po = N`
  :host {
    position: relative;
    width: 100%;
...
let X = class extends O {
  ...
  render() {
    const e = `wui-padding-right-${this.inputRightPadding}`,
      n = { [`wui-size-${this.size}`]: !0, [e]: !!this.inputRightPadding };
...
X.styles = [q, G, Po];
le([u()], X.prototype, "size", void 0);
le([u()], X.prototype, "icon", void 0);
le([u({ type: Boolean })], X.prototype, "disabled", void 0);
le([u()], X.prototype, "placeholder", void 0);
le([u()], X.prototype, "type", void 0);
le([u()], X.prototype, "keyHint", void 0);
le([u()], X.prototype, "value", void 0);
le([u()], X.prototype, "inputRightPadding", void 0);
le([u()], X.prototype, "tabIdx", void 0);
X = le([B("wui-input-text")], X);
const Bo = N`
  :host {
    position: relative;
    display: inline-block;
...
let ri = class extends O {
  ...
  clearValue() {
    const e = this.inputComponentRef.value,
      i = e == null ? void 0 : e.inputElementRef.value;
    i && ((i.value = ""), i.focus(), i.dispatchEvent(new Event("input")));
  }
};
ri.styles = [q, Bo];
ri = Lo([B("wui-search-bar")], ri);
  ...
  shimmerTemplate() {
    return this.type === "network"
      ? c` <wui-shimmer
        ...
        ></wui-shimmer>
        ${Oo}`
      : c`<wui-shimmer width="56px" height="56px" borderRadius="xs"></wui-shimmer>`;
  }
};
dt.styles = [q, G, Ao];
mn([u()], dt.prototype, "type", void 0);
dt = mn([B("wui-card-select-loader")], dt);
const ko = N`
  :host {
    display: grid;
    width: inherit;
...
Re.styles = jo;
Ye([_()], Re.prototype, "visible", void 0);
Ye([_()], Re.prototype, "imageSrc", void 0);
Ye([_()], Re.prototype, "imageLoading", void 0);
Ye([u()], Re.prototype, "wallet", void 0);
Re = Ye([B("w3m-all-wallets-list-item")], Re);
const Do = N`
  wui-grid {
...
let me = class extends O {
  constructor() {
    (super(),
      ...
      (this.loading = !z.state.wallets.length),
      (this.wallets = z.state.wallets),
      (this.recommended = z.state.recommended),
      (this.featured = z.state.featured),
      (this.filteredWallets = z.state.filteredWallets),
      this.unsubscribe.push(
        z.subscribeKey("wallets", (e) => (this.wallets = e)),
        z.subscribeKey("recommended", (e) => (this.recommended = e)),
        z.subscribeKey("featured", (e) => (this.featured = e)),
        z.subscribeKey("filteredWallets", (e) => (this.filteredWallets = e)),
      ));
  }
  firstUpdated() {
  ...
  async initialFetch() {
    ...
    e &&
      (await z.fetchWalletsByPage({ page: 1 }),
      await e.animate([{ opacity: 1 }, { opacity: 0 }], { duration: 200, fill: "forwards", easing: "ease" }).finished,
      (this.loading = !1),
      e.animate([{ opacity: 0 }, { opacity: 1 }], { duration: 200, fill: "forwards", easing: "ease" }));
  }
  shimmerTemplate(e, i) {
    return [...Array(e)].map(
      () => c`
  ...
  walletsTemplate() {
    ...
    const e =
      ((n = this.filteredWallets) == null ? void 0 : n.length) > 0
        ? k.uniqueBy([...this.featured, ...this.recommended, ...this.filteredWallets], "id")
        : k.uniqueBy([...this.featured, ...this.recommended, ...this.wallets], "id");
    return pt.markWalletsAsInstalled(e).map(
      (o) => c`
  ...
  paginationLoaderTemplate() {
    const { wallets: e, recommended: i, featured: n, count: o } = z.state,
      t = window.innerWidth < 352 ? 3 : 4,
      a = e.length + i.length;
    let l = Math.ceil(a / t) * t - a + t;
    return (
      (l -= e.length ? n.length % t : 0),
      o === 0 && n.length > 0 ? null : o === 0 || [...n, ...e, ...i].length < o ? this.shimmerTemplate(l, tn) : null
    );
  }
...
me.styles = Do;
je([_()], me.prototype, "loading", void 0);
je([_()], me.prototype, "wallets", void 0);
je([_()], me.prototype, "recommended", void 0);
je([_()], me.prototype, "featured", void 0);
je([_()], me.prototype, "filteredWallets", void 0);
me = je([B("w3m-all-wallets-list")], me);
const zo = N`
  wui-grid,
  wui-loading-spinner,
  wui-flex {
...
let Oe = class extends O {
  ...
  render() {
    return (
      this.onSearch(),
      this.loading ? c`<wui-loading-spinner color="accent-100"></wui-loading-spinner>` : this.walletsTemplate()
    );
  }
  async onSearch() {
    (this.query.trim() !== this.prevQuery.trim() || this.badge !== this.prevBadge) &&
      ...
      (this.loading = !0),
      await z.searchWallet({ search: this.query, badge: this.badge }),
      (this.loading = !1));
  }
  walletsTemplate() {
    const { search: e } = z.state,
      i = pt.markWalletsAsInstalled(e);
    return e.length
      ? c`
      <wui-grid
...
Oe.styles = zo;
xt([_()], Oe.prototype, "loading", void 0);
xt([u()], Oe.prototype, "query", void 0);
xt([u()], Oe.prototype, "badge", void 0);
Oe = xt([B("w3m-all-wallets-search")], Oe);
...
let ht = class extends O {
  constructor() {
    (super(...arguments),
      (this.search = ""),
      (this.onDebouncedSearch = k.debounce((e) => {
        this.search = e;
      })));
  }
  render() {
    ...
    return c`
      ...
      ${
        e || this.badge
          ...
          : c`<w3m-all-wallets-list badge=${E(this.badge)}></w3m-all-wallets-list>`
      }
    `;
  }
  onInputChange(e) {
  ...
  onClick() {
    ...
    ((this.badge = "certified"),
      Xe.showSvg("Only WalletConnect certified", { icon: "walletConnectBrown", iconColor: "accent-100" }));
  }
  qrButtonTemplate() {
    return k.isMobile()
      ? c`
...
gi([_()], ht.prototype, "search", void 0);
gi([_()], ht.prototype, "badge", void 0);
ht = gi([B("w3m-all-wallets-view")], ht);
const No = N`
  button {
    column-gap: var(--wui-spacing-s);
  ...
  visualTemplate() {
    ...
    if (this.variant === "icon" && this.icon && this.iconVariant) {
      const e = ["blue", "square-blue"].includes(this.iconVariant) ? "accent-100" : "fg-200",
        i = this.iconVariant === "square-blue" ? "mdl" : "md",
        n = this.iconSize ? this.iconSize : i;
      return c`
        <wui-icon-box
...
nn = Mo([B("w3m-downloads-view")], nn);
export { ht as W3mAllWalletsView, oi as W3mConnectingWcBasicView, nn as W3mDownloadsView };
