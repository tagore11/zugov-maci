...
class Ee extends Xt {
  ...
  update(e) {
    ...
    for (let c = 0; c < s; ) {
      ...
      if (f === o) {
        const i = At(e);
        for (; o <= s - c; c += o) this.process(i, c);
        continue;
      }
  ...
  digestInto(e) {
    ...
    for (let h = 0; h < u; h++) f.setUint32(4 * h, y[h], s);
  }
  digest() {
...
const Be = new Uint32Array([
  ...
  Q = new Uint32Array([1779033703, 3144134277, 1013904242, 2773480762, 1359893119, 2600822924, 528734635, 1541459225]),
...
class ve extends Ee {
  ...
  process(e, t) {
    for (let h = 0; h < 16; h++, t += 4) J[h] = e.getUint32(t, !1);
    for (let h = 16; h < 64; h++) {
      const l = J[h - 15],
        m = J[h - 2],
        N = P(l, 7) ^ P(l, 18) ^ (l >>> 3),
        b = P(m, 17) ^ P(m, 19) ^ (m >>> 10);
      J[h] = (b + J[h - 7] + N + J[h - 16]) | 0;
    }
    let { A: r, B: o, C: s, D: c, E: f, F: i, G: u, H: y } = this;
    for (let h = 0; h < 64; h++) {
      const l = P(f, 6) ^ P(f, 11) ^ P(f, 25),
        m = (y + l + me(f, i, u) + Be[h] + J[h]) | 0,
        b = ((P(r, 2) ^ P(r, 13) ^ P(r, 22)) + xe(r, o, s)) | 0;
...
const te = (n, e, t) => new Jt(n, e).update(t).digest();
te.create = (n, e) => new Jt(n, e);
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */ const Ct = BigInt(0),
  ee = BigInt(1),
  Ae = BigInt(2);
function it(n) {
...
function yt(n) {
  if (!it(n)) throw new Error("Uint8Array expected");
}
function at(n, e) {
  if (typeof e != "boolean") throw new Error(n + " boolean expected, got " + e);
}
const Ie = Array.from({ length: 256 }, (n, e) => e.toString(16).padStart(2, "0"));
function ut(n) {
  yt(n);
  let e = "";
  for (let t = 0; t < n.length; t++) e += Ie[n[t]];
  return e;
}
function wt(n) {
...
function jt(n) {
  if (n >= D._0 && n <= D._9) return n - D._0;
  if (n >= D.A && n <= D.F) return n - (D.A - 10);
  if (n >= D.a && n <= D.f) return n - (D.a - 10);
}
function pt(n) {
  if (typeof n != "string") throw new Error("hex string expected, got " + typeof n);
  ...
  for (let o = 0, s = 0; o < t; o++, s += 2) {
    const c = jt(n.charCodeAt(s)),
      f = jt(n.charCodeAt(s + 1));
...
function K(n, e, t) {
  ...
  const o = r.length;
  if (typeof t == "number" && o !== t) throw new Error(n + " of length " + t + " expected, got " + o);
  return r;
}
function bt(...n) {
  let e = 0;
...
function ot(n, e, t, r) {
  if (!Bt(e, t, r)) throw new Error("expected valid " + n + ": " + t + " <= n < " + r + ", got " + e);
}
function ne(n) {
  let e;
  for (e = 0; n > Ct; n >>= ee, e += 1);
  return e;
}
const Vt = (n) => (Ae << BigInt(n - 1)) - ee,
  Nt = (n) => new Uint8Array(n),
  Yt = (n) => Uint8Array.from(n);
function re(n, e, t) {
...
function mt(n, e, t = {}) {
  ...
  for (const [o, s] of Object.entries(t)) r(o, s, !0);
  return n;
}
function Ut(n) {
  const e = new WeakMap();
...
function Le(n, e, t) {
  if (e < z) throw new Error("invalid exponent, negatives unsupported");
  if (t <= z) throw new Error("invalid modulus");
  if (t === _) return z;
  let r = _;
  for (; e > z; ) (e & _ && (r = (r * n) % t), (n = (n * n) % t), (e >>= _));
  return r;
}
function Y(n, e, t) {
  let r = n;
...
function Tt(n, e) {
  if (n === z) throw new Error("invert: expected non-zero number");
  if (e <= z) throw new Error("invert: expected positive modulus, got " + e);
  let t = V(n, e),
    r = e,
    o = z,
    s = _;
...
function He(n) {
  ...
  if (r === 1) {
    ...
    return function (i, u) {
      const y = i.pow(u, c);
      if (!i.eql(i.sqr(y), u)) throw new Error("Cannot find square root");
      return y;
    };
  }
  const s = (t + _) / nt;
  return function (f, i) {
    ...
    let u = r,
      y = f.pow(f.mul(f.ONE, o), t),
      h = f.pow(i, s),
      l = f.pow(i, t);
    for (; !f.eql(l, f.ONE); ) {
      if (f.eql(l, f.ZERO)) return f.ZERO;
      let m = 1;
      for (let b = f.sqr(l); m < u && !f.eql(b, f.ONE); m++) b = f.sqr(b);
  ...
  if (n % Kt === Ft) {
    ...
    return function (r, o) {
      const s = r.mul(o, nt),
        c = r.pow(s, e),
        f = r.mul(o, c),
        i = r.mul(r.mul(f, nt), c),
        u = r.mul(f, r.sub(i, r.ONE));
...
function ke(n, e, t) {
  ...
  let r = n.ONE,
    o = e;
  for (; t > z; ) (t & _ && (r = n.mul(r, o)), (o = n.sqr(o)), (t >>= _));
  return r;
}
function ze(n, e) {
  const t = new Array(e.length),
    r = e.reduce((s, c, f) => (n.is0(c) ? s : ((t[f] = s), n.mul(s, c))), n.ONE),
    o = n.inv(r);
...
function ie(n, e, t = !1, r = {}) {
  if (n <= z) throw new Error("invalid field: expected ORDER > 0, got " + n);
...
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */ const Pt = BigInt(0),
  xt = BigInt(1);
function qt(n, e) {
  const t = e.negate();
  return n ? t : e;
...
function Me(n, e) {
  return {
    ...
    unsafeLadder(t, r, o = n.ZERO) {
      let s = t;
      for (; r > Pt; ) (r & xt && (o = o.add(s)), (s = s.double()), (r >>= xt));
      return o;
    },
    precomputeWindow(t, r) {
      const { windows: o, windowSize: s } = Ot(r, e),
        c = [];
      let f = t,
        i = f;
      for (let u = 0; u < o; u++) {
        ((i = f), c.push(i));
        for (let y = 1; y < s; y++) ((i = i.add(f)), c.push(i));
        f = i.double();
      }
      return c;
    },
    ...
    wNAFUnsafe(t, r, o, s = n.ZERO) {
      const { windows: c, windowSize: f } = Ot(t, e),
        i = BigInt(2 ** t - 1),
        u = 2 ** t,
        y = BigInt(t);
      for (let h = 0; h < c; h++) {
        ...
        if (o === Pt) break;
        let m = Number(o & i);
        if (((o >>= y), m > f && ((m -= u), (o += xt)), m === 0)) continue;
...
function Ve(n, e, t, r) {
  ...
  const o = n.ZERO,
    s = ne(BigInt(t.length)),
    c = s > 12 ? s - 3 : s > 4 ? s - 2 : s ? 2 : 1,
    f = (1 << c) - 1,
    i = new Array(f + 1).fill(o),
  ...
  for (let h = u; h >= 0; h -= c) {
    ...
    for (let m = 0; m < r.length; m++) {
      const N = r[m],
        b = Number((N >> BigInt(h)) & BigInt(f));
      i[b] = i[b].add(t[m]);
    }
    let l = o;
    for (let m = i.length - 1, N = o; m > 0; m--) ((N = N.add(i[m])), (l = l.add(N)));
    if (((y = y.add(l)), h !== 0)) for (let m = 0; m < c; m++) y = y.double();
  }
  return y;
}
function ue(n) {
  return (
    ...
    Object.freeze({ ...oe(n.n, n.nBitLength), ...n, p: n.Fp.ORDER })
  );
}
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */ function Gt(n) {
...
const $ = {
    ...
    _tlv: {
      encode: (n, e) => {
        ...
        const r = e.length / 2,
          o = wt(r);
        if ((o.length / 2) & 128) throw new t("tlv.encode: long form length too big");
      ...
      decode(n, e) {
        ...
        if (!s) c = o;
          ...
          const i = o & 127;
          if (!i) throw new t("tlv.decode(long): indefinite length not supported");
          if (i > 4) throw new t("tlv.decode(long): byte length is too big");
          const u = e.subarray(r, r + i);
          if (u.length !== i) throw new t("tlv.decode: length bytes not complete");
          if (u[0] === 0) throw new t("tlv.decode(long): zero leftmost byte");
          for (const y of u) c = (c << 8) | y;
          if (((r += i), c < 128)) throw new t("tlv.decode(long): not minimal encoding");
        }
        const f = e.subarray(r, r + c);
        if (f.length !== c) throw new t("tlv.decode: wrong value length");
    ...
    _int: {
      encode(n) {
        const { Err: e } = $;
        if (n < W) throw new e("integer: negative integers are not allowed");
        let t = wt(n);
    ...
    toSig(n) {
      const { Err: e, _int: t, _tlv: r } = $,
        o = typeof n == "string" ? Fe(n) : n;
      yt(o);
      const { v: s, l: c } = r.decode(48, o);
      if (c.length) throw new e("invalid signature: left bytes after parsing");
      const { v: f, l: i } = r.decode(2, s),
        { v: u, l: y } = r.decode(2, i);
...
function Pe(n) {
  const e = je(n),
    ...
    s =
      e.fromBytes ||
      ((b) => {
        const a = b.subarray(1),
          g = t.fromBytes(a.subarray(0, t.BYTES)),
          x = t.fromBytes(a.subarray(t.BYTES, 2 * t.BYTES));
        return { x: g, y: x };
      });
  function c(b) {
    const { a, b: g } = e,
  ...
  if (!t.eql(t.sqr(e.Gy), c(e.Gx))) throw new Error("bad generator point: equation left != right");
  function f(b) {
    return Bt(b, k, e.n);
  }
  function i(b) {
    ...
    if (a && typeof b != "bigint") {
      if ((it(b) && (b = ut(b)), typeof b != "string" || !a.includes(b.length))) throw new Error("invalid private key");
      b = b.padStart(g * 2, "0");
    }
    let q;
    try {
  ...
  const y = Ut((b, a) => {
      ...
      if (t.eql(E, t.ONE)) return { x: g, y: x };
      const q = b.is0();
    ...
    h = Ut((b) => {
      if (b.is0()) {
        if (e.allowInfinityPoint && !t.is0(b.py)) return;
        throw new Error("bad point: ZERO");
      }
      const { x: a, y: g } = b.toAffine();
      if (!t.isValid(a) || !t.isValid(g)) throw new Error("bad point: x or y not FE");
      const x = t.sqr(g),
        E = c(a);
      if (!t.eql(x, E)) throw new Error("bad point: equation left != right");
      if (!b.isTorsionFree()) throw new Error("bad point: not in prime-order subgroup");
      return !0;
    });
  class l {
    constructor(a, g, x) {
      if (((this.px = a), (this.py = g), (this.pz = x), a == null || !t.isValid(a))) throw new Error("x required");
    ...
    static fromAffine(a) {
      const { x: g, y: x } = a || {};
      if (!a || !t.isValid(g) || !t.isValid(x)) throw new Error("invalid affine point");
    ...
    hasEvenY() {
      ...
      if (t.isOdd) return !t.isOdd(a);
      throw new Error("Field doesn't support isOdd");
    }
    equals(a) {
      u(a);
      const { px: g, py: x, pz: E } = this,
        { px: q, py: L, pz: I } = a,
        B = t.eql(t.mul(g, I), t.mul(q, E)),
        A = t.eql(t.mul(x, I), t.mul(L, E));
      return B && A;
    }
    negate() {
    ...
    multiplyUnsafe(a) {
      ...
      const E = l.ZERO;
      if (a === W) return E;
      if (this.is0() || a === k) return this;
      if (!g || N.hasPrecomputes(this)) return N.wNAFCachedUnsafe(this, a, l.normalizeZ);
      let { k1neg: q, k1: L, k2neg: I, k2: B } = g.splitScalar(a),
        A = E,
        v = E,
        C = this;
      for (; L > W || B > W; )
    ...
    multiply(a) {
      ...
      if (g) {
        ...
        let { p: v, f: C } = this.wNAF(I),
          { p: U, f: H } = this.wNAF(A);
        ((v = N.constTimeNegate(L, v)),
          (U = N.constTimeNegate(B, U)),
          (U = new l(t.mul(U.px, g.beta), U.py, U.pz)),
          (E = v.add(U)),
          (q = C.add(H)));
      } else {
    ...
    multiplyAndAddUnsafe(a, g, x) {
      const E = l.BASE,
        q = (I, B) => (B === W || B === k || !I.equals(E) ? I.multiplyUnsafe(B) : I.multiply(B)),
        L = q(this, g).add(q(a, x));
  ...
  const m = e.nBitLength,
    N = Me(l, e.endo ? Math.ceil(m / 2) : m);
  return { CURVE: e, ProjectivePoint: l, normPrivateKeyToScalar: i, weierstrassEquation: c, isWithinCurveOrder: f };
}
function Ge(n) {
  const e = ue(n);
  return (
...
function De(n) {
  ...
  const {
      ...
      toBytes(d, w, p) {
        ...
        return (
          at("isCompressed", p),
          p ? T(Uint8Array.from([w.hasEvenY() ? 2 : 3]), O) : T(Uint8Array.from([4]), O, t.toBytes(S.y))
        );
      },
      fromBytes(d) {
        const w = d.length,
        ...
        if (w === o && (p === 2 || p === 3)) {
          const O = rt(S);
          if (!Bt(O, k, t.ORDER)) throw new Error("Point is not on curve");
          const T = y(O);
          let R;
          try {
            R = t.sqrt(T);
          ...
          const O = t.fromBytes(S.subarray(0, t.BYTES)),
            T = t.fromBytes(S.subarray(t.BYTES, 2 * t.BYTES));
          return { x: O, y: T };
        } else {
          const O = o,
            T = s;
  ...
  class a {
    ...
    recoverPublicKey(w) {
      const { r: p, s: S, recovery: O } = this,
        T = I(K("msgHash", w));
      if (O == null || ![0, 1, 2, 3].includes(O)) throw new Error("recovery id invalid");
      const R = O === 2 || O === 3 ? p + e.n : p;
      if (R >= t.ORDER) throw new Error("recovery id 2 or 3 invalid");
      const Z = (O & 1) === 0 ? "02" : "03",
        G = i.fromHex(Z + l(R)),
        F = f(R),
        M = c(-T * F),
        st = c(S * F),
        X = i.BASE.multiplyAndAddUnsafe(G, M, st);
  ...
  function q(d, w, p = !0) {
    if (E(d)) throw new Error("first arg must be private key");
    if (!E(w)) throw new Error("second arg must be public key");
  ...
  function v(d, w, p = C) {
    if (["recovered", "canonical"].some((tt) => tt in p)) throw new Error("sign() legacy options not supported");
    ...
    function vt(tt) {
      ...
      if (!h(ct)) return;
      const St = f(ct),
        dt = i.BASE.multiply(ct).toAffine(),
        et = c(dt.x);
      if (et === W) return;
      const ht = c(St * c(X + et * F));
      if (ht === W) return;
      let gt = (dt.x === et ? 0 : 2) | Number(dt.y & k),
        ft = ht;
  ...
  function H(d, w, p = C) {
    const { seed: S, k2sig: O } = v(d, w, p),
      T = e;
    return re(T.hash.outputLen, T.nByteLength, T.hmac)(S, O);
  }
  ...
  function j(d, w, p, S = U) {
    ...
    if ((Gt(S), "strict" in S)) throw new Error("options.strict was renamed to lowS");
    if (Z !== void 0 && Z !== "compact" && Z !== "der") throw new Error("format must be compact or der");
    const G = typeof O == "string" || it(O),
      F = !G && !Z && typeof O == "object" && O !== null && typeof O.r == "bigint" && typeof O.s == "bigint";
    if (!G && !F) throw new Error("invalid signature, expected Uint8Array, hex string or Signature instance");
    let M, st;
    try {
    ...
    const { r: X, s: vt } = M,
      ...
      St = c(tt * ct),
      dt = c(X * ct),
      et = (gt = i.BASE.multiplyAndAddUnsafe(st, St, dt)) == null ? void 0 : gt.toAffine();
...
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */ function $e(n) {
  return { hash: n, hmac: (e, ...t) => te(n, e, be(...t)), randomBytes: pe };
}
function We(n, e) {
  const t = (r) => De({ ...n, ...$e(r) });
  return { ...t(e), create: t };
}
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */ const le = BigInt(
...
function Qe(n) {
  const e = le,
    ...
    L = (Y(q, r, e) * u) % e,
    I = Y(L, kt, e);
  if (!zt.eql(zt.sqr(I), n)) throw new Error("Cannot find square root");
  return I;
}
const zt = ie(le, void 0, void 0, { sqrt: Qe }),
  Je = We(
    {
      a: BigInt(0),
      b: BigInt(7),
      ...
      endo: {
        ...
        splitScalar: (n) => {
          const e = $t,
            ...
            r = -Xe * BigInt("0xe4437ed6010e88286f547fa90abfe4c3"),
