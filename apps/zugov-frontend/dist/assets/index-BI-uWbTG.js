import { r as T } from "./index-BV8s6ez1.js";
import { h as y, j as k, k as I } from "./index-myL0f5cF.js";
const q = () => "9.1.0",
...
class g {}
g.makeRequest = (t, e) => ({ id: R(), method: t, params: e, env: { sdkVersion: q() } });
g.makeResponse = (t, e, s) => ({ id: t, success: !0, version: s, data: e });
g.makeErrorResponse = (t, e, s) => ({ id: t, success: !1, error: e, version: s });
var r;
(function (t) {
  ...
  constructor(e = null, s = !1) {
    ((this.allowedOrigins = null),
      ...
      (this.isValidMessage = ({ origin: a, data: n, source: i }) => {
        ...
        let p = !0;
        return (
          Array.isArray(this.allowedOrigins) && (p = this.allowedOrigins.find((P) => P.test(a)) !== void 0),
          !o && l && B && p
        );
      }),
...
class A {
  constructor(e) {
    ((this.communicator = e),
      (this.call = this.buildRequest({ call: c.eth_call, formatters: [null, h.defaultBlockParam] })),
      (this.getBalance = this.buildRequest({ call: c.eth_getBalance, formatters: [null, h.defaultBlockParam] })),
      (this.getCode = this.buildRequest({ call: c.eth_getCode, formatters: [null, h.defaultBlockParam] })),
      ...
      (this.getTransactionByHash = this.buildRequest({ call: c.eth_getTransactionByHash })),
      (this.getTransactionReceipt = this.buildRequest({ call: c.eth_getTransactionReceipt })),
      ...
      (this.getEstimateGas = (s) => this.buildRequest({ call: c.eth_estimateGas })([s])),
...
class S {
  ...
  async requestPermissions(e) {
    if (!this.isPermissionRequestValid(e)) throw new d("Permissions request is invalid", f);
    try {
...
var M = function (t, e, s, a) {
  var n = arguments.length,
    i = n < 3 ? e : a === null ? (a = Object.getOwnPropertyDescriptor(e, s)) : a,
    o;
...
class _ {
  ...
  async experimental_getBalances({ currency: e = "usd" } = {}) {
    return (await this.communicator.send(r.getSafeBalances, { currency: e })).data;
  }
  async check1271Signature(e, s = "0x") {
    const a = await this.getInfo(),
      ...
      i = { call: c.eth_call, params: [{ to: a.safeAddress, data: n }, "latest"] };
    try {
    ...
    if (!a) {
      const n = Object.values(e.types),
        i = Object.keys(e.types).filter((o) =>
          n.every((l) => l.every(({ type: u }) => u.replace("[", "").replace("]", "") !== o)),
        );
      if (i.length === 0 || i.length > 1) throw new Error("Please specify primaryType");
      a = i[0];
    }
    return I({
      message: e.message,
      domain: { ...e.domain, chainId: s, verifyingContract: e.domain.verifyingContract, salt: e.domain.salt },
      types: e.types,
      primaryType: a,
    });
  }
