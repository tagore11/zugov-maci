...
function T() {
  ...
  ((o.prototype.getMaxListeners = function () {
    ...
    (o.prototype.emit = function (e) {
      ...
      else for (var O = c.length, P = b(c, O), r = 0; r < O; ++r) h(P[r], this, n);
      return !0;
    }));
  function y(t, e, n, r) {
    var i, f, s;
    if (
      ...
      f === void 0
        ...
        : (f.newListener !== void 0 && (t.emit("newListener", e, n.listener ? n.listener : n), (f = t._events)),
          (s = f[e])),
      s === void 0)
    )
    ...
    (o.prototype.removeAllListeners = function (e) {
      ...
      if (r.removeListener === void 0)
        return (
          arguments.length === 0
            ? ((this._events = Object.create(null)), (this._eventsCount = 0))
            : r[e] !== void 0 && (--this._eventsCount === 0 ? (this._events = Object.create(null)) : delete r[e]),
          this
        );
