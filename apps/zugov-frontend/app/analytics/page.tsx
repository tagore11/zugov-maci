      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          <div className="bg-gray-900 rounded-lg p-6 border border-gray-700">
            ...
            <p className="text-2xl font-bold text-foreground mb-1">1,940</p>
          ...
          <div className="bg-gray-900 rounded-lg p-6 border border-gray-700">
            ...
            <p className="text-2xl font-bold text-foreground mb-1">98</p>
          ...
          <div className="bg-gray-900 rounded-lg p-6 border border-gray-700">
            ...
            <p className="text-2xl font-bold text-foreground mb-1">68.4%</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          <div className="bg-gray-900 rounded-xl border border-gray-700 p-6">
            <h2 className="text-lg font-semibold text-foreground mb-4">Voting Activity (Last 30 Days)</h2>
          ...
          <div className="bg-gray-900 rounded-xl border border-gray-700 p-6">
            <h2 className="text-lg font-semibold text-foreground mb-4">Community Growth</h2>
            <div className="h-64 flex items-center justify-center bg-gray-800/40 rounded-lg">
              <p className="text-gray-500">Chart visualization would go here</p>
            </div>
          </div>
        ...
        <div className="bg-gray-900 rounded-xl border border-gray-700 p-6 mb-8">
          <h2 className="text-lg font-semibold text-foreground mb-4">Community Breakdown</h2>
            ...
            {[
              ...
              <div key={community.name} className="border-b border-gray-700 pb-4 last:border-0">
                ...
                <div className="w-full bg-gray-800 rounded-full h-2 mb-2">
                  <div className="bg-accent h-2 rounded-full" style={{ width: `${community.participation}%` }} />
                </div>
        ...
        <div className="bg-gray-900 rounded-xl border border-gray-700 p-6">
          <h2 className="text-lg font-semibold text-foreground mb-4">Voting Mechanism Distribution</h2>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div className="text-center p-4 bg-accent/10 rounded-lg">
              <p className="text-3xl font-bold text-accent-hover mb-2">65%</p>
