      ...
      <div className="min-h-screen bg-gray-950 text-white">
        ...
        <main className="max-w-2xl mx-auto px-4 py-8 space-y-6">
          <div className="rounded-xl border border-green-600/50 bg-green-900/20 p-8 text-center space-y-4">
            ...
            <h1 className="text-2xl font-bold text-white">Community Registered!</h1>
      ...
      <main className="max-w-2xl mx-auto px-4 py-8 space-y-6">
        ...
        <div>
          ...
          <div className="space-y-2">
            ...
            >
              <span className="font-medium text-white">MACI</span>
            ...
            <div>
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="px-4 py-2.5 rounded-lg bg-gray-700 text-white font-medium hover:bg-gray-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 shrink-0"
                >
            ...
            {contractConfig && (
              <div className="rounded-lg bg-gray-800/60 border border-gray-700 p-4 space-y-2 text-sm">
                ...
                <p className="text-gray-300">
                  Sign-up policy: <span className="text-white">{contractConfig.signUpPolicyType}</span>{" "}
