...
// local imports
include "../trees/QuinaryCheckRootRanked.circom";
 ...
 */
 template ResultCommitmentVerifierRanked(voteOptionTreeDepth) {
    ...
    signal input newResults[MAX_RANKED_VOTE_OPTIONS];
    ...
    var computedCurrentResultsRoot = QuinaryCheckRootRanked()(currentResults, 0);
    ...
    var computedNewResultsRoot = QuinaryCheckRootRanked()(newResults, 0);
