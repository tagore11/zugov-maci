 ...
 */
 template MessageProcessorRanked(
    ...
    var voteOptionsValid = LessEqThan(32)([voteOptions, maxRankedVoteOptions]);
    voteOptionsValid === 1;
    ...
    for (var i = batchSize - 1; i >= 0; i--) {
        ...
        (computedNewVoteStateRoot[i], computedNewVoteBallotRoot[i]) = SingleMessageProcessorRanked(stateTreeDepth, voteOptionTreeDepth)(
            totalSignups,
            stateRoots[i + 1],
            ballotRoots[i + 1],
